...
![Total Records](https://img.shields.io/badge/records-926,935-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.64MB-blue)
...
> **Last Updated:** 2026-02-27 14:36:50 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **926,935** |
| 💾 **Database Size** | **96.64 MB** |
| 📅 **Last Updated** | February 27, 2026 at 14:36 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,800                        │
│ 🧾 Transaction Headers  │ ████████ 255,280               │
│ 📝 Transaction Lines    │ ████████████████████ 638,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,921 Suppliers (+ 3 per run)
- ✅ 2,614 Staff members (+ 2 per run)
- ✅ 25,800 Products (+ 10 per run)
- ✅ 255,280 Transactions (+ 20 per run)
- ✅ 638,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.64 MB)
...
**Current Status:** 926,935 records | 96.64 MB | Growing every 2 hours
