...
![Total Records](https://img.shields.io/badge/records-927,660-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.71MB-blue)
...
> **Last Updated:** 2026-02-27 16:34:14 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **927,660** |
| 💾 **Database Size** | **96.71 MB** |
| 📅 **Last Updated** | February 27, 2026 at 16:34 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,820                        │
│ 🧾 Transaction Headers  │ ████████ 255,480               │
│ 📝 Transaction Lines    │ ████████████████████ 638,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,924 Suppliers (+ 3 per run)
- ✅ 2,616 Staff members (+ 2 per run)
- ✅ 25,820 Products (+ 10 per run)
- ✅ 255,480 Transactions (+ 20 per run)
- ✅ 638,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.71 MB)
...
- **Records:** 927,660
- **Size:** 96.71 MB
- **Last Updated:** 2026-02-27 16:34 UTC
...
**Current Status:** 927,660 records | 96.71 MB | Growing every 2 hours
