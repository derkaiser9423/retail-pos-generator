...
![Total Records](https://img.shields.io/badge/records-503,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-52.29MB-blue)
...
> **Last Updated:** 2026-01-07 08:21:22 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **503,535** |
| 💾 **Database Size** | **52.29 MB** |
| 📅 **Last Updated** | January 07, 2026 at 08:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,120                        │
│ 🧾 Transaction Headers  │ ████████ 138,480               │
│ 📝 Transaction Lines    │ ████████████████████ 346,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,169 Suppliers (+ 3 per run)
- ✅ 1,446 Staff members (+ 2 per run)
- ✅ 14,120 Products (+ 10 per run)
- ✅ 138,480 Transactions (+ 20 per run)
- ✅ 346,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (52.29 MB)
...
- **Records:** 503,535
- **Size:** 52.29 MB
- **Last Updated:** 2026-01-07 08:21 UTC
...
**Current Status:** 503,535 records | 52.29 MB | Growing every 2 hours
