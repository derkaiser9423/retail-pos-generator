...
![Total Records](https://img.shields.io/badge/records-848,635-brightgreen)
![Database Size](https://img.shields.io/badge/size-88.32MB-blue)
...
> **Last Updated:** 2026-02-17 20:30:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **848,635** |
| 💾 **Database Size** | **88.32 MB** |
| 📅 **Last Updated** | February 17, 2026 at 20:30 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,640                        │
│ 🧾 Transaction Headers  │ ████████ 233,680               │
│ 📝 Transaction Lines    │ ████████████████████ 584,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,597 Suppliers (+ 3 per run)
- ✅ 2,398 Staff members (+ 2 per run)
- ✅ 23,640 Products (+ 10 per run)
- ✅ 233,680 Transactions (+ 20 per run)
- ✅ 584,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (88.32 MB)
...
**Current Status:** 848,635 records | 88.32 MB | Growing every 2 hours
