...
![Total Records](https://img.shields.io/badge/records-639,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-66.54MB-blue)
...
> **Last Updated:** 2026-01-23 01:09:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **639,835** |
| 💾 **Database Size** | **66.54 MB** |
| 📅 **Last Updated** | January 23, 2026 at 01:09 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,880                        │
│ 🧾 Transaction Headers  │ ████████ 176,080               │
│ 📝 Transaction Lines    │ ████████████████████ 440,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,733 Suppliers (+ 3 per run)
- ✅ 1,822 Staff members (+ 2 per run)
- ✅ 17,880 Products (+ 10 per run)
- ✅ 176,080 Transactions (+ 20 per run)
- ✅ 440,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (66.54 MB)
...
- **Records:** 639,835
- **Size:** 66.54 MB
- **Last Updated:** 2026-01-23 01:09 UTC
...
**Current Status:** 639,835 records | 66.54 MB | Growing every 2 hours
