...
![Total Records](https://img.shields.io/badge/records-716,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-74.51MB-blue)
...
> **Last Updated:** 2026-02-01 01:30:47 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **716,685** |
| 💾 **Database Size** | **74.51 MB** |
...
│ 📦 Products             │  20,000                        │
│ 🧾 Transaction Headers  │ ████████ 197,280               │
│ 📝 Transaction Lines    │ ████████████████████ 493,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,051 Suppliers (+ 3 per run)
- ✅ 2,034 Staff members (+ 2 per run)
- ✅ 20,000 Products (+ 10 per run)
- ✅ 197,280 Transactions (+ 20 per run)
- ✅ 493,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (74.51 MB)
...
**Current Status:** 716,685 records | 74.51 MB | Growing every 2 hours
