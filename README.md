...
![Total Records](https://img.shields.io/badge/records-837,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-87.07MB-blue)
...
> **Last Updated:** 2026-02-16 10:43:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **837,035** |
| 💾 **Database Size** | **87.07 MB** |
| 📅 **Last Updated** | February 16, 2026 at 10:43 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,320                        │
│ 🧾 Transaction Headers  │ ████████ 230,480               │
│ 📝 Transaction Lines    │ ████████████████████ 576,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,549 Suppliers (+ 3 per run)
- ✅ 2,366 Staff members (+ 2 per run)
- ✅ 23,320 Products (+ 10 per run)
- ✅ 230,480 Transactions (+ 20 per run)
- ✅ 576,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (87.07 MB)
...
**Current Status:** 837,035 records | 87.07 MB | Growing every 2 hours
