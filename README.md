...
![Total Records](https://img.shields.io/badge/records-533,985-brightgreen)
![Database Size](https://img.shields.io/badge/size-55.4MB-blue)
...
> **Last Updated:** 2026-01-10 20:15:22 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **533,985** |
| 💾 **Database Size** | **55.4 MB** |
| 📅 **Last Updated** | January 10, 2026 at 20:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,960                        │
│ 🧾 Transaction Headers  │ ████████ 146,880               │
│ 📝 Transaction Lines    │ ████████████████████ 367,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,295 Suppliers (+ 3 per run)
- ✅ 1,530 Staff members (+ 2 per run)
- ✅ 14,960 Products (+ 10 per run)
- ✅ 146,880 Transactions (+ 20 per run)
- ✅ 367,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (55.4 MB)
...
**Current Status:** 533,985 records | 55.4 MB | Growing every 2 hours
