...
![Total Records](https://img.shields.io/badge/records-657,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-68.4MB-blue)
...
> **Last Updated:** 2026-01-25 03:48:11 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **657,960** |
| 💾 **Database Size** | **68.4 MB** |
| 📅 **Last Updated** | January 25, 2026 at 03:48 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,380                        │
│ 🧾 Transaction Headers  │ ████████ 181,080               │
│ 📝 Transaction Lines    │ ████████████████████ 452,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,808 Suppliers (+ 3 per run)
- ✅ 1,872 Staff members (+ 2 per run)
- ✅ 18,380 Products (+ 10 per run)
- ✅ 181,080 Transactions (+ 20 per run)
- ✅ 452,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (68.4 MB)
...
- **Records:** 657,960
- **Size:** 68.4 MB
- **Last Updated:** 2026-01-25 03:48 UTC
...
**Current Status:** 657,960 records | 68.4 MB | Growing every 2 hours
