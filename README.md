...
![Total Records](https://img.shields.io/badge/records-933,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.3MB-blue)
...
> **Last Updated:** 2026-02-28 08:21:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **933,460** |
| 💾 **Database Size** | **97.3 MB** |
| 📅 **Last Updated** | February 28, 2026 at 08:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,980                        │
│ 🧾 Transaction Headers  │ ████████ 257,080               │
│ 📝 Transaction Lines    │ ████████████████████ 642,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,948 Suppliers (+ 3 per run)
- ✅ 2,632 Staff members (+ 2 per run)
- ✅ 25,980 Products (+ 10 per run)
- ✅ 257,080 Transactions (+ 20 per run)
- ✅ 642,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.3 MB)
...
- **Records:** 933,460
- **Size:** 97.3 MB
- **Last Updated:** 2026-02-28 08:21 UTC
...
**Current Status:** 933,460 records | 97.3 MB | Growing every 2 hours
