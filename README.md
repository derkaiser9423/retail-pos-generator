...
![Total Records](https://img.shields.io/badge/records-719,585-brightgreen)
![Database Size](https://img.shields.io/badge/size-74.86MB-blue)
...
> **Last Updated:** 2026-02-01 10:19:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **719,585** |
| 💾 **Database Size** | **74.86 MB** |
| 📅 **Last Updated** | February 01, 2026 at 10:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,080                        │
│ 🧾 Transaction Headers  │ ████████ 198,080               │
│ 📝 Transaction Lines    │ ████████████████████ 495,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,063 Suppliers (+ 3 per run)
- ✅ 2,042 Staff members (+ 2 per run)
- ✅ 20,080 Products (+ 10 per run)
- ✅ 198,080 Transactions (+ 20 per run)
- ✅ 495,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (74.86 MB)
...
- **Records:** 719,585
- **Size:** 74.86 MB
- **Last Updated:** 2026-02-01 10:19 UTC
...
**Current Status:** 719,585 records | 74.86 MB | Growing every 2 hours
