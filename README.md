...
![Total Records](https://img.shields.io/badge/records-854,435-brightgreen)
![Database Size](https://img.shields.io/badge/size-88.95MB-blue)
...
> **Last Updated:** 2026-02-18 14:41:22 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **854,435** |
| 💾 **Database Size** | **88.95 MB** |
| 📅 **Last Updated** | February 18, 2026 at 14:41 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,800                        │
│ 🧾 Transaction Headers  │ ████████ 235,280               │
│ 📝 Transaction Lines    │ ████████████████████ 588,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,621 Suppliers (+ 3 per run)
- ✅ 2,414 Staff members (+ 2 per run)
- ✅ 23,800 Products (+ 10 per run)
- ✅ 235,280 Transactions (+ 20 per run)
- ✅ 588,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (88.95 MB)
...
**Current Status:** 854,435 records | 88.95 MB | Growing every 2 hours
