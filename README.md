...
![Total Records](https://img.shields.io/badge/records-684,785-brightgreen)
![Database Size](https://img.shields.io/badge/size-71.15MB-blue)
...
> **Last Updated:** 2026-01-28 04:39:19 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **684,785** |
| 💾 **Database Size** | **71.15 MB** |
| 📅 **Last Updated** | January 28, 2026 at 04:39 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  19,120                        │
│ 🧾 Transaction Headers  │ ████████ 188,480               │
│ 📝 Transaction Lines    │ ████████████████████ 471,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,919 Suppliers (+ 3 per run)
- ✅ 1,946 Staff members (+ 2 per run)
- ✅ 19,120 Products (+ 10 per run)
- ✅ 188,480 Transactions (+ 20 per run)
- ✅ 471,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (71.15 MB)
...
- **Records:** 684,785
- **Size:** 71.15 MB
- **Last Updated:** 2026-01-28 04:39 UTC
...
**Current Status:** 684,785 records | 71.15 MB | Growing every 2 hours
