...
![Total Records](https://img.shields.io/badge/records-855,160-brightgreen)
![Database Size](https://img.shields.io/badge/size-89.02MB-blue)
...
> **Last Updated:** 2026-02-18 16:57:12 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **855,160** |
| 💾 **Database Size** | **89.02 MB** |
| 📅 **Last Updated** | February 18, 2026 at 16:57 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,820                        │
│ 🧾 Transaction Headers  │ ████████ 235,480               │
│ 📝 Transaction Lines    │ ████████████████████ 588,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,624 Suppliers (+ 3 per run)
- ✅ 2,416 Staff members (+ 2 per run)
- ✅ 23,820 Products (+ 10 per run)
- ✅ 235,480 Transactions (+ 20 per run)
- ✅ 588,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (89.02 MB)
...
**Current Status:** 855,160 records | 89.02 MB | Growing every 2 hours
