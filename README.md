...
![Total Records](https://img.shields.io/badge/records-410,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-42.53MB-blue)
...
> **Last Updated:** 2025-12-27 16:16:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **410,735** |
| 💾 **Database Size** | **42.53 MB** |
| 📅 **Last Updated** | December 27, 2025 at 16:16 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  11,560                        │
│ 🧾 Transaction Headers  │ ████████ 112,880               │
│ 📝 Transaction Lines    │ ████████████████████ 282,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,785 Suppliers (+ 3 per run)
- ✅ 1,190 Staff members (+ 2 per run)
- ✅ 11,560 Products (+ 10 per run)
- ✅ 112,880 Transactions (+ 20 per run)
- ✅ 282,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (42.53 MB)
...
- **Records:** 410,735
- **Size:** 42.53 MB
- **Last Updated:** 2025-12-27 16:16 UTC
...
**Current Status:** 410,735 records | 42.53 MB | Growing every 2 hours
