...
![Total Records](https://img.shields.io/badge/records-821,810-brightgreen)
![Database Size](https://img.shields.io/badge/size-85.54MB-blue)
...
> **Last Updated:** 2026-02-14 12:31:29 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **821,810** |
| 💾 **Database Size** | **85.54 MB** |
...
│ 📦 Products             │  22,900                        │
│ 🧾 Transaction Headers  │ ████████ 226,280               │
│ 📝 Transaction Lines    │ ████████████████████ 565,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,486 Suppliers (+ 3 per run)
- ✅ 2,324 Staff members (+ 2 per run)
- ✅ 22,900 Products (+ 10 per run)
- ✅ 226,280 Transactions (+ 20 per run)
- ✅ 565,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (85.54 MB)
...
- **Records:** 821,810
- **Size:** 85.54 MB
- **Last Updated:** 2026-02-14 12:31 UTC
...
**Current Status:** 821,810 records | 85.54 MB | Growing every 2 hours
