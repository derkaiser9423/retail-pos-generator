...
![Total Records](https://img.shields.io/badge/records-391,885-brightgreen)
![Database Size](https://img.shields.io/badge/size-40.52MB-blue)
...
> **Last Updated:** 2025-12-25 12:27:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **391,885** |
| 💾 **Database Size** | **40.52 MB** |
...
│ 📦 Products             │  11,040                        │
│ 🧾 Transaction Headers  │ ████████ 107,680               │
│ 📝 Transaction Lines    │ ████████████████████ 269,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,707 Suppliers (+ 3 per run)
- ✅ 1,138 Staff members (+ 2 per run)
- ✅ 11,040 Products (+ 10 per run)
- ✅ 107,680 Transactions (+ 20 per run)
- ✅ 269,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (40.52 MB)
...
**Current Status:** 391,885 records | 40.52 MB | Growing every 2 hours
