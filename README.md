...
![Total Records](https://img.shields.io/badge/records-829,785-brightgreen)
![Database Size](https://img.shields.io/badge/size-86.31MB-blue)
...
> **Last Updated:** 2026-02-15 12:33:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **829,785** |
| 💾 **Database Size** | **86.31 MB** |
...
│ 📦 Products             │  23,120                        │
│ 🧾 Transaction Headers  │ ████████ 228,480               │
│ 📝 Transaction Lines    │ ████████████████████ 571,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,519 Suppliers (+ 3 per run)
- ✅ 2,346 Staff members (+ 2 per run)
- ✅ 23,120 Products (+ 10 per run)
- ✅ 228,480 Transactions (+ 20 per run)
- ✅ 571,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (86.31 MB)
...
- **Records:** 829,785
- **Size:** 86.31 MB
- **Last Updated:** 2026-02-15 12:33 UTC
...
**Current Status:** 829,785 records | 86.31 MB | Growing every 2 hours
