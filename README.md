...
![Total Records](https://img.shields.io/badge/records-315,032-brightgreen)
![Database Size](https://img.shields.io/badge/size-32.49MB-blue)
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **315,032** |
| 💾 **Database Size** | **32.49 MB** |
| 📅 **Last Updated** | December 16, 2025 at 16:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  8,920                         │
│ 🧾 Transaction Headers  │ ████████ 86,480                │
│ 📝 Transaction Lines    │ ████████████████████ 216,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,389 Suppliers (+ 3 per run)
- ✅ 926 Staff members (+ 2 per run)
- ✅ 8,920 Products (+ 10 per run)
- ✅ 86,480 Transactions (+ 20 per run)
- ✅ 216,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (32.49 MB)
...
- **Records:** 315,032
- **Size:** 32.49 MB
- **Last Updated:** 2025-12-16 16:19 UTC
...
**Current Status:** 315,032 records | 32.49 MB | Growing every 2 hours
