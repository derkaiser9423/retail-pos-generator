...
![Total Records](https://img.shields.io/badge/records-908,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-94.61MB-blue)
...
> **Last Updated:** 2026-02-25 06:56:07 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **908,085** |
| 💾 **Database Size** | **94.61 MB** |
| 📅 **Last Updated** | February 25, 2026 at 06:56 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,280                        │
│ 🧾 Transaction Headers  │ ████████ 250,080               │
│ 📝 Transaction Lines    │ ████████████████████ 625,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,843 Suppliers (+ 3 per run)
- ✅ 2,562 Staff members (+ 2 per run)
- ✅ 25,280 Products (+ 10 per run)
- ✅ 250,080 Transactions (+ 20 per run)
- ✅ 625,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (94.61 MB)
...
**Current Status:** 908,085 records | 94.61 MB | Growing every 2 hours
