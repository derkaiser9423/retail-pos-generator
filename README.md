...
![Total Records](https://img.shields.io/badge/records-610,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-63.46MB-blue)
...
> **Last Updated:** 2026-01-19 16:20:40 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **610,835** |
| 💾 **Database Size** | **63.46 MB** |
| 📅 **Last Updated** | January 19, 2026 at 16:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,080                        │
│ 🧾 Transaction Headers  │ ████████ 168,080               │
│ 📝 Transaction Lines    │ ████████████████████ 420,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,613 Suppliers (+ 3 per run)
- ✅ 1,742 Staff members (+ 2 per run)
- ✅ 17,080 Products (+ 10 per run)
- ✅ 168,080 Transactions (+ 20 per run)
- ✅ 420,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (63.46 MB)
...
- **Records:** 610,835
- **Size:** 63.46 MB
- **Last Updated:** 2026-01-19 16:20 UTC
...
**Current Status:** 610,835 records | 63.46 MB | Growing every 2 hours
