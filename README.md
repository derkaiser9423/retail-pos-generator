...
![Total Records](https://img.shields.io/badge/records-802,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-83.55MB-blue)
...
> **Last Updated:** 2026-02-12 04:17:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **802,960** |
| 💾 **Database Size** | **83.55 MB** |
| 📅 **Last Updated** | February 12, 2026 at 04:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,380                        │
│ 🧾 Transaction Headers  │ ████████ 221,080               │
│ 📝 Transaction Lines    │ ████████████████████ 552,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,408 Suppliers (+ 3 per run)
- ✅ 2,272 Staff members (+ 2 per run)
- ✅ 22,380 Products (+ 10 per run)
- ✅ 221,080 Transactions (+ 20 per run)
- ✅ 552,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (83.55 MB)
...
**Current Status:** 802,960 records | 83.55 MB | Growing every 2 hours
