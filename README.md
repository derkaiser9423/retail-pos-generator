...
![Total Records](https://img.shields.io/badge/records-420,885-brightgreen)
![Database Size](https://img.shields.io/badge/size-43.57MB-blue)
...
> **Last Updated:** 2025-12-28 20:15:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **420,885** |
| 💾 **Database Size** | **43.57 MB** |
| 📅 **Last Updated** | December 28, 2025 at 20:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  11,840                        │
│ 🧾 Transaction Headers  │ ████████ 115,680               │
│ 📝 Transaction Lines    │ ████████████████████ 289,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,827 Suppliers (+ 3 per run)
- ✅ 1,218 Staff members (+ 2 per run)
- ✅ 11,840 Products (+ 10 per run)
- ✅ 115,680 Transactions (+ 20 per run)
- ✅ 289,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (43.57 MB)
...
- **Records:** 420,885
- **Size:** 43.57 MB
- **Last Updated:** 2025-12-28 20:15 UTC
...
**Current Status:** 420,885 records | 43.57 MB | Growing every 2 hours
