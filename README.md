...
![Total Records](https://img.shields.io/badge/records-532,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-55.24MB-blue)
...
> **Last Updated:** 2026-01-10 16:16:20 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **532,535** |
| 💾 **Database Size** | **55.24 MB** |
| 📅 **Last Updated** | January 10, 2026 at 16:16 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,920                        │
│ 🧾 Transaction Headers  │ ████████ 146,480               │
│ 📝 Transaction Lines    │ ████████████████████ 366,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,289 Suppliers (+ 3 per run)
- ✅ 1,526 Staff members (+ 2 per run)
- ✅ 14,920 Products (+ 10 per run)
- ✅ 146,480 Transactions (+ 20 per run)
- ✅ 366,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (55.24 MB)
...
- **Records:** 532,535
- **Size:** 55.24 MB
- **Last Updated:** 2026-01-10 16:16 UTC
...
**Current Status:** 532,535 records | 55.24 MB | Growing every 2 hours
