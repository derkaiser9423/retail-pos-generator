...
![Total Records](https://img.shields.io/badge/records-920,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-95.96MB-blue)
...
> **Last Updated:** 2026-02-26 18:43:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **920,410** |
| 💾 **Database Size** | **95.96 MB** |
| 📅 **Last Updated** | February 26, 2026 at 18:43 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,620                        │
│ 🧾 Transaction Headers  │ ████████ 253,480               │
│ 📝 Transaction Lines    │ ████████████████████ 633,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,894 Suppliers (+ 3 per run)
- ✅ 2,596 Staff members (+ 2 per run)
- ✅ 25,620 Products (+ 10 per run)
- ✅ 253,480 Transactions (+ 20 per run)
- ✅ 633,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (95.96 MB)
...
- **Records:** 920,410
- **Size:** 95.96 MB
- **Last Updated:** 2026-02-26 18:43 UTC
...
**Current Status:** 920,410 records | 95.96 MB | Growing every 2 hours
