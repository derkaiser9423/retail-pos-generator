...
![Total Records](https://img.shields.io/badge/records-760,185-brightgreen)
![Database Size](https://img.shields.io/badge/size-79.11MB-blue)
...
> **Last Updated:** 2026-02-06 16:36:50 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **760,185** |
| 💾 **Database Size** | **79.11 MB** |
| 📅 **Last Updated** | February 06, 2026 at 16:36 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,200                        │
│ 🧾 Transaction Headers  │ ████████ 209,280               │
│ 📝 Transaction Lines    │ ████████████████████ 523,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,231 Suppliers (+ 3 per run)
- ✅ 2,154 Staff members (+ 2 per run)
- ✅ 21,200 Products (+ 10 per run)
- ✅ 209,280 Transactions (+ 20 per run)
- ✅ 523,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (79.11 MB)
...
**Current Status:** 760,185 records | 79.11 MB | Growing every 2 hours
