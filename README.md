...
![Total Records](https://img.shields.io/badge/records-746,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-77.71MB-blue)
...
> **Last Updated:** 2026-02-04 22:19:37 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **746,410** |
| 💾 **Database Size** | **77.71 MB** |
| 📅 **Last Updated** | February 04, 2026 at 22:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,820                        │
│ 🧾 Transaction Headers  │ ████████ 205,480               │
│ 📝 Transaction Lines    │ ████████████████████ 513,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,174 Suppliers (+ 3 per run)
- ✅ 2,116 Staff members (+ 2 per run)
- ✅ 20,820 Products (+ 10 per run)
- ✅ 205,480 Transactions (+ 20 per run)
- ✅ 513,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (77.71 MB)
...
- **Records:** 746,410
- **Size:** 77.71 MB
- **Last Updated:** 2026-02-04 22:19 UTC
...
**Current Status:** 746,410 records | 77.71 MB | Growing every 2 hours
