...
![Total Records](https://img.shields.io/badge/records-399,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-41.3MB-blue)
...
> **Last Updated:** 2025-12-26 08:19:21 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **399,135** |
| 💾 **Database Size** | **41.3 MB** |
| 📅 **Last Updated** | December 26, 2025 at 08:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  11,240                        │
│ 🧾 Transaction Headers  │ ████████ 109,680               │
│ 📝 Transaction Lines    │ ████████████████████ 274,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,737 Suppliers (+ 3 per run)
- ✅ 1,158 Staff members (+ 2 per run)
- ✅ 11,240 Products (+ 10 per run)
- ✅ 109,680 Transactions (+ 20 per run)
- ✅ 274,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (41.3 MB)
...
- **Records:** 399,135
- **Size:** 41.3 MB
- **Last Updated:** 2025-12-26 08:19 UTC
...
**Current Status:** 399,135 records | 41.3 MB | Growing every 2 hours
