...
![Total Records](https://img.shields.io/badge/records-884,160-brightgreen)
![Database Size](https://img.shields.io/badge/size-92.1MB-blue)
...
> **Last Updated:** 2026-02-22 06:39:31 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **884,160** |
| 💾 **Database Size** | **92.1 MB** |
| 📅 **Last Updated** | February 22, 2026 at 06:39 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,620                        │
│ 🧾 Transaction Headers  │ ████████ 243,480               │
│ 📝 Transaction Lines    │ ████████████████████ 608,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,744 Suppliers (+ 3 per run)
- ✅ 2,496 Staff members (+ 2 per run)
- ✅ 24,620 Products (+ 10 per run)
- ✅ 243,480 Transactions (+ 20 per run)
- ✅ 608,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (92.1 MB)
...
**Current Status:** 884,160 records | 92.1 MB | Growing every 2 hours
