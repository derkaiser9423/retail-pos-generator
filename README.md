...
![Total Records](https://img.shields.io/badge/records-792,810-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.53MB-blue)
...
> **Last Updated:** 2026-02-10 20:38:39 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **792,810** |
| 💾 **Database Size** | **82.53 MB** |
| 📅 **Last Updated** | February 10, 2026 at 20:38 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,100                        │
│ 🧾 Transaction Headers  │ ████████ 218,280               │
│ 📝 Transaction Lines    │ ████████████████████ 545,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,366 Suppliers (+ 3 per run)
- ✅ 2,244 Staff members (+ 2 per run)
- ✅ 22,100 Products (+ 10 per run)
- ✅ 218,280 Transactions (+ 20 per run)
- ✅ 545,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.53 MB)
...
**Current Status:** 792,810 records | 82.53 MB | Growing every 2 hours
