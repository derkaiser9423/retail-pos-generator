...
![Total Records](https://img.shields.io/badge/records-574,585-brightgreen)
![Database Size](https://img.shields.io/badge/size-59.64MB-blue)
...
> **Last Updated:** 2026-01-15 12:29:44 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **574,585** |
| 💾 **Database Size** | **59.64 MB** |
| 📅 **Last Updated** | January 15, 2026 at 12:29 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,080                        │
│ 🧾 Transaction Headers  │ ████████ 158,080               │
│ 📝 Transaction Lines    │ ████████████████████ 395,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,463 Suppliers (+ 3 per run)
- ✅ 1,642 Staff members (+ 2 per run)
- ✅ 16,080 Products (+ 10 per run)
- ✅ 158,080 Transactions (+ 20 per run)
- ✅ 395,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (59.64 MB)
...
- **Records:** 574,585
- **Size:** 59.64 MB
- **Last Updated:** 2026-01-15 12:29 UTC
...
**Current Status:** 574,585 records | 59.64 MB | Growing every 2 hours
