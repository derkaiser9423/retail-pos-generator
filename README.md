...
![Total Records](https://img.shields.io/badge/records-794,260-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.68MB-blue)
...
> **Last Updated:** 2026-02-11 01:31:36 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **794,260** |
| 💾 **Database Size** | **82.68 MB** |
| 📅 **Last Updated** | February 11, 2026 at 01:31 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,140                        │
│ 🧾 Transaction Headers  │ ████████ 218,680               │
│ 📝 Transaction Lines    │ ████████████████████ 546,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,372 Suppliers (+ 3 per run)
- ✅ 2,248 Staff members (+ 2 per run)
- ✅ 22,140 Products (+ 10 per run)
- ✅ 218,680 Transactions (+ 20 per run)
- ✅ 546,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.68 MB)
...
**Current Status:** 794,260 records | 82.68 MB | Growing every 2 hours
