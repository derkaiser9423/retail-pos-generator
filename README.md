...
![Total Records](https://img.shields.io/badge/records-750,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-78.05MB-blue)
...
> **Last Updated:** 2026-02-05 10:34:32 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **750,035** |
| 💾 **Database Size** | **78.05 MB** |
| 📅 **Last Updated** | February 05, 2026 at 10:34 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,920                        │
│ 🧾 Transaction Headers  │ ████████ 206,480               │
│ 📝 Transaction Lines    │ ████████████████████ 516,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,189 Suppliers (+ 3 per run)
- ✅ 2,126 Staff members (+ 2 per run)
- ✅ 20,920 Products (+ 10 per run)
- ✅ 206,480 Transactions (+ 20 per run)
- ✅ 516,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (78.05 MB)
...
- **Records:** 750,035
- **Size:** 78.05 MB
- **Last Updated:** 2026-02-05 10:34 UTC
...
**Current Status:** 750,035 records | 78.05 MB | Growing every 2 hours
