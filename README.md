...
![Total Records](https://img.shields.io/badge/records-689,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-71.64MB-blue)
...
> **Last Updated:** 2026-01-28 16:28:21 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **689,135** |
| 💾 **Database Size** | **71.64 MB** |
| 📅 **Last Updated** | January 28, 2026 at 16:28 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  19,240                        │
│ 🧾 Transaction Headers  │ ████████ 189,680               │
│ 📝 Transaction Lines    │ ████████████████████ 474,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,937 Suppliers (+ 3 per run)
- ✅ 1,958 Staff members (+ 2 per run)
- ✅ 19,240 Products (+ 10 per run)
- ✅ 189,680 Transactions (+ 20 per run)
- ✅ 474,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (71.64 MB)
...
- **Records:** 689,135
- **Size:** 71.64 MB
- **Last Updated:** 2026-01-28 16:28 UTC
...
**Current Status:** 689,135 records | 71.64 MB | Growing every 2 hours
