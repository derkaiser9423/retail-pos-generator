...
![Total Records](https://img.shields.io/badge/records-619,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-64.4MB-blue)
...
> **Last Updated:** 2026-01-20 16:26:10 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **619,535** |
| 💾 **Database Size** | **64.4 MB** |
| 📅 **Last Updated** | January 20, 2026 at 16:26 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,320                        │
│ 🧾 Transaction Headers  │ ████████ 170,480               │
│ 📝 Transaction Lines    │ ████████████████████ 426,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,649 Suppliers (+ 3 per run)
- ✅ 1,766 Staff members (+ 2 per run)
- ✅ 17,320 Products (+ 10 per run)
- ✅ 170,480 Transactions (+ 20 per run)
- ✅ 426,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (64.4 MB)
...
- **Records:** 619,535
- **Size:** 64.4 MB
- **Last Updated:** 2026-01-20 16:26 UTC
...
**Current Status:** 619,535 records | 64.4 MB | Growing every 2 hours
