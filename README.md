...
![Total Records](https://img.shields.io/badge/records-938,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.83MB-blue)
...
> **Last Updated:** 2026-02-28 22:17:42 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **938,535** |
| 💾 **Database Size** | **97.83 MB** |
| 📅 **Last Updated** | February 28, 2026 at 22:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,120                        │
│ 🧾 Transaction Headers  │ ████████ 258,480               │
│ 📝 Transaction Lines    │ ████████████████████ 646,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,969 Suppliers (+ 3 per run)
- ✅ 2,646 Staff members (+ 2 per run)
- ✅ 26,120 Products (+ 10 per run)
- ✅ 258,480 Transactions (+ 20 per run)
- ✅ 646,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.83 MB)
...
- **Records:** 938,535
- **Size:** 97.83 MB
- **Last Updated:** 2026-02-28 22:17 UTC
...
**Current Status:** 938,535 records | 97.83 MB | Growing every 2 hours
