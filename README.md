...
![Total Records](https://img.shields.io/badge/records-885,610-brightgreen)
![Database Size](https://img.shields.io/badge/size-92.23MB-blue)
...
> **Last Updated:** 2026-02-22 10:19:44 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **885,610** |
| 💾 **Database Size** | **92.23 MB** |
| 📅 **Last Updated** | February 22, 2026 at 10:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,660                        │
│ 🧾 Transaction Headers  │ ████████ 243,880               │
│ 📝 Transaction Lines    │ ████████████████████ 609,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,750 Suppliers (+ 3 per run)
- ✅ 2,500 Staff members (+ 2 per run)
- ✅ 24,660 Products (+ 10 per run)
- ✅ 243,880 Transactions (+ 20 per run)
- ✅ 609,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (92.23 MB)
...
**Current Status:** 885,610 records | 92.23 MB | Growing every 2 hours
