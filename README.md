...
![Total Records](https://img.shields.io/badge/records-608,660-brightgreen)
![Database Size](https://img.shields.io/badge/size-63.22MB-blue)
...
> **Last Updated:** 2026-01-19 10:21:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **608,660** |
| 💾 **Database Size** | **63.22 MB** |
| 📅 **Last Updated** | January 19, 2026 at 10:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,020                        │
│ 🧾 Transaction Headers  │ ████████ 167,480               │
│ 📝 Transaction Lines    │ ████████████████████ 418,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,604 Suppliers (+ 3 per run)
- ✅ 1,736 Staff members (+ 2 per run)
- ✅ 17,020 Products (+ 10 per run)
- ✅ 167,480 Transactions (+ 20 per run)
- ✅ 418,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (63.22 MB)
...
- **Records:** 608,660
- **Size:** 63.22 MB
- **Last Updated:** 2026-01-19 10:21 UTC
...
**Current Status:** 608,660 records | 63.22 MB | Growing every 2 hours
