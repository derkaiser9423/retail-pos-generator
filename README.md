...
![Total Records](https://img.shields.io/badge/records-672,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-69.85MB-blue)
...
> **Last Updated:** 2026-01-26 18:25:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **672,460** |
| 💾 **Database Size** | **69.85 MB** |
...
│ 📦 Products             │  18,780                        │
│ 🧾 Transaction Headers  │ ████████ 185,080               │
│ 📝 Transaction Lines    │ ████████████████████ 462,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,868 Suppliers (+ 3 per run)
- ✅ 1,912 Staff members (+ 2 per run)
- ✅ 18,780 Products (+ 10 per run)
- ✅ 185,080 Transactions (+ 20 per run)
- ✅ 462,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (69.85 MB)
...
- **Records:** 672,460
- **Size:** 69.85 MB
- **Last Updated:** 2026-01-26 18:25 UTC
...
**Current Status:** 672,460 records | 69.85 MB | Growing every 2 hours
