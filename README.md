...
![Total Records](https://img.shields.io/badge/records-209,149-brightgreen)
![Database Size](https://img.shields.io/badge/size-21.41MB-blue)
...
> **Last Updated:** 2025-12-04 12:29:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **209,149** |
| 💾 **Database Size** | **21.41 MB** |
| 📅 **Last Updated** | December 04, 2025 at 12:29 UTC |
| 📈 **24h Growth** | +726 records |
...
│ 📦 Products             │  6,000                         │
│ 🧾 Transaction Headers  │ ████████ 57,280                │
│ 📝 Transaction Lines    │ ████████████████████ 143,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 951 Suppliers (+ 3 per run)
- ✅ 634 Staff members (+ 2 per run)
- ✅ 6,000 Products (+ 10 per run)
- ✅ 57,280 Transactions (+ 20 per run)
- ✅ 143,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (21.41 MB)
...
**Current Status:** 209,149 records | 21.41 MB | Growing every 2 hours
