...
![Total Records](https://img.shields.io/badge/records-832,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-86.66MB-blue)
...
> **Last Updated:** 2026-02-15 20:18:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **832,685** |
| 💾 **Database Size** | **86.66 MB** |
| 📅 **Last Updated** | February 15, 2026 at 20:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,200                        │
│ 🧾 Transaction Headers  │ ████████ 229,280               │
│ 📝 Transaction Lines    │ ████████████████████ 573,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,531 Suppliers (+ 3 per run)
- ✅ 2,354 Staff members (+ 2 per run)
- ✅ 23,200 Products (+ 10 per run)
- ✅ 229,280 Transactions (+ 20 per run)
- ✅ 573,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (86.66 MB)
...
- **Records:** 832,685
- **Size:** 86.66 MB
- **Last Updated:** 2026-02-15 20:18 UTC
...
**Current Status:** 832,685 records | 86.66 MB | Growing every 2 hours
