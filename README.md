...
![Total Records](https://img.shields.io/badge/records-607,210-brightgreen)
![Database Size](https://img.shields.io/badge/size-63.06MB-blue)
...
> **Last Updated:** 2026-01-19 06:28:42 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **607,210** |
| 💾 **Database Size** | **63.06 MB** |
...
│ 📦 Products             │  16,980                        │
│ 🧾 Transaction Headers  │ ████████ 167,080               │
│ 📝 Transaction Lines    │ ████████████████████ 417,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,598 Suppliers (+ 3 per run)
- ✅ 1,732 Staff members (+ 2 per run)
- ✅ 16,980 Products (+ 10 per run)
- ✅ 167,080 Transactions (+ 20 per run)
- ✅ 417,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (63.06 MB)
...
- **Records:** 607,210
- **Size:** 63.06 MB
- **Last Updated:** 2026-01-19 06:28 UTC
...
**Current Status:** 607,210 records | 63.06 MB | Growing every 2 hours
