...
![Total Records](https://img.shields.io/badge/records-906,635-brightgreen)
![Database Size](https://img.shields.io/badge/size-94.45MB-blue)
...
> **Last Updated:** 2026-02-25 01:26:30 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **906,635** |
| 💾 **Database Size** | **94.45 MB** |
...
│ 📦 Products             │  25,240                        │
│ 🧾 Transaction Headers  │ ████████ 249,680               │
│ 📝 Transaction Lines    │ ████████████████████ 624,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,837 Suppliers (+ 3 per run)
- ✅ 2,558 Staff members (+ 2 per run)
- ✅ 25,240 Products (+ 10 per run)
- ✅ 249,680 Transactions (+ 20 per run)
- ✅ 624,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (94.45 MB)
...
- **Records:** 906,635
- **Size:** 94.45 MB
- **Last Updated:** 2026-02-25 01:26 UTC
...
**Current Status:** 906,635 records | 94.45 MB | Growing every 2 hours
