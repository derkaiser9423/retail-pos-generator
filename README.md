...
![Total Records](https://img.shields.io/badge/records-498,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-51.78MB-blue)
...
> **Last Updated:** 2026-01-06 18:21:28 UTC  
...
│ 📦 Products             │  13,980                        │
│ 🧾 Transaction Headers  │ ████████ 137,080               │
│ 📝 Transaction Lines    │ ████████████████████ 342,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,148 Suppliers (+ 3 per run)
- ✅ 1,432 Staff members (+ 2 per run)
- ✅ 13,980 Products (+ 10 per run)
- ✅ 137,080 Transactions (+ 20 per run)
- ✅ 342,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (51.78 MB)
...
**Current Status:** 498,460 records | 51.78 MB | Growing every 2 hours
