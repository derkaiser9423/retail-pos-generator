...
![Total Records](https://img.shields.io/badge/records-153,216-brightgreen)
![Database Size](https://img.shields.io/badge/size-15.56MB-blue)
...
> **Last Updated:** 2025-11-28 03:05:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **153,216** |
| 💾 **Database Size** | **15.56 MB** |
| 📅 **Last Updated** | November 28, 2025 at 03:05 UTC |
| 📈 **24h Growth** | +727 records |
...
│ 🏷️ Product Groups       │  674                           │
│ 📦 Products             │  4,460                         │
│ 🧾 Transaction Headers  │ ████████ 41,880                │
│ 📝 Transaction Lines    │ ████████████████████ 104,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 720 Suppliers (+ 3 per run)
- ✅ 480 Staff members (+ 2 per run)
- ✅ 4,460 Products (+ 10 per run)
- ✅ 41,880 Transactions (+ 20 per run)
- ✅ 104,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (15.56 MB)
...
- **Records:** 153,216
- **Size:** 15.56 MB
- **Last Updated:** 2025-11-28 03:05 UTC
...
**Current Status:** 153,216 records | 15.56 MB | Growing every 2 hours
