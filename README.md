...
![Total Records](https://img.shields.io/badge/records-643,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-66.9MB-blue)
...
> **Last Updated:** 2026-01-23 10:18:22 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **643,460** |
| 💾 **Database Size** | **66.9 MB** |
| 📅 **Last Updated** | January 23, 2026 at 10:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,980                        │
│ 🧾 Transaction Headers  │ ████████ 177,080               │
│ 📝 Transaction Lines    │ ████████████████████ 442,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,748 Suppliers (+ 3 per run)
- ✅ 1,832 Staff members (+ 2 per run)
- ✅ 17,980 Products (+ 10 per run)
- ✅ 177,080 Transactions (+ 20 per run)
- ✅ 442,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (66.9 MB)
...
- **Records:** 643,460
- **Size:** 66.9 MB
- **Last Updated:** 2026-01-23 10:18 UTC
...
**Current Status:** 643,460 records | 66.9 MB | Growing every 2 hours
