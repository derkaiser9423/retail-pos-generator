...
![Total Records](https://img.shields.io/badge/records-436,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-45.2MB-blue)
...
> **Last Updated:** 2025-12-30 16:18:26 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **436,835** |
| 💾 **Database Size** | **45.2 MB** |
| 📅 **Last Updated** | December 30, 2025 at 16:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  12,280                        │
│ 🧾 Transaction Headers  │ ████████ 120,080               │
│ 📝 Transaction Lines    │ ████████████████████ 300,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,893 Suppliers (+ 3 per run)
- ✅ 1,262 Staff members (+ 2 per run)
- ✅ 12,280 Products (+ 10 per run)
- ✅ 120,080 Transactions (+ 20 per run)
- ✅ 300,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (45.2 MB)
...
- **Records:** 436,835
- **Size:** 45.2 MB
- **Last Updated:** 2025-12-30 16:18 UTC
...
**Current Status:** 436,835 records | 45.2 MB | Growing every 2 hours
