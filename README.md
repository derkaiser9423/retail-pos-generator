...
![Total Records](https://img.shields.io/badge/records-325,184-brightgreen)
![Database Size](https://img.shields.io/badge/size-33.54MB-blue)
...
> **Last Updated:** 2025-12-17 20:16:15 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **325,184** |
| 💾 **Database Size** | **33.54 MB** |
| 📅 **Last Updated** | December 17, 2025 at 20:16 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  9,200                         │
│ 🧾 Transaction Headers  │ ████████ 89,280                │
│ 📝 Transaction Lines    │ ████████████████████ 223,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,431 Suppliers (+ 3 per run)
- ✅ 954 Staff members (+ 2 per run)
- ✅ 9,200 Products (+ 10 per run)
- ✅ 89,280 Transactions (+ 20 per run)
- ✅ 223,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (33.54 MB)
...
- **Records:** 325,184
- **Size:** 33.54 MB
- **Last Updated:** 2025-12-17 20:16 UTC
...
**Current Status:** 325,184 records | 33.54 MB | Growing every 2 hours
