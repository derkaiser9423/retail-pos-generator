...
![Total Records](https://img.shields.io/badge/records-422,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-43.7MB-blue)
...
> **Last Updated:** 2025-12-29 01:10:29 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **422,335** |
| 💾 **Database Size** | **43.7 MB** |
...
│ 📦 Products             │  11,880                        │
│ 🧾 Transaction Headers  │ ████████ 116,080               │
│ 📝 Transaction Lines    │ ████████████████████ 290,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,833 Suppliers (+ 3 per run)
- ✅ 1,222 Staff members (+ 2 per run)
- ✅ 11,880 Products (+ 10 per run)
- ✅ 116,080 Transactions (+ 20 per run)
- ✅ 290,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (43.7 MB)
...
- **Records:** 422,335
- **Size:** 43.7 MB
- **Last Updated:** 2025-12-29 01:10 UTC
...
**Current Status:** 422,335 records | 43.7 MB | Growing every 2 hours
