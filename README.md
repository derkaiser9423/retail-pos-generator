...
![Total Records](https://img.shields.io/badge/records-913,885-brightgreen)
![Database Size](https://img.shields.io/badge/size-95.23MB-blue)
...
> **Last Updated:** 2026-02-25 22:26:42 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **913,885** |
| 💾 **Database Size** | **95.23 MB** |
| 📅 **Last Updated** | February 25, 2026 at 22:26 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,440                        │
│ 🧾 Transaction Headers  │ ████████ 251,680               │
│ 📝 Transaction Lines    │ ████████████████████ 629,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,867 Suppliers (+ 3 per run)
- ✅ 2,578 Staff members (+ 2 per run)
- ✅ 25,440 Products (+ 10 per run)
- ✅ 251,680 Transactions (+ 20 per run)
- ✅ 629,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (95.23 MB)
...
- **Records:** 913,885
- **Size:** 95.23 MB
- **Last Updated:** 2026-02-25 22:26 UTC
...
**Current Status:** 913,885 records | 95.23 MB | Growing every 2 hours
