...
![Total Records](https://img.shields.io/badge/records-929,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.92MB-blue)
...
> **Last Updated:** 2026-02-27 22:18:28 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **929,835** |
| 💾 **Database Size** | **96.92 MB** |
| 📅 **Last Updated** | February 27, 2026 at 22:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,880                        │
│ 🧾 Transaction Headers  │ ████████ 256,080               │
│ 📝 Transaction Lines    │ ████████████████████ 640,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,933 Suppliers (+ 3 per run)
- ✅ 2,622 Staff members (+ 2 per run)
- ✅ 25,880 Products (+ 10 per run)
- ✅ 256,080 Transactions (+ 20 per run)
- ✅ 640,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.92 MB)
...
**Current Status:** 929,835 records | 96.92 MB | Growing every 2 hours
