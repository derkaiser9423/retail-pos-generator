...
![Total Records](https://img.shields.io/badge/records-269,351-brightgreen)
![Database Size](https://img.shields.io/badge/size-27.69MB-blue)
...
> **Last Updated:** 2025-12-11 10:16:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **269,351** |
| 💾 **Database Size** | **27.69 MB** |
...
│ 📦 Products             │  7,660                         │
│ 🧾 Transaction Headers  │ ████████ 73,880                │
│ 📝 Transaction Lines    │ ████████████████████ 184,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,200 Suppliers (+ 3 per run)
- ✅ 800 Staff members (+ 2 per run)
- ✅ 7,660 Products (+ 10 per run)
- ✅ 73,880 Transactions (+ 20 per run)
- ✅ 184,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (27.69 MB)
...
- **Records:** 269,351
- **Size:** 27.69 MB
- **Last Updated:** 2025-12-11 10:16 UTC
...
**Current Status:** 269,351 records | 27.69 MB | Growing every 2 hours
