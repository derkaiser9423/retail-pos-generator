...
![Total Records](https://img.shields.io/badge/records-618,810-brightgreen)
![Database Size](https://img.shields.io/badge/size-64.3MB-blue)
...
> **Last Updated:** 2026-01-20 14:24:16 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **618,810** |
| 💾 **Database Size** | **64.3 MB** |
| 📅 **Last Updated** | January 20, 2026 at 14:24 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,300                        │
│ 🧾 Transaction Headers  │ ████████ 170,280               │
│ 📝 Transaction Lines    │ ████████████████████ 425,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,646 Suppliers (+ 3 per run)
- ✅ 1,764 Staff members (+ 2 per run)
- ✅ 17,300 Products (+ 10 per run)
- ✅ 170,280 Transactions (+ 20 per run)
- ✅ 425,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (64.3 MB)
...
- **Records:** 618,810
- **Size:** 64.3 MB
- **Last Updated:** 2026-01-20 14:24 UTC
...
**Current Status:** 618,810 records | 64.3 MB | Growing every 2 hours
