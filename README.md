...
![Total Records](https://img.shields.io/badge/records-381,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-39.52MB-blue)
...
> **Last Updated:** 2025-12-24 08:20:08 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **381,735** |
| 💾 **Database Size** | **39.52 MB** |
| 📅 **Last Updated** | December 24, 2025 at 08:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  10,760                        │
│ 🧾 Transaction Headers  │ ████████ 104,880               │
│ 📝 Transaction Lines    │ ████████████████████ 262,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,665 Suppliers (+ 3 per run)
- ✅ 1,110 Staff members (+ 2 per run)
- ✅ 10,760 Products (+ 10 per run)
- ✅ 104,880 Transactions (+ 20 per run)
- ✅ 262,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (39.52 MB)
...
- **Records:** 381,735
- **Size:** 39.52 MB
- **Last Updated:** 2025-12-24 08:20 UTC
...
**Current Status:** 381,735 records | 39.52 MB | Growing every 2 hours
