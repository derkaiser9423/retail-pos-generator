...
![Total Records](https://img.shields.io/badge/records-734,810-brightgreen)
![Database Size](https://img.shields.io/badge/size-76.47MB-blue)
...
> **Last Updated:** 2026-02-03 12:41:07 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **734,810** |
| 💾 **Database Size** | **76.47 MB** |
...
│ 📦 Products             │  20,500                        │
│ 🧾 Transaction Headers  │ ████████ 202,280               │
│ 📝 Transaction Lines    │ ████████████████████ 505,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,126 Suppliers (+ 3 per run)
- ✅ 2,084 Staff members (+ 2 per run)
- ✅ 20,500 Products (+ 10 per run)
- ✅ 202,280 Transactions (+ 20 per run)
- ✅ 505,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (76.47 MB)
...
**Current Status:** 734,810 records | 76.47 MB | Growing every 2 hours
