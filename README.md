...
![Total Records](https://img.shields.io/badge/records-779,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-81.16MB-blue)
...
> **Last Updated:** 2026-02-09 04:21:21 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **779,760** |
| 💾 **Database Size** | **81.16 MB** |
| 📅 **Last Updated** | February 09, 2026 at 04:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,740                        │
│ 🧾 Transaction Headers  │ ████████ 214,680               │
│ 📝 Transaction Lines    │ ████████████████████ 536,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,312 Suppliers (+ 3 per run)
- ✅ 2,208 Staff members (+ 2 per run)
- ✅ 21,740 Products (+ 10 per run)
- ✅ 214,680 Transactions (+ 20 per run)
- ✅ 536,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (81.16 MB)
...
- **Records:** 779,760
- **Size:** 81.16 MB
- **Last Updated:** 2026-02-09 04:21 UTC
...
**Current Status:** 779,760 records | 81.16 MB | Growing every 2 hours
