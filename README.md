...
![Total Records](https://img.shields.io/badge/records-670,285-brightgreen)
![Database Size](https://img.shields.io/badge/size-69.59MB-blue)
...
> **Last Updated:** 2026-01-26 12:32:41 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **670,285** |
| 💾 **Database Size** | **69.59 MB** |
...
│ 📦 Products             │  18,720                        │
│ 🧾 Transaction Headers  │ ████████ 184,480               │
│ 📝 Transaction Lines    │ ████████████████████ 461,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,859 Suppliers (+ 3 per run)
- ✅ 1,906 Staff members (+ 2 per run)
- ✅ 18,720 Products (+ 10 per run)
- ✅ 184,480 Transactions (+ 20 per run)
- ✅ 461,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (69.59 MB)
...
- **Records:** 670,285
- **Size:** 69.59 MB
- **Last Updated:** 2026-01-26 12:32 UTC
...
**Current Status:** 670,285 records | 69.59 MB | Growing every 2 hours
