...
![Total Records](https://img.shields.io/badge/records-304,156-brightgreen)
![Database Size](https://img.shields.io/badge/size-31.38MB-blue)
...
> **Last Updated:** 2025-12-15 10:18:20 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **304,156** |
| 💾 **Database Size** | **31.38 MB** |
| 📅 **Last Updated** | December 15, 2025 at 10:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  8,620                         │
│ 🧾 Transaction Headers  │ ████████ 83,480                │
│ 📝 Transaction Lines    │ ████████████████████ 208,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,344 Suppliers (+ 3 per run)
- ✅ 896 Staff members (+ 2 per run)
- ✅ 8,620 Products (+ 10 per run)
- ✅ 83,480 Transactions (+ 20 per run)
- ✅ 208,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (31.38 MB)
...
- **Records:** 304,156
- **Size:** 31.38 MB
- **Last Updated:** 2025-12-15 10:18 UTC
...
**Current Status:** 304,156 records | 31.38 MB | Growing every 2 hours
