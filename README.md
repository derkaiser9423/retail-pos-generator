...
![Total Records](https://img.shields.io/badge/records-788,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.09MB-blue)
...
> **Last Updated:** 2026-02-10 08:43:37 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **788,460** |
| 💾 **Database Size** | **82.09 MB** |
| 📅 **Last Updated** | February 10, 2026 at 08:43 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,980                        │
│ 🧾 Transaction Headers  │ ████████ 217,080               │
│ 📝 Transaction Lines    │ ████████████████████ 542,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,348 Suppliers (+ 3 per run)
- ✅ 2,232 Staff members (+ 2 per run)
- ✅ 21,980 Products (+ 10 per run)
- ✅ 217,080 Transactions (+ 20 per run)
- ✅ 542,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.09 MB)
...
- **Records:** 788,460
- **Size:** 82.09 MB
- **Last Updated:** 2026-02-10 08:43 UTC
...
**Current Status:** 788,460 records | 82.09 MB | Growing every 2 hours
