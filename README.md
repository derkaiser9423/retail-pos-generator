...
![Total Records](https://img.shields.io/badge/records-950,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-99.16MB-blue)
...
> **Last Updated:** 2026-03-02 10:39:08 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **950,135** |
| 💾 **Database Size** | **99.16 MB** |
| 📅 **Last Updated** | March 02, 2026 at 10:39 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,440                        │
│ 🧾 Transaction Headers  │ ████████ 261,680               │
│ 📝 Transaction Lines    │ ████████████████████ 654,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 4,017 Suppliers (+ 3 per run)
- ✅ 2,678 Staff members (+ 2 per run)
- ✅ 26,440 Products (+ 10 per run)
- ✅ 261,680 Transactions (+ 20 per run)
- ✅ 654,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (99.16 MB)
...
- **Records:** 950,135
- **Size:** 99.16 MB
- **Last Updated:** 2026-03-02 10:39 UTC
...
**Current Status:** 950,135 records | 99.16 MB | Growing every 2 hours
