...
![Total Records](https://img.shields.io/badge/records-333,159-brightgreen)
![Database Size](https://img.shields.io/badge/size-34.32MB-blue)
...
> **Last Updated:** 2025-12-18 18:21:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **333,159** |
| 💾 **Database Size** | **34.32 MB** |
...
│ 📦 Products             │  9,420                         │
│ 🧾 Transaction Headers  │ ████████ 91,480                │
│ 📝 Transaction Lines    │ ████████████████████ 228,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,464 Suppliers (+ 3 per run)
- ✅ 976 Staff members (+ 2 per run)
- ✅ 9,420 Products (+ 10 per run)
- ✅ 91,480 Transactions (+ 20 per run)
- ✅ 228,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (34.32 MB)
...
- **Records:** 333,159
- **Size:** 34.32 MB
- **Last Updated:** 2025-12-18 18:21 UTC
...
**Current Status:** 333,159 records | 34.32 MB | Growing every 2 hours
