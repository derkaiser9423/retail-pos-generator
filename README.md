...
![Total Records](https://img.shields.io/badge/records-481,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-49.9MB-blue)
...
> **Last Updated:** 2026-01-04 18:19:29 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **481,060** |
| 💾 **Database Size** | **49.9 MB** |
...
│ 📦 Products             │  13,500                        │
│ 🧾 Transaction Headers  │ ████████ 132,280               │
│ 📝 Transaction Lines    │ ████████████████████ 330,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,076 Suppliers (+ 3 per run)
- ✅ 1,384 Staff members (+ 2 per run)
- ✅ 13,500 Products (+ 10 per run)
- ✅ 132,280 Transactions (+ 20 per run)
- ✅ 330,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (49.9 MB)
...
**Current Status:** 481,060 records | 49.9 MB | Growing every 2 hours
