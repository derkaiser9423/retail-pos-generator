...
![Total Records](https://img.shields.io/badge/records-411,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-42.61MB-blue)
...
> **Last Updated:** 2025-12-27 18:19:04 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **411,460** |
| 💾 **Database Size** | **42.61 MB** |
...
│ 📦 Products             │  11,580                        │
│ 🧾 Transaction Headers  │ ████████ 113,080               │
│ 📝 Transaction Lines    │ ████████████████████ 282,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,788 Suppliers (+ 3 per run)
- ✅ 1,192 Staff members (+ 2 per run)
- ✅ 11,580 Products (+ 10 per run)
- ✅ 113,080 Transactions (+ 20 per run)
- ✅ 282,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (42.61 MB)
...
**Current Status:** 411,460 records | 42.61 MB | Growing every 2 hours
