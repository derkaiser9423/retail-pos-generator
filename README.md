...
![Total Records](https://img.shields.io/badge/records-547,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-56.7MB-blue)
...
> **Last Updated:** 2026-01-12 08:22:46 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **547,035** |
| 💾 **Database Size** | **56.7 MB** |
| 📅 **Last Updated** | January 12, 2026 at 08:22 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  15,320                        │
│ 🧾 Transaction Headers  │ ████████ 150,480               │
│ 📝 Transaction Lines    │ ████████████████████ 376,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,349 Suppliers (+ 3 per run)
- ✅ 1,566 Staff members (+ 2 per run)
- ✅ 15,320 Products (+ 10 per run)
- ✅ 150,480 Transactions (+ 20 per run)
- ✅ 376,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (56.7 MB)
...
- **Records:** 547,035
- **Size:** 56.7 MB
- **Last Updated:** 2026-01-12 08:22 UTC
...
**Current Status:** 547,035 records | 56.7 MB | Growing every 2 hours
