...
![Total Records](https://img.shields.io/badge/records-618,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-64.24MB-blue)
...
> **Last Updated:** 2026-01-20 12:33:20 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **618,085** |
| 💾 **Database Size** | **64.24 MB** |
| 📅 **Last Updated** | January 20, 2026 at 12:33 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,280                        │
│ 🧾 Transaction Headers  │ ████████ 170,080               │
│ 📝 Transaction Lines    │ ████████████████████ 425,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,643 Suppliers (+ 3 per run)
- ✅ 1,762 Staff members (+ 2 per run)
- ✅ 17,280 Products (+ 10 per run)
- ✅ 170,080 Transactions (+ 20 per run)
- ✅ 425,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (64.24 MB)
...
- **Records:** 618,085
- **Size:** 64.24 MB
- **Last Updated:** 2026-01-20 12:33 UTC
...
**Current Status:** 618,085 records | 64.24 MB | Growing every 2 hours
