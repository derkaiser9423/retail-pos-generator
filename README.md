...
![Total Records](https://img.shields.io/badge/records-932,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.21MB-blue)
...
> **Last Updated:** 2026-02-28 06:30:27 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **932,735** |
| 💾 **Database Size** | **97.21 MB** |
| 📅 **Last Updated** | February 28, 2026 at 06:30 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,960                        │
│ 🧾 Transaction Headers  │ ████████ 256,880               │
│ 📝 Transaction Lines    │ ████████████████████ 642,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,945 Suppliers (+ 3 per run)
- ✅ 2,630 Staff members (+ 2 per run)
- ✅ 25,960 Products (+ 10 per run)
- ✅ 256,880 Transactions (+ 20 per run)
- ✅ 642,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.21 MB)
...
- **Records:** 932,735
- **Size:** 97.21 MB
- **Last Updated:** 2026-02-28 06:30 UTC
...
**Current Status:** 932,735 records | 97.21 MB | Growing every 2 hours
