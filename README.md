...
![Total Records](https://img.shields.io/badge/records-299,080-brightgreen)
![Database Size](https://img.shields.io/badge/size-30.85MB-blue)
...
> **Last Updated:** 2025-12-14 20:14:32 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **299,080** |
| 💾 **Database Size** | **30.85 MB** |
| 📅 **Last Updated** | December 14, 2025 at 20:14 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  8,480                         │
│ 🧾 Transaction Headers  │ ████████ 82,080                │
│ 📝 Transaction Lines    │ ████████████████████ 205,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,323 Suppliers (+ 3 per run)
- ✅ 882 Staff members (+ 2 per run)
- ✅ 8,480 Products (+ 10 per run)
- ✅ 82,080 Transactions (+ 20 per run)
- ✅ 205,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (30.85 MB)
...
- **Records:** 299,080
- **Size:** 30.85 MB
- **Last Updated:** 2025-12-14 20:14 UTC
...
**Current Status:** 299,080 records | 30.85 MB | Growing every 2 hours
