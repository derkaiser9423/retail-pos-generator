...
![Total Records](https://img.shields.io/badge/records-663,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-68.95MB-blue)
...
> **Last Updated:** 2026-01-25 18:20:59 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **663,760** |
| 💾 **Database Size** | **68.95 MB** |
...
│ 📦 Products             │  18,540                        │
│ 🧾 Transaction Headers  │ ████████ 182,680               │
│ 📝 Transaction Lines    │ ████████████████████ 456,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,832 Suppliers (+ 3 per run)
- ✅ 1,888 Staff members (+ 2 per run)
- ✅ 18,540 Products (+ 10 per run)
- ✅ 182,680 Transactions (+ 20 per run)
- ✅ 456,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (68.95 MB)
...
- **Records:** 663,760
- **Size:** 68.95 MB
- **Last Updated:** 2026-01-25 18:20 UTC
...
**Current Status:** 663,760 records | 68.95 MB | Growing every 2 hours
