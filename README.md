...
![Total Records](https://img.shields.io/badge/records-875,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-91.21MB-blue)
...
> **Last Updated:** 2026-02-21 05:09:31 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **875,460** |
| 💾 **Database Size** | **91.21 MB** |
| 📅 **Last Updated** | February 21, 2026 at 05:09 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,380                        │
│ 🧾 Transaction Headers  │ ████████ 241,080               │
│ 📝 Transaction Lines    │ ████████████████████ 602,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,708 Suppliers (+ 3 per run)
- ✅ 2,472 Staff members (+ 2 per run)
- ✅ 24,380 Products (+ 10 per run)
- ✅ 241,080 Transactions (+ 20 per run)
- ✅ 602,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (91.21 MB)
...
- **Records:** 875,460
- **Size:** 91.21 MB
- **Last Updated:** 2026-02-21 05:09 UTC
...
**Current Status:** 875,460 records | 91.21 MB | Growing every 2 hours
