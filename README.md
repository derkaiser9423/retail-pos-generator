...
![Total Records](https://img.shields.io/badge/records-837,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-87.16MB-blue)
...
> **Last Updated:** 2026-02-16 12:45:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **837,760** |
| 💾 **Database Size** | **87.16 MB** |
| 📅 **Last Updated** | February 16, 2026 at 12:45 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,340                        │
│ 🧾 Transaction Headers  │ ████████ 230,680               │
│ 📝 Transaction Lines    │ ████████████████████ 576,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,552 Suppliers (+ 3 per run)
- ✅ 2,368 Staff members (+ 2 per run)
- ✅ 23,340 Products (+ 10 per run)
- ✅ 230,680 Transactions (+ 20 per run)
- ✅ 576,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (87.16 MB)
...
**Current Status:** 837,760 records | 87.16 MB | Growing every 2 hours
