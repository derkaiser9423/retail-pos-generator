...
![Total Records](https://img.shields.io/badge/records-546,310-brightgreen)
![Database Size](https://img.shields.io/badge/size-56.63MB-blue)
...
> **Last Updated:** 2026-01-12 06:26:36 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **546,310** |
| 💾 **Database Size** | **56.63 MB** |
...
│ 📦 Products             │  15,300                        │
│ 🧾 Transaction Headers  │ ████████ 150,280               │
│ 📝 Transaction Lines    │ ████████████████████ 375,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,346 Suppliers (+ 3 per run)
- ✅ 1,564 Staff members (+ 2 per run)
- ✅ 15,300 Products (+ 10 per run)
- ✅ 150,280 Transactions (+ 20 per run)
- ✅ 375,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (56.63 MB)
...
- **Records:** 546,310
- **Size:** 56.63 MB
- **Last Updated:** 2026-01-12 06:26 UTC
...
**Current Status:** 546,310 records | 56.63 MB | Growing every 2 hours
