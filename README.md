...
![Total Records](https://img.shields.io/badge/records-504,260-brightgreen)
![Database Size](https://img.shields.io/badge/size-52.4MB-blue)
...
> **Last Updated:** 2026-01-07 10:17:27 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **504,260** |
| 💾 **Database Size** | **52.4 MB** |
| 📅 **Last Updated** | January 07, 2026 at 10:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,140                        │
│ 🧾 Transaction Headers  │ ████████ 138,680               │
│ 📝 Transaction Lines    │ ████████████████████ 346,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,172 Suppliers (+ 3 per run)
- ✅ 1,448 Staff members (+ 2 per run)
- ✅ 14,140 Products (+ 10 per run)
- ✅ 138,680 Transactions (+ 20 per run)
- ✅ 346,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (52.4 MB)
...
**Current Status:** 504,260 records | 52.4 MB | Growing every 2 hours
