...
![Total Records](https://img.shields.io/badge/records-494,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-51.33MB-blue)
...
> **Last Updated:** 2026-01-06 08:21:41 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **494,835** |
| 💾 **Database Size** | **51.33 MB** |
| 📅 **Last Updated** | January 06, 2026 at 08:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  13,880                        │
│ 🧾 Transaction Headers  │ ████████ 136,080               │
│ 📝 Transaction Lines    │ ████████████████████ 340,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,133 Suppliers (+ 3 per run)
- ✅ 1,422 Staff members (+ 2 per run)
- ✅ 13,880 Products (+ 10 per run)
- ✅ 136,080 Transactions (+ 20 per run)
- ✅ 340,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (51.33 MB)
...
- **Records:** 494,835
- **Size:** 51.33 MB
- **Last Updated:** 2026-01-06 08:21 UTC
...
**Current Status:** 494,835 records | 51.33 MB | Growing every 2 hours
