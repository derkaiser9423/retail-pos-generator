...
![Total Records](https://img.shields.io/badge/records-518,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-53.75MB-blue)
...
> **Last Updated:** 2026-01-09 01:07:42 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **518,035** |
| 💾 **Database Size** | **53.75 MB** |
...
│ 📦 Products             │  14,520                        │
│ 🧾 Transaction Headers  │ ████████ 142,480               │
│ 📝 Transaction Lines    │ ████████████████████ 356,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,229 Suppliers (+ 3 per run)
- ✅ 1,486 Staff members (+ 2 per run)
- ✅ 14,520 Products (+ 10 per run)
- ✅ 142,480 Transactions (+ 20 per run)
- ✅ 356,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (53.75 MB)
...
**Current Status:** 518,035 records | 53.75 MB | Growing every 2 hours
