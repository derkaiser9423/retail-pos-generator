...
![Total Records](https://img.shields.io/badge/records-278,052-brightgreen)
![Database Size](https://img.shields.io/badge/size-28.61MB-blue)
...
> **Last Updated:** 2025-12-12 10:15:24 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **278,052** |
| 💾 **Database Size** | **28.61 MB** |
| 📅 **Last Updated** | December 12, 2025 at 10:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  7,900                         │
│ 🧾 Transaction Headers  │ ████████ 76,280                │
│ 📝 Transaction Lines    │ ████████████████████ 190,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,236 Suppliers (+ 3 per run)
- ✅ 824 Staff members (+ 2 per run)
- ✅ 7,900 Products (+ 10 per run)
- ✅ 76,280 Transactions (+ 20 per run)
- ✅ 190,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (28.61 MB)
...
- **Records:** 278,052
- **Size:** 28.61 MB
- **Last Updated:** 2025-12-12 10:15 UTC
...
**Current Status:** 278,052 records | 28.61 MB | Growing every 2 hours
