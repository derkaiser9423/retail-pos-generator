...
![Total Records](https://img.shields.io/badge/records-722,485-brightgreen)
![Database Size](https://img.shields.io/badge/size-75.14MB-blue)
...
> **Last Updated:** 2026-02-01 18:25:02 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **722,485** |
| 💾 **Database Size** | **75.14 MB** |
| 📅 **Last Updated** | February 01, 2026 at 18:25 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,160                        │
│ 🧾 Transaction Headers  │ ████████ 198,880               │
│ 📝 Transaction Lines    │ ████████████████████ 497,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,075 Suppliers (+ 3 per run)
- ✅ 2,050 Staff members (+ 2 per run)
- ✅ 20,160 Products (+ 10 per run)
- ✅ 198,880 Transactions (+ 20 per run)
- ✅ 497,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (75.14 MB)
...
**Current Status:** 722,485 records | 75.14 MB | Growing every 2 hours
