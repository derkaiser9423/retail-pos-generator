...
![Total Records](https://img.shields.io/badge/records-464,385-brightgreen)
![Database Size](https://img.shields.io/badge/size-48.1MB-blue)
...
> **Last Updated:** 2026-01-02 20:15:18 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **464,385** |
| 💾 **Database Size** | **48.1 MB** |
| 📅 **Last Updated** | January 02, 2026 at 20:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  13,040                        │
│ 🧾 Transaction Headers  │ ████████ 127,680               │
│ 📝 Transaction Lines    │ ████████████████████ 319,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,007 Suppliers (+ 3 per run)
- ✅ 1,338 Staff members (+ 2 per run)
- ✅ 13,040 Products (+ 10 per run)
- ✅ 127,680 Transactions (+ 20 per run)
- ✅ 319,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (48.1 MB)
...
- **Records:** 464,385
- **Size:** 48.1 MB
- **Last Updated:** 2026-01-02 20:15 UTC
...
**Current Status:** 464,385 records | 48.1 MB | Growing every 2 hours
