...
![Total Records](https://img.shields.io/badge/records-910,985-brightgreen)
![Database Size](https://img.shields.io/badge/size-94.92MB-blue)
...
> **Last Updated:** 2026-02-25 14:45:58 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **910,985** |
| 💾 **Database Size** | **94.92 MB** |
| 📅 **Last Updated** | February 25, 2026 at 14:45 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,360                        │
│ 🧾 Transaction Headers  │ ████████ 250,880               │
│ 📝 Transaction Lines    │ ████████████████████ 627,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,855 Suppliers (+ 3 per run)
- ✅ 2,570 Staff members (+ 2 per run)
- ✅ 25,360 Products (+ 10 per run)
- ✅ 250,880 Transactions (+ 20 per run)
- ✅ 627,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (94.92 MB)
...
**Current Status:** 910,985 records | 94.92 MB | Growing every 2 hours
