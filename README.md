...
![Total Records](https://img.shields.io/badge/records-676,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-70.21MB-blue)
...
> **Last Updated:** 2026-01-27 04:41:41 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **676,085** |
| 💾 **Database Size** | **70.21 MB** |
| 📅 **Last Updated** | January 27, 2026 at 04:41 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,880                        │
│ 🧾 Transaction Headers  │ ████████ 186,080               │
│ 📝 Transaction Lines    │ ████████████████████ 465,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,883 Suppliers (+ 3 per run)
- ✅ 1,922 Staff members (+ 2 per run)
- ✅ 18,880 Products (+ 10 per run)
- ✅ 186,080 Transactions (+ 20 per run)
- ✅ 465,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (70.21 MB)
...
- **Records:** 676,085
- **Size:** 70.21 MB
- **Last Updated:** 2026-01-27 04:41 UTC
...
**Current Status:** 676,085 records | 70.21 MB | Growing every 2 hours
