...
![Total Records](https://img.shields.io/badge/records-384,635-brightgreen)
![Database Size](https://img.shields.io/badge/size-39.8MB-blue)
...
> **Last Updated:** 2025-12-24 16:17:39 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **384,635** |
| 💾 **Database Size** | **39.8 MB** |
| 📅 **Last Updated** | December 24, 2025 at 16:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  10,840                        │
│ 🧾 Transaction Headers  │ ████████ 105,680               │
│ 📝 Transaction Lines    │ ████████████████████ 264,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,677 Suppliers (+ 3 per run)
- ✅ 1,118 Staff members (+ 2 per run)
- ✅ 10,840 Products (+ 10 per run)
- ✅ 105,680 Transactions (+ 20 per run)
- ✅ 264,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (39.8 MB)
...
- **Records:** 384,635
- **Size:** 39.8 MB
- **Last Updated:** 2025-12-24 16:17 UTC
...
**Current Status:** 384,635 records | 39.8 MB | Growing every 2 hours
