...
![Total Records](https://img.shields.io/badge/records-713,785-brightgreen)
![Database Size](https://img.shields.io/badge/size-74.2MB-blue)
...
> **Last Updated:** 2026-01-31 16:19:46 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **713,785** |
| 💾 **Database Size** | **74.2 MB** |
| 📅 **Last Updated** | January 31, 2026 at 16:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  19,920                        │
│ 🧾 Transaction Headers  │ ████████ 196,480               │
│ 📝 Transaction Lines    │ ████████████████████ 491,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,039 Suppliers (+ 3 per run)
- ✅ 2,026 Staff members (+ 2 per run)
- ✅ 19,920 Products (+ 10 per run)
- ✅ 196,480 Transactions (+ 20 per run)
- ✅ 491,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (74.2 MB)
...
- **Records:** 713,785
- **Size:** 74.2 MB
- **Last Updated:** 2026-01-31 16:19 UTC
...
**Current Status:** 713,785 records | 74.2 MB | Growing every 2 hours
