...
![Total Records](https://img.shields.io/badge/records-377,385-brightgreen)
![Database Size](https://img.shields.io/badge/size-39.04MB-blue)
...
> **Last Updated:** 2025-12-23 20:15:18 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **377,385** |
| 💾 **Database Size** | **39.04 MB** |
| 📅 **Last Updated** | December 23, 2025 at 20:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  10,640                        │
│ 🧾 Transaction Headers  │ ████████ 103,680               │
│ 📝 Transaction Lines    │ ████████████████████ 259,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,647 Suppliers (+ 3 per run)
- ✅ 1,098 Staff members (+ 2 per run)
- ✅ 10,640 Products (+ 10 per run)
- ✅ 103,680 Transactions (+ 20 per run)
- ✅ 259,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (39.04 MB)
...
- **Records:** 377,385
- **Size:** 39.04 MB
- **Last Updated:** 2025-12-23 20:15 UTC
...
**Current Status:** 377,385 records | 39.04 MB | Growing every 2 hours
