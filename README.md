...
![Total Records](https://img.shields.io/badge/records-660,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-68.57MB-blue)
...
> **Last Updated:** 2026-01-25 08:19:39 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **660,135** |
| 💾 **Database Size** | **68.57 MB** |
| 📅 **Last Updated** | January 25, 2026 at 08:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,440                        │
│ 🧾 Transaction Headers  │ ████████ 181,680               │
│ 📝 Transaction Lines    │ ████████████████████ 454,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,817 Suppliers (+ 3 per run)
- ✅ 1,878 Staff members (+ 2 per run)
- ✅ 18,440 Products (+ 10 per run)
- ✅ 181,680 Transactions (+ 20 per run)
- ✅ 454,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (68.57 MB)
...
- **Records:** 660,135
- **Size:** 68.57 MB
- **Last Updated:** 2026-01-25 08:19 UTC
...
**Current Status:** 660,135 records | 68.57 MB | Growing every 2 hours
