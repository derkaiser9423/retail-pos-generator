...
![Total Records](https://img.shields.io/badge/records-939,260-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.93MB-blue)
...
> **Last Updated:** 2026-03-01 01:30:27 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **939,260** |
| 💾 **Database Size** | **97.93 MB** |
| 📅 **Last Updated** | March 01, 2026 at 01:30 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,140                        │
│ 🧾 Transaction Headers  │ ████████ 258,680               │
│ 📝 Transaction Lines    │ ████████████████████ 646,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,972 Suppliers (+ 3 per run)
- ✅ 2,648 Staff members (+ 2 per run)
- ✅ 26,140 Products (+ 10 per run)
- ✅ 258,680 Transactions (+ 20 per run)
- ✅ 646,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.93 MB)
...
**Current Status:** 939,260 records | 97.93 MB | Growing every 2 hours
