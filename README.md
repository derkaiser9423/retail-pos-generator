...
![Total Records](https://img.shields.io/badge/records-559,360-brightgreen)
![Database Size](https://img.shields.io/badge/size-58.05MB-blue)
...
> **Last Updated:** 2026-01-13 18:23:09 UTC  
...
│ 📦 Products             │  15,660                        │
│ 🧾 Transaction Headers  │ ████████ 153,880               │
│ 📝 Transaction Lines    │ ████████████████████ 384,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,400 Suppliers (+ 3 per run)
- ✅ 1,600 Staff members (+ 2 per run)
- ✅ 15,660 Products (+ 10 per run)
- ✅ 153,880 Transactions (+ 20 per run)
- ✅ 384,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (58.05 MB)
...
- **Records:** 559,360
- **Size:** 58.05 MB
- **Last Updated:** 2026-01-13 18:23 UTC
...
**Current Status:** 559,360 records | 58.05 MB | Growing every 2 hours
