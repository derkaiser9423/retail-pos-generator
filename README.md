...
![Total Records](https://img.shields.io/badge/records-795,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.82MB-blue)
...
> **Last Updated:** 2026-02-11 06:54:33 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **795,710** |
| 💾 **Database Size** | **82.82 MB** |
| 📅 **Last Updated** | February 11, 2026 at 06:54 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,180                        │
│ 🧾 Transaction Headers  │ ████████ 219,080               │
│ 📝 Transaction Lines    │ ████████████████████ 547,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,378 Suppliers (+ 3 per run)
- ✅ 2,252 Staff members (+ 2 per run)
- ✅ 22,180 Products (+ 10 per run)
- ✅ 219,080 Transactions (+ 20 per run)
- ✅ 547,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.82 MB)
...
**Current Status:** 795,710 records | 82.82 MB | Growing every 2 hours
