...
![Total Records](https://img.shields.io/badge/records-371,585-brightgreen)
![Database Size](https://img.shields.io/badge/size-38.41MB-blue)
...
> **Last Updated:** 2025-12-23 04:32:02 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **371,585** |
| 💾 **Database Size** | **38.41 MB** |
| 📅 **Last Updated** | December 23, 2025 at 04:32 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  10,480                        │
│ 🧾 Transaction Headers  │ ████████ 102,080               │
│ 📝 Transaction Lines    │ ████████████████████ 255,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,623 Suppliers (+ 3 per run)
- ✅ 1,082 Staff members (+ 2 per run)
- ✅ 10,480 Products (+ 10 per run)
- ✅ 102,080 Transactions (+ 20 per run)
- ✅ 255,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (38.41 MB)
...
- **Records:** 371,585
- **Size:** 38.41 MB
- **Last Updated:** 2025-12-23 04:32 UTC
...
**Current Status:** 371,585 records | 38.41 MB | Growing every 2 hours
