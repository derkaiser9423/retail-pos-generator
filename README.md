...
![Total Records](https://img.shields.io/badge/records-135,037-brightgreen)
![Database Size](https://img.shields.io/badge/size-13.75MB-blue)
...
> **Last Updated:** 2025-11-26 01:01:16 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **135,037** |
| 💾 **Database Size** | **13.75 MB** |
...
│ 🏷️ Product Groups       │  620                           │
│ 📦 Products             │  3,960                         │
│ 🧾 Transaction Headers  │ ████████ 36,880                │
│ 📝 Transaction Lines    │ ████████████████████ 92,200    │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 645 Suppliers (+ 3 per run)
- ✅ 430 Staff members (+ 2 per run)
- ✅ 3,960 Products (+ 10 per run)
- ✅ 36,880 Transactions (+ 20 per run)
- ✅ 92,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (13.75 MB)
...
- **Records:** 135,037
- **Size:** 13.75 MB
- **Last Updated:** 2025-11-26 01:01 UTC
...
**Current Status:** 135,037 records | 13.75 MB | Growing every 2 hours
