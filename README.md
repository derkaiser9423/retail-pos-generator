...
![Total Records](https://img.shields.io/badge/records-789,910-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.25MB-blue)
...
> **Last Updated:** 2026-02-10 12:56:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **789,910** |
| 💾 **Database Size** | **82.25 MB** |
...
│ 📦 Products             │  22,020                        │
│ 🧾 Transaction Headers  │ ████████ 217,480               │
│ 📝 Transaction Lines    │ ████████████████████ 543,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,354 Suppliers (+ 3 per run)
- ✅ 2,236 Staff members (+ 2 per run)
- ✅ 22,020 Products (+ 10 per run)
- ✅ 217,480 Transactions (+ 20 per run)
- ✅ 543,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.25 MB)
...
- **Records:** 789,910
- **Size:** 82.25 MB
- **Last Updated:** 2026-02-10 12:56 UTC
...
**Current Status:** 789,910 records | 82.25 MB | Growing every 2 hours
