...
![Total Records](https://img.shields.io/badge/records-674,635-brightgreen)
![Database Size](https://img.shields.io/badge/size-70.04MB-blue)
...
> **Last Updated:** 2026-01-27 01:12:52 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **674,635** |
| 💾 **Database Size** | **70.04 MB** |
| 📅 **Last Updated** | January 27, 2026 at 01:12 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,840                        │
│ 🧾 Transaction Headers  │ ████████ 185,680               │
│ 📝 Transaction Lines    │ ████████████████████ 464,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,877 Suppliers (+ 3 per run)
- ✅ 1,918 Staff members (+ 2 per run)
- ✅ 18,840 Products (+ 10 per run)
- ✅ 185,680 Transactions (+ 20 per run)
- ✅ 464,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (70.04 MB)
...
**Current Status:** 674,635 records | 70.04 MB | Growing every 2 hours
