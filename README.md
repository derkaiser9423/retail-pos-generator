...
![Total Records](https://img.shields.io/badge/records-494,110-brightgreen)
![Database Size](https://img.shields.io/badge/size-51.25MB-blue)
...
> **Last Updated:** 2026-01-06 06:23:14 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **494,110** |
| 💾 **Database Size** | **51.25 MB** |
...
│ 📦 Products             │  13,860                        │
│ 🧾 Transaction Headers  │ ████████ 135,880               │
│ 📝 Transaction Lines    │ ████████████████████ 339,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,130 Suppliers (+ 3 per run)
- ✅ 1,420 Staff members (+ 2 per run)
- ✅ 13,860 Products (+ 10 per run)
- ✅ 135,880 Transactions (+ 20 per run)
- ✅ 339,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (51.25 MB)
...
- **Records:** 494,110
- **Size:** 51.25 MB
- **Last Updated:** 2026-01-06 06:23 UTC
...
**Current Status:** 494,110 records | 51.25 MB | Growing every 2 hours
