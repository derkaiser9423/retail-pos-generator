...
![Total Records](https://img.shields.io/badge/records-620,985-brightgreen)
![Database Size](https://img.shields.io/badge/size-64.55MB-blue)
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **620,985** |
| 💾 **Database Size** | **64.55 MB** |
| 📅 **Last Updated** | January 20, 2026 at 20:39 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,360                        │
│ 🧾 Transaction Headers  │ ████████ 170,880               │
│ 📝 Transaction Lines    │ ████████████████████ 427,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,655 Suppliers (+ 3 per run)
- ✅ 1,770 Staff members (+ 2 per run)
- ✅ 17,360 Products (+ 10 per run)
- ✅ 170,880 Transactions (+ 20 per run)
- ✅ 427,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (64.55 MB)
...
**Current Status:** 620,985 records | 64.55 MB | Growing every 2 hours
