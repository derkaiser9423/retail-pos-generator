...
![Total Records](https://img.shields.io/badge/records-772,510-brightgreen)
![Database Size](https://img.shields.io/badge/size-80.37MB-blue)
...
> **Last Updated:** 2026-02-08 06:41:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **772,510** |
| 💾 **Database Size** | **80.37 MB** |
| 📅 **Last Updated** | February 08, 2026 at 06:41 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,540                        │
│ 🧾 Transaction Headers  │ ████████ 212,680               │
│ 📝 Transaction Lines    │ ████████████████████ 531,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,282 Suppliers (+ 3 per run)
- ✅ 2,188 Staff members (+ 2 per run)
- ✅ 21,540 Products (+ 10 per run)
- ✅ 212,680 Transactions (+ 20 per run)
- ✅ 531,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (80.37 MB)
...
**Current Status:** 772,510 records | 80.37 MB | Growing every 2 hours
