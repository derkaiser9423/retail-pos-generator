...
![Total Records](https://img.shields.io/badge/records-332,434-brightgreen)
![Database Size](https://img.shields.io/badge/size-34.23MB-blue)
...
> **Last Updated:** 2025-12-18 16:19:46 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **332,434** |
| 💾 **Database Size** | **34.23 MB** |
...
│ 📦 Products             │  9,400                         │
│ 🧾 Transaction Headers  │ ████████ 91,280                │
│ 📝 Transaction Lines    │ ████████████████████ 228,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,461 Suppliers (+ 3 per run)
- ✅ 974 Staff members (+ 2 per run)
- ✅ 9,400 Products (+ 10 per run)
- ✅ 91,280 Transactions (+ 20 per run)
- ✅ 228,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (34.23 MB)
...
**Current Status:** 332,434 records | 34.23 MB | Growing every 2 hours
