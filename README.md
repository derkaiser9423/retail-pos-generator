...
![Total Records](https://img.shields.io/badge/records-658,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-68.45MB-blue)
...
> **Last Updated:** 2026-01-25 04:46:59 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **658,685** |
| 💾 **Database Size** | **68.45 MB** |
| 📅 **Last Updated** | January 25, 2026 at 04:46 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,400                        │
│ 🧾 Transaction Headers  │ ████████ 181,280               │
│ 📝 Transaction Lines    │ ████████████████████ 453,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,811 Suppliers (+ 3 per run)
- ✅ 1,874 Staff members (+ 2 per run)
- ✅ 18,400 Products (+ 10 per run)
- ✅ 181,280 Transactions (+ 20 per run)
- ✅ 453,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (68.45 MB)
...
- **Records:** 658,685
- **Size:** 68.45 MB
- **Last Updated:** 2026-01-25 04:46 UTC
...
**Current Status:** 658,685 records | 68.45 MB | Growing every 2 hours
