...
![Total Records](https://img.shields.io/badge/records-561,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-58.32MB-blue)
...
> **Last Updated:** 2026-01-14 01:09:47 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **561,535** |
| 💾 **Database Size** | **58.32 MB** |
...
│ 📦 Products             │  15,720                        │
│ 🧾 Transaction Headers  │ ████████ 154,480               │
│ 📝 Transaction Lines    │ ████████████████████ 386,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,409 Suppliers (+ 3 per run)
- ✅ 1,606 Staff members (+ 2 per run)
- ✅ 15,720 Products (+ 10 per run)
- ✅ 154,480 Transactions (+ 20 per run)
- ✅ 386,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (58.32 MB)
...
**Current Status:** 561,535 records | 58.32 MB | Growing every 2 hours
