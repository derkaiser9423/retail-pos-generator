...
![Total Records](https://img.shields.io/badge/records-880,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-91.68MB-blue)
...
> **Last Updated:** 2026-02-21 18:25:33 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **880,535** |
| 💾 **Database Size** | **91.68 MB** |
| 📅 **Last Updated** | February 21, 2026 at 18:25 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,520                        │
│ 🧾 Transaction Headers  │ ████████ 242,480               │
│ 📝 Transaction Lines    │ ████████████████████ 606,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,729 Suppliers (+ 3 per run)
- ✅ 2,486 Staff members (+ 2 per run)
- ✅ 24,520 Products (+ 10 per run)
- ✅ 242,480 Transactions (+ 20 per run)
- ✅ 606,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (91.68 MB)
...
- **Records:** 880,535
- **Size:** 91.68 MB
- **Last Updated:** 2026-02-21 18:25 UTC
...
**Current Status:** 880,535 records | 91.68 MB | Growing every 2 hours
