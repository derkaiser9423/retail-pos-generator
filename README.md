...
![Total Records](https://img.shields.io/badge/records-831,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-86.56MB-blue)
...
> **Last Updated:** 2026-02-15 18:26:33 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **831,960** |
| 💾 **Database Size** | **86.56 MB** |
| 📅 **Last Updated** | February 15, 2026 at 18:26 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,180                        │
│ 🧾 Transaction Headers  │ ████████ 229,080               │
│ 📝 Transaction Lines    │ ████████████████████ 572,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,528 Suppliers (+ 3 per run)
- ✅ 2,352 Staff members (+ 2 per run)
- ✅ 23,180 Products (+ 10 per run)
- ✅ 229,080 Transactions (+ 20 per run)
- ✅ 572,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (86.56 MB)
...
- **Records:** 831,960
- **Size:** 86.56 MB
- **Last Updated:** 2026-02-15 18:26 UTC
...
**Current Status:** 831,960 records | 86.56 MB | Growing every 2 hours
