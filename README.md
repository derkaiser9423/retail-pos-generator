...
![Total Records](https://img.shields.io/badge/records-697,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-72.56MB-blue)
...
> **Last Updated:** 2026-01-29 18:34:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **697,835** |
| 💾 **Database Size** | **72.56 MB** |
...
│ 📦 Products             │  19,480                        │
│ 🧾 Transaction Headers  │ ████████ 192,080               │
│ 📝 Transaction Lines    │ ████████████████████ 480,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,973 Suppliers (+ 3 per run)
- ✅ 1,982 Staff members (+ 2 per run)
- ✅ 19,480 Products (+ 10 per run)
- ✅ 192,080 Transactions (+ 20 per run)
- ✅ 480,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (72.56 MB)
...
**Current Status:** 697,835 records | 72.56 MB | Growing every 2 hours
