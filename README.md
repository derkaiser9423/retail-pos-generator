...
![Total Records](https://img.shields.io/badge/records-340,409-brightgreen)
![Database Size](https://img.shields.io/badge/size-35.07MB-blue)
...
> **Last Updated:** 2025-12-19 14:14:29 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **340,409** |
| 💾 **Database Size** | **35.07 MB** |
| 📅 **Last Updated** | December 19, 2025 at 14:14 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  9,620                         │
│ 🧾 Transaction Headers  │ ████████ 93,480                │
│ 📝 Transaction Lines    │ ████████████████████ 233,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,494 Suppliers (+ 3 per run)
- ✅ 996 Staff members (+ 2 per run)
- ✅ 9,620 Products (+ 10 per run)
- ✅ 93,480 Transactions (+ 20 per run)
- ✅ 233,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (35.07 MB)
...
**Current Status:** 340,409 records | 35.07 MB | Growing every 2 hours
