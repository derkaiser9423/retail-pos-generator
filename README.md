...
![Total Records](https://img.shields.io/badge/records-605,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-62.89MB-blue)
...
> **Last Updated:** 2026-01-19 03:44:30 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **605,760** |
| 💾 **Database Size** | **62.89 MB** |
| 📅 **Last Updated** | January 19, 2026 at 03:44 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,940                        │
│ 🧾 Transaction Headers  │ ████████ 166,680               │
│ 📝 Transaction Lines    │ ████████████████████ 416,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,592 Suppliers (+ 3 per run)
- ✅ 1,728 Staff members (+ 2 per run)
- ✅ 16,940 Products (+ 10 per run)
- ✅ 166,680 Transactions (+ 20 per run)
- ✅ 416,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (62.89 MB)
...
- **Records:** 605,760
- **Size:** 62.89 MB
- **Last Updated:** 2026-01-19 03:44 UTC
...
**Current Status:** 605,760 records | 62.89 MB | Growing every 2 hours
