...
![Total Records](https://img.shields.io/badge/records-914,610-brightgreen)
![Database Size](https://img.shields.io/badge/size-95.32MB-blue)
...
> **Last Updated:** 2026-02-26 01:21:57 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **914,610** |
| 💾 **Database Size** | **95.32 MB** |
| 📅 **Last Updated** | February 26, 2026 at 01:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,460                        │
│ 🧾 Transaction Headers  │ ████████ 251,880               │
│ 📝 Transaction Lines    │ ████████████████████ 629,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,870 Suppliers (+ 3 per run)
- ✅ 2,580 Staff members (+ 2 per run)
- ✅ 25,460 Products (+ 10 per run)
- ✅ 251,880 Transactions (+ 20 per run)
- ✅ 629,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (95.32 MB)
...
- **Records:** 914,610
- **Size:** 95.32 MB
- **Last Updated:** 2026-02-26 01:21 UTC
...
**Current Status:** 914,610 records | 95.32 MB | Growing every 2 hours
