...
![Total Records](https://img.shields.io/badge/records-639,110-brightgreen)
![Database Size](https://img.shields.io/badge/size-66.46MB-blue)
...
> **Last Updated:** 2026-01-22 22:16:19 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **639,110** |
| 💾 **Database Size** | **66.46 MB** |
| 📅 **Last Updated** | January 22, 2026 at 22:16 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,860                        │
│ 🧾 Transaction Headers  │ ████████ 175,880               │
│ 📝 Transaction Lines    │ ████████████████████ 439,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,730 Suppliers (+ 3 per run)
- ✅ 1,820 Staff members (+ 2 per run)
- ✅ 17,860 Products (+ 10 per run)
- ✅ 175,880 Transactions (+ 20 per run)
- ✅ 439,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (66.46 MB)
...
- **Records:** 639,110
- **Size:** 66.46 MB
- **Last Updated:** 2026-01-22 22:16 UTC
...
**Current Status:** 639,110 records | 66.46 MB | Growing every 2 hours
