...
![Total Records](https://img.shields.io/badge/records-507,160-brightgreen)
![Database Size](https://img.shields.io/badge/size-52.68MB-blue)
...
> **Last Updated:** 2026-01-07 18:22:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **507,160** |
| 💾 **Database Size** | **52.68 MB** |
...
│ 📦 Products             │  14,220                        │
│ 🧾 Transaction Headers  │ ████████ 139,480               │
│ 📝 Transaction Lines    │ ████████████████████ 348,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,184 Suppliers (+ 3 per run)
- ✅ 1,456 Staff members (+ 2 per run)
- ✅ 14,220 Products (+ 10 per run)
- ✅ 139,480 Transactions (+ 20 per run)
- ✅ 348,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (52.68 MB)
...
- **Records:** 507,160
- **Size:** 52.68 MB
- **Last Updated:** 2026-01-07 18:22 UTC
...
**Current Status:** 507,160 records | 52.68 MB | Growing every 2 hours
