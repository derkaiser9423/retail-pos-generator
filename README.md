...
![Total Records](https://img.shields.io/badge/records-798,610-brightgreen)
![Database Size](https://img.shields.io/badge/size-83.11MB-blue)
...
> **Last Updated:** 2026-02-11 14:48:40 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **798,610** |
| 💾 **Database Size** | **83.11 MB** |
| 📅 **Last Updated** | February 11, 2026 at 14:48 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,260                        │
│ 🧾 Transaction Headers  │ ████████ 219,880               │
│ 📝 Transaction Lines    │ ████████████████████ 549,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,390 Suppliers (+ 3 per run)
- ✅ 2,260 Staff members (+ 2 per run)
- ✅ 22,260 Products (+ 10 per run)
- ✅ 219,880 Transactions (+ 20 per run)
- ✅ 549,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (83.11 MB)
...
**Current Status:** 798,610 records | 83.11 MB | Growing every 2 hours
