...
![Total Records](https://img.shields.io/badge/records-915,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-95.4MB-blue)
...
> **Last Updated:** 2026-02-26 04:11:40 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **915,335** |
| 💾 **Database Size** | **95.4 MB** |
| 📅 **Last Updated** | February 26, 2026 at 04:11 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,480                        │
│ 🧾 Transaction Headers  │ ████████ 252,080               │
│ 📝 Transaction Lines    │ ████████████████████ 630,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,873 Suppliers (+ 3 per run)
- ✅ 2,582 Staff members (+ 2 per run)
- ✅ 25,480 Products (+ 10 per run)
- ✅ 252,080 Transactions (+ 20 per run)
- ✅ 630,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (95.4 MB)
...
- **Records:** 915,335
- **Size:** 95.4 MB
- **Last Updated:** 2026-02-26 04:11 UTC
...
**Current Status:** 915,335 records | 95.4 MB | Growing every 2 hours
