...
![Total Records](https://img.shields.io/badge/records-548,485-brightgreen)
![Database Size](https://img.shields.io/badge/size-56.87MB-blue)
...
> **Last Updated:** 2026-01-12 12:31:37 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **548,485** |
| 💾 **Database Size** | **56.87 MB** |
| 📅 **Last Updated** | January 12, 2026 at 12:31 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  15,360                        │
│ 🧾 Transaction Headers  │ ████████ 150,880               │
│ 📝 Transaction Lines    │ ████████████████████ 377,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,355 Suppliers (+ 3 per run)
- ✅ 1,570 Staff members (+ 2 per run)
- ✅ 15,360 Products (+ 10 per run)
- ✅ 150,880 Transactions (+ 20 per run)
- ✅ 377,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (56.87 MB)
...
- **Records:** 548,485
- **Size:** 56.87 MB
- **Last Updated:** 2026-01-12 12:31 UTC
...
**Current Status:** 548,485 records | 56.87 MB | Growing every 2 hours
