...
![Total Records](https://img.shields.io/badge/records-359,260-brightgreen)
![Database Size](https://img.shields.io/badge/size-37.04MB-blue)
...
> **Last Updated:** 2025-12-21 18:18:42 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **359,260** |
| 💾 **Database Size** | **37.04 MB** |
| 📅 **Last Updated** | December 21, 2025 at 18:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  10,140                        │
│ 🧾 Transaction Headers  │ ████████ 98,680                │
│ 📝 Transaction Lines    │ ████████████████████ 246,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,572 Suppliers (+ 3 per run)
- ✅ 1,048 Staff members (+ 2 per run)
- ✅ 10,140 Products (+ 10 per run)
- ✅ 98,680 Transactions (+ 20 per run)
- ✅ 246,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (37.04 MB)
...
**Current Status:** 359,260 records | 37.04 MB | Growing every 2 hours
