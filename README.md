...
![Total Records](https://img.shields.io/badge/records-780,485-brightgreen)
![Database Size](https://img.shields.io/badge/size-81.25MB-blue)
...
> **Last Updated:** 2026-02-09 06:57:53 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **780,485** |
| 💾 **Database Size** | **81.25 MB** |
| 📅 **Last Updated** | February 09, 2026 at 06:57 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,760                        │
│ 🧾 Transaction Headers  │ ████████ 214,880               │
│ 📝 Transaction Lines    │ ████████████████████ 537,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,315 Suppliers (+ 3 per run)
- ✅ 2,210 Staff members (+ 2 per run)
- ✅ 21,760 Products (+ 10 per run)
- ✅ 214,880 Transactions (+ 20 per run)
- ✅ 537,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (81.25 MB)
...
- **Records:** 780,485
- **Size:** 81.25 MB
- **Last Updated:** 2026-02-09 06:57 UTC
...
**Current Status:** 780,485 records | 81.25 MB | Growing every 2 hours
