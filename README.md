...
![Total Records](https://img.shields.io/badge/records-853,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-88.86MB-blue)
...
> **Last Updated:** 2026-02-18 12:44:16 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **853,710** |
| 💾 **Database Size** | **88.86 MB** |
...
│ 📦 Products             │  23,780                        │
│ 🧾 Transaction Headers  │ ████████ 235,080               │
│ 📝 Transaction Lines    │ ████████████████████ 587,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,618 Suppliers (+ 3 per run)
- ✅ 2,412 Staff members (+ 2 per run)
- ✅ 23,780 Products (+ 10 per run)
- ✅ 235,080 Transactions (+ 20 per run)
- ✅ 587,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (88.86 MB)
...
- **Records:** 853,710
- **Size:** 88.86 MB
- **Last Updated:** 2026-02-18 12:44 UTC
...
**Current Status:** 853,710 records | 88.86 MB | Growing every 2 hours
