...
![Total Records](https://img.shields.io/badge/records-917,510-brightgreen)
![Database Size](https://img.shields.io/badge/size-95.64MB-blue)
...
> **Last Updated:** 2026-02-26 10:40:15 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **917,510** |
| 💾 **Database Size** | **95.64 MB** |
| 📅 **Last Updated** | February 26, 2026 at 10:40 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,540                        │
│ 🧾 Transaction Headers  │ ████████ 252,680               │
│ 📝 Transaction Lines    │ ████████████████████ 631,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,882 Suppliers (+ 3 per run)
- ✅ 2,588 Staff members (+ 2 per run)
- ✅ 25,540 Products (+ 10 per run)
- ✅ 252,680 Transactions (+ 20 per run)
- ✅ 631,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (95.64 MB)
...
**Current Status:** 917,510 records | 95.64 MB | Growing every 2 hours
