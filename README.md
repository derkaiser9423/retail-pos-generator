...
![Total Records](https://img.shields.io/badge/records-921,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.04MB-blue)
...
> **Last Updated:** 2026-02-26 20:30:20 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **921,135** |
| 💾 **Database Size** | **96.04 MB** |
| 📅 **Last Updated** | February 26, 2026 at 20:30 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,640                        │
│ 🧾 Transaction Headers  │ ████████ 253,680               │
│ 📝 Transaction Lines    │ ████████████████████ 634,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,897 Suppliers (+ 3 per run)
- ✅ 2,598 Staff members (+ 2 per run)
- ✅ 25,640 Products (+ 10 per run)
- ✅ 253,680 Transactions (+ 20 per run)
- ✅ 634,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.04 MB)
...
**Current Status:** 921,135 records | 96.04 MB | Growing every 2 hours
