...
![Total Records](https://img.shields.io/badge/records-694,935-brightgreen)
![Database Size](https://img.shields.io/badge/size-72.27MB-blue)
...
> **Last Updated:** 2026-01-29 10:29:45 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **694,935** |
| 💾 **Database Size** | **72.27 MB** |
| 📅 **Last Updated** | January 29, 2026 at 10:29 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  19,400                        │
│ 🧾 Transaction Headers  │ ████████ 191,280               │
│ 📝 Transaction Lines    │ ████████████████████ 478,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,961 Suppliers (+ 3 per run)
- ✅ 1,974 Staff members (+ 2 per run)
- ✅ 19,400 Products (+ 10 per run)
- ✅ 191,280 Transactions (+ 20 per run)
- ✅ 478,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (72.27 MB)
...
- **Records:** 694,935
- **Size:** 72.27 MB
- **Last Updated:** 2026-01-29 10:29 UTC
...
**Current Status:** 694,935 records | 72.27 MB | Growing every 2 hours
