...
![Total Records](https://img.shields.io/badge/records-620,260-brightgreen)
![Database Size](https://img.shields.io/badge/size-64.47MB-blue)
...
> **Last Updated:** 2026-01-20 18:26:20 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **620,260** |
| 💾 **Database Size** | **64.47 MB** |
...
│ 📦 Products             │  17,340                        │
│ 🧾 Transaction Headers  │ ████████ 170,680               │
│ 📝 Transaction Lines    │ ████████████████████ 426,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,652 Suppliers (+ 3 per run)
- ✅ 1,768 Staff members (+ 2 per run)
- ✅ 17,340 Products (+ 10 per run)
- ✅ 170,680 Transactions (+ 20 per run)
- ✅ 426,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (64.47 MB)
...
- **Records:** 620,260
- **Size:** 64.47 MB
- **Last Updated:** 2026-01-20 18:26 UTC
...
**Current Status:** 620,260 records | 64.47 MB | Growing every 2 hours
