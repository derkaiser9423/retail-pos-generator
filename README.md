...
![Total Records](https://img.shields.io/badge/records-947,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-98.94MB-blue)
...
> **Last Updated:** 2026-03-02 04:09:19 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **947,960** |
| 💾 **Database Size** | **98.94 MB** |
| 📅 **Last Updated** | March 02, 2026 at 04:09 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,380                        │
│ 🧾 Transaction Headers  │ ████████ 261,080               │
│ 📝 Transaction Lines    │ ████████████████████ 652,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 4,008 Suppliers (+ 3 per run)
- ✅ 2,672 Staff members (+ 2 per run)
- ✅ 26,380 Products (+ 10 per run)
- ✅ 261,080 Transactions (+ 20 per run)
- ✅ 652,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (98.94 MB)
...
**Current Status:** 947,960 records | 98.94 MB | Growing every 2 hours
