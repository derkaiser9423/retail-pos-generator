...
![Total Records](https://img.shields.io/badge/records-936,360-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.64MB-blue)
...
> **Last Updated:** 2026-02-28 16:20:06 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **936,360** |
| 💾 **Database Size** | **97.64 MB** |
| 📅 **Last Updated** | February 28, 2026 at 16:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,060                        │
│ 🧾 Transaction Headers  │ ████████ 257,880               │
│ 📝 Transaction Lines    │ ████████████████████ 644,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,960 Suppliers (+ 3 per run)
- ✅ 2,640 Staff members (+ 2 per run)
- ✅ 26,060 Products (+ 10 per run)
- ✅ 257,880 Transactions (+ 20 per run)
- ✅ 644,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.64 MB)
...
**Current Status:** 936,360 records | 97.64 MB | Growing every 2 hours
