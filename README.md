...
![Total Records](https://img.shields.io/badge/records-427,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-44.23MB-blue)
...
> **Last Updated:** 2025-12-29 14:15:20 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **427,410** |
| 💾 **Database Size** | **44.23 MB** |
| 📅 **Last Updated** | December 29, 2025 at 14:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  12,020                        │
│ 🧾 Transaction Headers  │ ████████ 117,480               │
│ 📝 Transaction Lines    │ ████████████████████ 293,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,854 Suppliers (+ 3 per run)
- ✅ 1,236 Staff members (+ 2 per run)
- ✅ 12,020 Products (+ 10 per run)
- ✅ 117,480 Transactions (+ 20 per run)
- ✅ 293,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (44.23 MB)
...
- **Records:** 427,410
- **Size:** 44.23 MB
- **Last Updated:** 2025-12-29 14:15 UTC
...
**Current Status:** 427,410 records | 44.23 MB | Growing every 2 hours
