...
![Total Records](https://img.shields.io/badge/records-821,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-85.46MB-blue)
...
> **Last Updated:** 2026-02-14 10:21:30 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **821,085** |
| 💾 **Database Size** | **85.46 MB** |
| 📅 **Last Updated** | February 14, 2026 at 10:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,880                        │
│ 🧾 Transaction Headers  │ ████████ 226,080               │
│ 📝 Transaction Lines    │ ████████████████████ 565,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,483 Suppliers (+ 3 per run)
- ✅ 2,322 Staff members (+ 2 per run)
- ✅ 22,880 Products (+ 10 per run)
- ✅ 226,080 Transactions (+ 20 per run)
- ✅ 565,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (85.46 MB)
...
**Current Status:** 821,085 records | 85.46 MB | Growing every 2 hours
