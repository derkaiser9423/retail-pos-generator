...
![Total Records](https://img.shields.io/badge/records-845,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-87.96MB-blue)
...
> **Last Updated:** 2026-02-17 12:44:30 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **845,735** |
| 💾 **Database Size** | **87.96 MB** |
...
│ 📦 Products             │  23,560                        │
│ 🧾 Transaction Headers  │ ████████ 232,880               │
│ 📝 Transaction Lines    │ ████████████████████ 582,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,585 Suppliers (+ 3 per run)
- ✅ 2,390 Staff members (+ 2 per run)
- ✅ 23,560 Products (+ 10 per run)
- ✅ 232,880 Transactions (+ 20 per run)
- ✅ 582,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (87.96 MB)
...
- **Records:** 845,735
- **Size:** 87.96 MB
- **Last Updated:** 2026-02-17 12:44 UTC
...
**Current Status:** 845,735 records | 87.96 MB | Growing every 2 hours
