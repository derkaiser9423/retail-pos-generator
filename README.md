...
![Total Records](https://img.shields.io/badge/records-289,655-brightgreen)
![Database Size](https://img.shields.io/badge/size-29.83MB-blue)
...
> **Last Updated:** 2025-12-13 18:17:32 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **289,655** |
| 💾 **Database Size** | **29.83 MB** |
...
│ 📦 Products             │  8,220                         │
│ 🧾 Transaction Headers  │ ████████ 79,480                │
│ 📝 Transaction Lines    │ ████████████████████ 198,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,284 Suppliers (+ 3 per run)
- ✅ 856 Staff members (+ 2 per run)
- ✅ 8,220 Products (+ 10 per run)
- ✅ 79,480 Transactions (+ 20 per run)
- ✅ 198,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (29.83 MB)
...
- **Records:** 289,655
- **Size:** 29.83 MB
- **Last Updated:** 2025-12-13 18:17 UTC
...
**Current Status:** 289,655 records | 29.83 MB | Growing every 2 hours
