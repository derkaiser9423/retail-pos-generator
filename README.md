...
![Total Records](https://img.shields.io/badge/records-897,210-brightgreen)
![Database Size](https://img.shields.io/badge/size-93.45MB-blue)
...
> **Last Updated:** 2026-02-23 20:39:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **897,210** |
| 💾 **Database Size** | **93.45 MB** |
| 📅 **Last Updated** | February 23, 2026 at 20:39 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,980                        │
│ 🧾 Transaction Headers  │ ████████ 247,080               │
│ 📝 Transaction Lines    │ ████████████████████ 617,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,798 Suppliers (+ 3 per run)
- ✅ 2,532 Staff members (+ 2 per run)
- ✅ 24,980 Products (+ 10 per run)
- ✅ 247,080 Transactions (+ 20 per run)
- ✅ 617,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (93.45 MB)
...
**Current Status:** 897,210 records | 93.45 MB | Growing every 2 hours
