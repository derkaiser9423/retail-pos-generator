...
![Total Records](https://img.shields.io/badge/records-767,435-brightgreen)
![Database Size](https://img.shields.io/badge/size-79.89MB-blue)
...
> **Last Updated:** 2026-02-07 14:20:43 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **767,435** |
| 💾 **Database Size** | **79.89 MB** |
| 📅 **Last Updated** | February 07, 2026 at 14:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,400                        │
│ 🧾 Transaction Headers  │ ████████ 211,280               │
│ 📝 Transaction Lines    │ ████████████████████ 528,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,261 Suppliers (+ 3 per run)
- ✅ 2,174 Staff members (+ 2 per run)
- ✅ 21,400 Products (+ 10 per run)
- ✅ 211,280 Transactions (+ 20 per run)
- ✅ 528,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (79.89 MB)
...
**Current Status:** 767,435 records | 79.89 MB | Growing every 2 hours
