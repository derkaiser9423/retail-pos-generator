...
![Total Records](https://img.shields.io/badge/records-764,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-79.59MB-blue)
...
> **Last Updated:** 2026-02-07 06:33:42 UTC  
...
│ 📦 Products             │  21,320                        │
│ 🧾 Transaction Headers  │ ████████ 210,480               │
│ 📝 Transaction Lines    │ ████████████████████ 526,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,249 Suppliers (+ 3 per run)
- ✅ 2,166 Staff members (+ 2 per run)
- ✅ 21,320 Products (+ 10 per run)
- ✅ 210,480 Transactions (+ 20 per run)
- ✅ 526,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (79.59 MB)
...
- **Records:** 764,535
- **Size:** 79.59 MB
- **Last Updated:** 2026-02-07 06:33 UTC
...
**Current Status:** 764,535 records | 79.59 MB | Growing every 2 hours
