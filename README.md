...
![Total Records](https://img.shields.io/badge/records-506,435-brightgreen)
![Database Size](https://img.shields.io/badge/size-52.61MB-blue)
...
> **Last Updated:** 2026-01-07 16:21:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **506,435** |
| 💾 **Database Size** | **52.61 MB** |
| 📅 **Last Updated** | January 07, 2026 at 16:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,200                        │
│ 🧾 Transaction Headers  │ ████████ 139,280               │
│ 📝 Transaction Lines    │ ████████████████████ 348,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,181 Suppliers (+ 3 per run)
- ✅ 1,454 Staff members (+ 2 per run)
- ✅ 14,200 Products (+ 10 per run)
- ✅ 139,280 Transactions (+ 20 per run)
- ✅ 348,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (52.61 MB)
...
- **Records:** 506,435
- **Size:** 52.61 MB
- **Last Updated:** 2026-01-07 16:21 UTC
...
**Current Status:** 506,435 records | 52.61 MB | Growing every 2 hours
