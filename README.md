...
![Total Records](https://img.shields.io/badge/records-887,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-92.4MB-blue)
...
> **Last Updated:** 2026-02-22 14:21:25 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **887,060** |
| 💾 **Database Size** | **92.4 MB** |
| 📅 **Last Updated** | February 22, 2026 at 14:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,700                        │
│ 🧾 Transaction Headers  │ ████████ 244,280               │
│ 📝 Transaction Lines    │ ████████████████████ 610,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,756 Suppliers (+ 3 per run)
- ✅ 2,504 Staff members (+ 2 per run)
- ✅ 24,700 Products (+ 10 per run)
- ✅ 244,280 Transactions (+ 20 per run)
- ✅ 610,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (92.4 MB)
...
**Current Status:** 887,060 records | 92.4 MB | Growing every 2 hours
