...
![Total Records](https://img.shields.io/badge/records-675,360-brightgreen)
![Database Size](https://img.shields.io/badge/size-70.12MB-blue)
...
> **Last Updated:** 2026-01-27 03:43:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **675,360** |
| 💾 **Database Size** | **70.12 MB** |
| 📅 **Last Updated** | January 27, 2026 at 03:43 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,860                        │
│ 🧾 Transaction Headers  │ ████████ 185,880               │
│ 📝 Transaction Lines    │ ████████████████████ 464,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,880 Suppliers (+ 3 per run)
- ✅ 1,920 Staff members (+ 2 per run)
- ✅ 18,860 Products (+ 10 per run)
- ✅ 185,880 Transactions (+ 20 per run)
- ✅ 464,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (70.12 MB)
...
**Current Status:** 675,360 records | 70.12 MB | Growing every 2 hours
