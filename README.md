...
![Total Records](https://img.shields.io/badge/records-942,885-brightgreen)
![Database Size](https://img.shields.io/badge/size-98.34MB-blue)
...
> **Last Updated:** 2026-03-01 12:33:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **942,885** |
| 💾 **Database Size** | **98.34 MB** |
| 📅 **Last Updated** | March 01, 2026 at 12:33 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,240                        │
│ 🧾 Transaction Headers  │ ████████ 259,680               │
│ 📝 Transaction Lines    │ ████████████████████ 649,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,987 Suppliers (+ 3 per run)
- ✅ 2,658 Staff members (+ 2 per run)
- ✅ 26,240 Products (+ 10 per run)
- ✅ 259,680 Transactions (+ 20 per run)
- ✅ 649,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (98.34 MB)
...
- **Records:** 942,885
- **Size:** 98.34 MB
- **Last Updated:** 2026-03-01 12:33 UTC
...
**Current Status:** 942,885 records | 98.34 MB | Growing every 2 hours
