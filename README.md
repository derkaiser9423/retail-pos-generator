...
![Total Records](https://img.shields.io/badge/records-635,485-brightgreen)
![Database Size](https://img.shields.io/badge/size-66.04MB-blue)
...
> **Last Updated:** 2026-01-22 12:32:29 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **635,485** |
| 💾 **Database Size** | **66.04 MB** |
| 📅 **Last Updated** | January 22, 2026 at 12:32 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,760                        │
│ 🧾 Transaction Headers  │ ████████ 174,880               │
│ 📝 Transaction Lines    │ ████████████████████ 437,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,715 Suppliers (+ 3 per run)
- ✅ 1,810 Staff members (+ 2 per run)
- ✅ 17,760 Products (+ 10 per run)
- ✅ 174,880 Transactions (+ 20 per run)
- ✅ 437,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (66.04 MB)
...
- **Records:** 635,485
- **Size:** 66.04 MB
- **Last Updated:** 2026-01-22 12:32 UTC
...
**Current Status:** 635,485 records | 66.04 MB | Growing every 2 hours
