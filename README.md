...
![Total Records](https://img.shields.io/badge/records-896,485-brightgreen)
![Database Size](https://img.shields.io/badge/size-93.39MB-blue)
...
> **Last Updated:** 2026-02-23 18:55:40 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **896,485** |
| 💾 **Database Size** | **93.39 MB** |
| 📅 **Last Updated** | February 23, 2026 at 18:55 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,960                        │
│ 🧾 Transaction Headers  │ ████████ 246,880               │
│ 📝 Transaction Lines    │ ████████████████████ 617,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,795 Suppliers (+ 3 per run)
- ✅ 2,530 Staff members (+ 2 per run)
- ✅ 24,960 Products (+ 10 per run)
- ✅ 246,880 Transactions (+ 20 per run)
- ✅ 617,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (93.39 MB)
...
**Current Status:** 896,485 records | 93.39 MB | Growing every 2 hours
