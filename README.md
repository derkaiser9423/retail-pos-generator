...
![Total Records](https://img.shields.io/badge/records-260,650-brightgreen)
![Database Size](https://img.shields.io/badge/size-26.82MB-blue)
...
> **Last Updated:** 2025-12-10 10:16:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **260,650** |
| 💾 **Database Size** | **26.82 MB** |
...
│ 📦 Products             │  7,420                         │
│ 🧾 Transaction Headers  │ ████████ 71,480                │
│ 📝 Transaction Lines    │ ████████████████████ 178,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,164 Suppliers (+ 3 per run)
- ✅ 776 Staff members (+ 2 per run)
- ✅ 7,420 Products (+ 10 per run)
- ✅ 71,480 Transactions (+ 20 per run)
- ✅ 178,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (26.82 MB)
...
- **Records:** 260,650
- **Size:** 26.82 MB
- **Last Updated:** 2025-12-10 10:16 UTC
...
**Current Status:** 260,650 records | 26.82 MB | Growing every 2 hours
