...
![Total Records](https://img.shields.io/badge/records-139,401-brightgreen)
![Database Size](https://img.shields.io/badge/size-14.2MB-blue)
...
> **Last Updated:** 2025-11-26 12:28:00 UTC  
...
│ 🏷️ Product Groups       │  634                           │
│ 📦 Products             │  4,080                         │
│ 🧾 Transaction Headers  │ ████████ 38,080                │
│ 📝 Transaction Lines    │ ████████████████████ 95,200    │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 663 Suppliers (+ 3 per run)
- ✅ 442 Staff members (+ 2 per run)
- ✅ 4,080 Products (+ 10 per run)
- ✅ 38,080 Transactions (+ 20 per run)
- ✅ 95,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (14.2 MB)
...
- **Records:** 139,401
- **Size:** 14.2 MB
- **Last Updated:** 2025-11-26 12:28 UTC
...
**Current Status:** 139,401 records | 14.2 MB | Growing every 2 hours
