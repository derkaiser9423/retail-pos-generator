...
![Total Records](https://img.shields.io/badge/records-829,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-86.22MB-blue)
...
> **Last Updated:** 2026-02-15 10:20:30 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **829,060** |
| 💾 **Database Size** | **86.22 MB** |
| 📅 **Last Updated** | February 15, 2026 at 10:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,100                        │
│ 🧾 Transaction Headers  │ ████████ 228,280               │
│ 📝 Transaction Lines    │ ████████████████████ 570,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,516 Suppliers (+ 3 per run)
- ✅ 2,344 Staff members (+ 2 per run)
- ✅ 23,100 Products (+ 10 per run)
- ✅ 228,280 Transactions (+ 20 per run)
- ✅ 570,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (86.22 MB)
...
**Current Status:** 829,060 records | 86.22 MB | Growing every 2 hours
