...
![Total Records](https://img.shields.io/badge/records-735,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-76.54MB-blue)
...
> **Last Updated:** 2026-02-03 14:40:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **735,535** |
| 💾 **Database Size** | **76.54 MB** |
| 📅 **Last Updated** | February 03, 2026 at 14:40 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,520                        │
│ 🧾 Transaction Headers  │ ████████ 202,480               │
│ 📝 Transaction Lines    │ ████████████████████ 506,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,129 Suppliers (+ 3 per run)
- ✅ 2,086 Staff members (+ 2 per run)
- ✅ 20,520 Products (+ 10 per run)
- ✅ 202,480 Transactions (+ 20 per run)
- ✅ 506,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (76.54 MB)
...
**Current Status:** 735,535 records | 76.54 MB | Growing every 2 hours
