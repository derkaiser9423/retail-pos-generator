...
![Total Records](https://img.shields.io/badge/records-648,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-67.46MB-blue)
...
> **Last Updated:** 2026-01-24 01:06:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **648,535** |
| 💾 **Database Size** | **67.46 MB** |
| 📅 **Last Updated** | January 24, 2026 at 01:06 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,120                        │
│ 🧾 Transaction Headers  │ ████████ 178,480               │
│ 📝 Transaction Lines    │ ████████████████████ 446,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,769 Suppliers (+ 3 per run)
- ✅ 1,846 Staff members (+ 2 per run)
- ✅ 18,120 Products (+ 10 per run)
- ✅ 178,480 Transactions (+ 20 per run)
- ✅ 446,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (67.46 MB)
...
- **Records:** 648,535
- **Size:** 67.46 MB
- **Last Updated:** 2026-01-24 01:06 UTC
...
**Current Status:** 648,535 records | 67.46 MB | Growing every 2 hours
