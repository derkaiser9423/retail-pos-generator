...
![Total Records](https://img.shields.io/badge/records-563,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-58.54MB-blue)
...
> **Last Updated:** 2026-01-14 06:24:08 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **563,710** |
| 💾 **Database Size** | **58.54 MB** |
...
│ 📦 Products             │  15,780                        │
│ 🧾 Transaction Headers  │ ████████ 155,080               │
│ 📝 Transaction Lines    │ ████████████████████ 387,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,418 Suppliers (+ 3 per run)
- ✅ 1,612 Staff members (+ 2 per run)
- ✅ 15,780 Products (+ 10 per run)
- ✅ 155,080 Transactions (+ 20 per run)
- ✅ 387,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (58.54 MB)
...
- **Records:** 563,710
- **Size:** 58.54 MB
- **Last Updated:** 2026-01-14 06:24 UTC
...
**Current Status:** 563,710 records | 58.54 MB | Growing every 2 hours
