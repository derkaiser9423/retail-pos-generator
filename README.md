...
![Total Records](https://img.shields.io/badge/records-766,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-79.8MB-blue)
...
> **Last Updated:** 2026-02-07 12:31:45 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **766,710** |
| 💾 **Database Size** | **79.8 MB** |
...
│ 📦 Products             │  21,380                        │
│ 🧾 Transaction Headers  │ ████████ 211,080               │
│ 📝 Transaction Lines    │ ████████████████████ 527,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,258 Suppliers (+ 3 per run)
- ✅ 2,172 Staff members (+ 2 per run)
- ✅ 21,380 Products (+ 10 per run)
- ✅ 211,080 Transactions (+ 20 per run)
- ✅ 527,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (79.8 MB)
...
- **Records:** 766,710
- **Size:** 79.8 MB
- **Last Updated:** 2026-02-07 12:31 UTC
...
**Current Status:** 766,710 records | 79.8 MB | Growing every 2 hours
