...
![Total Records](https://img.shields.io/badge/records-655,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-68.09MB-blue)
...
> **Last Updated:** 2026-01-24 18:20:59 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **655,060** |
| 💾 **Database Size** | **68.09 MB** |
...
│ 📦 Products             │  18,300                        │
│ 🧾 Transaction Headers  │ ████████ 180,280               │
│ 📝 Transaction Lines    │ ████████████████████ 450,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,796 Suppliers (+ 3 per run)
- ✅ 1,864 Staff members (+ 2 per run)
- ✅ 18,300 Products (+ 10 per run)
- ✅ 180,280 Transactions (+ 20 per run)
- ✅ 450,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (68.09 MB)
...
- **Records:** 655,060
- **Size:** 68.09 MB
- **Last Updated:** 2026-01-24 18:20 UTC
...
**Current Status:** 655,060 records | 68.09 MB | Growing every 2 hours
