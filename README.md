...
![Total Records](https://img.shields.io/badge/records-644,185-brightgreen)
![Database Size](https://img.shields.io/badge/size-66.99MB-blue)
...
> **Last Updated:** 2026-01-23 12:31:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **644,185** |
| 💾 **Database Size** | **66.99 MB** |
...
│ 📦 Products             │  18,000                        │
│ 🧾 Transaction Headers  │ ████████ 177,280               │
│ 📝 Transaction Lines    │ ████████████████████ 443,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,751 Suppliers (+ 3 per run)
- ✅ 1,834 Staff members (+ 2 per run)
- ✅ 18,000 Products (+ 10 per run)
- ✅ 177,280 Transactions (+ 20 per run)
- ✅ 443,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (66.99 MB)
...
- **Records:** 644,185
- **Size:** 66.99 MB
- **Last Updated:** 2026-01-23 12:31 UTC
...
**Current Status:** 644,185 records | 66.99 MB | Growing every 2 hours
