...
![Total Records](https://img.shields.io/badge/records-689,860-brightgreen)
![Database Size](https://img.shields.io/badge/size-71.71MB-blue)
...
> **Last Updated:** 2026-01-28 18:28:48 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **689,860** |
| 💾 **Database Size** | **71.71 MB** |
...
│ 📦 Products             │  19,260                        │
│ 🧾 Transaction Headers  │ ████████ 189,880               │
│ 📝 Transaction Lines    │ ████████████████████ 474,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,940 Suppliers (+ 3 per run)
- ✅ 1,960 Staff members (+ 2 per run)
- ✅ 19,260 Products (+ 10 per run)
- ✅ 189,880 Transactions (+ 20 per run)
- ✅ 474,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (71.71 MB)
...
- **Records:** 689,860
- **Size:** 71.71 MB
- **Last Updated:** 2026-01-28 18:28 UTC
...
**Current Status:** 689,860 records | 71.71 MB | Growing every 2 hours
