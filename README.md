...
![Total Records](https://img.shields.io/badge/records-245,420-brightgreen)
![Database Size](https://img.shields.io/badge/size-25.22MB-blue)
...
> **Last Updated:** 2025-12-08 16:18:28 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **245,420** |
| 💾 **Database Size** | **25.22 MB** |
| 📅 **Last Updated** | December 08, 2025 at 16:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 🏷️ Product Groups       │  803                           │
│ 📦 Products             │  7,000                         │
│ 🧾 Transaction Headers  │ ████████ 67,280                │
│ 📝 Transaction Lines    │ ████████████████████ 168,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,101 Suppliers (+ 3 per run)
- ✅ 734 Staff members (+ 2 per run)
- ✅ 7,000 Products (+ 10 per run)
- ✅ 67,280 Transactions (+ 20 per run)
- ✅ 168,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (25.22 MB)
...
- **Records:** 245,420
- **Size:** 25.22 MB
- **Last Updated:** 2025-12-08 16:18 UTC
...
**Current Status:** 245,420 records | 25.22 MB | Growing every 2 hours
