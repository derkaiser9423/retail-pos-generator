...
![Total Records](https://img.shields.io/badge/records-163,398-brightgreen)
![Database Size](https://img.shields.io/badge/size-16.67MB-blue)
...
> **Last Updated:** 2025-11-29 06:19:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **163,398** |
| 💾 **Database Size** | **16.67 MB** |
...
│ 📦 Products             │  4,740                         │
│ 🧾 Transaction Headers  │ ████████ 44,680                │
│ 📝 Transaction Lines    │ ████████████████████ 111,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 762 Suppliers (+ 3 per run)
- ✅ 508 Staff members (+ 2 per run)
- ✅ 4,740 Products (+ 10 per run)
- ✅ 44,680 Transactions (+ 20 per run)
- ✅ 111,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (16.67 MB)
...
- **Records:** 163,398
- **Size:** 16.67 MB
- **Last Updated:** 2025-11-29 06:19 UTC
...
**Current Status:** 163,398 records | 16.67 MB | Growing every 2 hours
