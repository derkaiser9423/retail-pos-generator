...
![Total Records](https://img.shields.io/badge/records-929,110-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.84MB-blue)
...
> **Last Updated:** 2026-02-27 20:22:41 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **929,110** |
| 💾 **Database Size** | **96.84 MB** |
| 📅 **Last Updated** | February 27, 2026 at 20:22 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,860                        │
│ 🧾 Transaction Headers  │ ████████ 255,880               │
│ 📝 Transaction Lines    │ ████████████████████ 639,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,930 Suppliers (+ 3 per run)
- ✅ 2,620 Staff members (+ 2 per run)
- ✅ 25,860 Products (+ 10 per run)
- ✅ 255,880 Transactions (+ 20 per run)
- ✅ 639,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.84 MB)
...
**Current Status:** 929,110 records | 96.84 MB | Growing every 2 hours
