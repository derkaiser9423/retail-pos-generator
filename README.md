...
![Total Records](https://img.shields.io/badge/records-688,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-71.55MB-blue)
...
> **Last Updated:** 2026-01-28 14:23:48 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **688,410** |
| 💾 **Database Size** | **71.55 MB** |
| 📅 **Last Updated** | January 28, 2026 at 14:23 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  19,220                        │
│ 🧾 Transaction Headers  │ ████████ 189,480               │
│ 📝 Transaction Lines    │ ████████████████████ 473,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,934 Suppliers (+ 3 per run)
- ✅ 1,956 Staff members (+ 2 per run)
- ✅ 19,220 Products (+ 10 per run)
- ✅ 189,480 Transactions (+ 20 per run)
- ✅ 473,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (71.55 MB)
...
- **Records:** 688,410
- **Size:** 71.55 MB
- **Last Updated:** 2026-01-28 14:23 UTC
...
**Current Status:** 688,410 records | 71.55 MB | Growing every 2 hours
