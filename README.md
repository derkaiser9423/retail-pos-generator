...
![Total Records](https://img.shields.io/badge/records-714,510-brightgreen)
![Database Size](https://img.shields.io/badge/size-74.25MB-blue)
...
> **Last Updated:** 2026-01-31 18:22:15 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **714,510** |
| 💾 **Database Size** | **74.25 MB** |
| 📅 **Last Updated** | January 31, 2026 at 18:22 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  19,940                        │
│ 🧾 Transaction Headers  │ ████████ 196,680               │
│ 📝 Transaction Lines    │ ████████████████████ 491,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,042 Suppliers (+ 3 per run)
- ✅ 2,028 Staff members (+ 2 per run)
- ✅ 19,940 Products (+ 10 per run)
- ✅ 196,680 Transactions (+ 20 per run)
- ✅ 491,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (74.25 MB)
...
- **Records:** 714,510
- **Size:** 74.25 MB
- **Last Updated:** 2026-01-31 18:22 UTC
...
**Current Status:** 714,510 records | 74.25 MB | Growing every 2 hours
