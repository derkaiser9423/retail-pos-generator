...
![Total Records](https://img.shields.io/badge/records-884,885-brightgreen)
![Database Size](https://img.shields.io/badge/size-92.16MB-blue)
...
> **Last Updated:** 2026-02-22 08:24:37 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **884,885** |
| 💾 **Database Size** | **92.16 MB** |
| 📅 **Last Updated** | February 22, 2026 at 08:24 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,640                        │
│ 🧾 Transaction Headers  │ ████████ 243,680               │
│ 📝 Transaction Lines    │ ████████████████████ 609,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,747 Suppliers (+ 3 per run)
- ✅ 2,498 Staff members (+ 2 per run)
- ✅ 24,640 Products (+ 10 per run)
- ✅ 243,680 Transactions (+ 20 per run)
- ✅ 609,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (92.16 MB)
...
**Current Status:** 884,885 records | 92.16 MB | Growing every 2 hours
