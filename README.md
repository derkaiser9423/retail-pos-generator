...
![Total Records](https://img.shields.io/badge/records-692,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-71.93MB-blue)
...
> **Last Updated:** 2026-01-29 01:18:36 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **692,035** |
| 💾 **Database Size** | **71.93 MB** |
...
│ 📦 Products             │  19,320                        │
│ 🧾 Transaction Headers  │ ████████ 190,480               │
│ 📝 Transaction Lines    │ ████████████████████ 476,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,949 Suppliers (+ 3 per run)
- ✅ 1,966 Staff members (+ 2 per run)
- ✅ 19,320 Products (+ 10 per run)
- ✅ 190,480 Transactions (+ 20 per run)
- ✅ 476,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (71.93 MB)
...
**Current Status:** 692,035 records | 71.93 MB | Growing every 2 hours
