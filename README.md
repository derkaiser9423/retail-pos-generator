...
![Total Records](https://img.shields.io/badge/records-943,610-brightgreen)
![Database Size](https://img.shields.io/badge/size-98.42MB-blue)
...
> **Last Updated:** 2026-03-01 14:19:56 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **943,610** |
| 💾 **Database Size** | **98.42 MB** |
| 📅 **Last Updated** | March 01, 2026 at 14:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,260                        │
│ 🧾 Transaction Headers  │ ████████ 259,880               │
│ 📝 Transaction Lines    │ ████████████████████ 649,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,990 Suppliers (+ 3 per run)
- ✅ 2,660 Staff members (+ 2 per run)
- ✅ 26,260 Products (+ 10 per run)
- ✅ 259,880 Transactions (+ 20 per run)
- ✅ 649,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (98.42 MB)
...
**Current Status:** 943,610 records | 98.42 MB | Growing every 2 hours
