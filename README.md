...
![Total Records](https://img.shields.io/badge/records-584,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-60.73MB-blue)
...
> **Last Updated:** 2026-01-16 16:20:01 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **584,735** |
| 💾 **Database Size** | **60.73 MB** |
| 📅 **Last Updated** | January 16, 2026 at 16:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,360                        │
│ 🧾 Transaction Headers  │ ████████ 160,880               │
│ 📝 Transaction Lines    │ ████████████████████ 402,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,505 Suppliers (+ 3 per run)
- ✅ 1,670 Staff members (+ 2 per run)
- ✅ 16,360 Products (+ 10 per run)
- ✅ 160,880 Transactions (+ 20 per run)
- ✅ 402,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (60.73 MB)
...
**Current Status:** 584,735 records | 60.73 MB | Growing every 2 hours
