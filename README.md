...
![Total Records](https://img.shields.io/badge/records-833,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-86.74MB-blue)
...
> **Last Updated:** 2026-02-15 22:17:38 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **833,410** |
| 💾 **Database Size** | **86.74 MB** |
| 📅 **Last Updated** | February 15, 2026 at 22:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,220                        │
│ 🧾 Transaction Headers  │ ████████ 229,480               │
│ 📝 Transaction Lines    │ ████████████████████ 573,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,534 Suppliers (+ 3 per run)
- ✅ 2,356 Staff members (+ 2 per run)
- ✅ 23,220 Products (+ 10 per run)
- ✅ 229,480 Transactions (+ 20 per run)
- ✅ 573,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (86.74 MB)
...
- **Records:** 833,410
- **Size:** 86.74 MB
- **Last Updated:** 2026-02-15 22:17 UTC
...
**Current Status:** 833,410 records | 86.74 MB | Growing every 2 hours
