...
![Total Records](https://img.shields.io/badge/records-753,660-brightgreen)
![Database Size](https://img.shields.io/badge/size-78.37MB-blue)
...
> **Last Updated:** 2026-02-05 20:26:02 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **753,660** |
| 💾 **Database Size** | **78.37 MB** |
| 📅 **Last Updated** | February 05, 2026 at 20:26 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,020                        │
│ 🧾 Transaction Headers  │ ████████ 207,480               │
│ 📝 Transaction Lines    │ ████████████████████ 518,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,204 Suppliers (+ 3 per run)
- ✅ 2,136 Staff members (+ 2 per run)
- ✅ 21,020 Products (+ 10 per run)
- ✅ 207,480 Transactions (+ 20 per run)
- ✅ 518,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (78.37 MB)
...
- **Records:** 753,660
- **Size:** 78.37 MB
- **Last Updated:** 2026-02-05 20:26 UTC
...
**Current Status:** 753,660 records | 78.37 MB | Growing every 2 hours
