...
![Total Records](https://img.shields.io/badge/records-850,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-88.45MB-blue)
...
> **Last Updated:** 2026-02-18 01:25:56 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **850,085** |
| 💾 **Database Size** | **88.45 MB** |
| 📅 **Last Updated** | February 18, 2026 at 01:25 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,680                        │
│ 🧾 Transaction Headers  │ ████████ 234,080               │
│ 📝 Transaction Lines    │ ████████████████████ 585,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,603 Suppliers (+ 3 per run)
- ✅ 2,402 Staff members (+ 2 per run)
- ✅ 23,680 Products (+ 10 per run)
- ✅ 234,080 Transactions (+ 20 per run)
- ✅ 585,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (88.45 MB)
...
**Current Status:** 850,085 records | 88.45 MB | Growing every 2 hours
