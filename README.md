...
![Total Records](https://img.shields.io/badge/records-201,166-brightgreen)
![Database Size](https://img.shields.io/badge/size-20.55MB-blue)
...
> **Last Updated:** 2025-12-03 14:15:00 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **201,166** |
| 💾 **Database Size** | **20.55 MB** |
| 📅 **Last Updated** | December 03, 2025 at 14:15 UTC |
| 📈 **24h Growth** | +726 records |
...
│ 📦 Products             │  5,780                         │
│ 🧾 Transaction Headers  │ ████████ 55,080                │
│ 📝 Transaction Lines    │ ████████████████████ 137,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 918 Suppliers (+ 3 per run)
- ✅ 612 Staff members (+ 2 per run)
- ✅ 5,780 Products (+ 10 per run)
- ✅ 55,080 Transactions (+ 20 per run)
- ✅ 137,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (20.55 MB)
...
- **Records:** 201,166
- **Size:** 20.55 MB
- **Last Updated:** 2025-12-03 14:15 UTC
...
**Current Status:** 201,166 records | 20.55 MB | Growing every 2 hours
