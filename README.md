...
![Total Records](https://img.shields.io/badge/records-385,360-brightgreen)
![Database Size](https://img.shields.io/badge/size-39.86MB-blue)
...
> **Last Updated:** 2025-12-24 18:20:31 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **385,360** |
| 💾 **Database Size** | **39.86 MB** |
...
│ 📦 Products             │  10,860                        │
│ 🧾 Transaction Headers  │ ████████ 105,880               │
│ 📝 Transaction Lines    │ ████████████████████ 264,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,680 Suppliers (+ 3 per run)
- ✅ 1,120 Staff members (+ 2 per run)
- ✅ 10,860 Products (+ 10 per run)
- ✅ 105,880 Transactions (+ 20 per run)
- ✅ 264,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (39.86 MB)
...
- **Records:** 385,360
- **Size:** 39.86 MB
- **Last Updated:** 2025-12-24 18:20 UTC
...
**Current Status:** 385,360 records | 39.86 MB | Growing every 2 hours
