...
![Total Records](https://img.shields.io/badge/records-396,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-41.07MB-blue)
...
> **Last Updated:** 2025-12-26 03:19:19 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **396,960** |
| 💾 **Database Size** | **41.07 MB** |
| 📅 **Last Updated** | December 26, 2025 at 03:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  11,180                        │
│ 🧾 Transaction Headers  │ ████████ 109,080               │
│ 📝 Transaction Lines    │ ████████████████████ 272,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,728 Suppliers (+ 3 per run)
- ✅ 1,152 Staff members (+ 2 per run)
- ✅ 11,180 Products (+ 10 per run)
- ✅ 109,080 Transactions (+ 20 per run)
- ✅ 272,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (41.07 MB)
...
- **Records:** 396,960
- **Size:** 41.07 MB
- **Last Updated:** 2025-12-26 03:19 UTC
...
**Current Status:** 396,960 records | 41.07 MB | Growing every 2 hours
