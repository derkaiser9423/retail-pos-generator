...
![Total Records](https://img.shields.io/badge/records-776,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-80.71MB-blue)
...
> **Last Updated:** 2026-02-08 16:22:37 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **776,135** |
| 💾 **Database Size** | **80.71 MB** |
| 📅 **Last Updated** | February 08, 2026 at 16:22 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,640                        │
│ 🧾 Transaction Headers  │ ████████ 213,680               │
│ 📝 Transaction Lines    │ ████████████████████ 534,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,297 Suppliers (+ 3 per run)
- ✅ 2,198 Staff members (+ 2 per run)
- ✅ 21,640 Products (+ 10 per run)
- ✅ 213,680 Transactions (+ 20 per run)
- ✅ 534,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (80.71 MB)
...
- **Records:** 776,135
- **Size:** 80.71 MB
- **Last Updated:** 2026-02-08 16:22 UTC
...
**Current Status:** 776,135 records | 80.71 MB | Growing every 2 hours
