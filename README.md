...
![Total Records](https://img.shields.io/badge/records-531,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-55.1MB-blue)
...
> **Last Updated:** 2026-01-10 12:26:15 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **531,085** |
| 💾 **Database Size** | **55.1 MB** |
...
│ 📦 Products             │  14,880                        │
│ 🧾 Transaction Headers  │ ████████ 146,080               │
│ 📝 Transaction Lines    │ ████████████████████ 365,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,283 Suppliers (+ 3 per run)
- ✅ 1,522 Staff members (+ 2 per run)
- ✅ 14,880 Products (+ 10 per run)
- ✅ 146,080 Transactions (+ 20 per run)
- ✅ 365,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (55.1 MB)
...
- **Records:** 531,085
- **Size:** 55.1 MB
- **Last Updated:** 2026-01-10 12:26 UTC
...
**Current Status:** 531,085 records | 55.1 MB | Growing every 2 hours
