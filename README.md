...
![Total Records](https://img.shields.io/badge/records-919,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-95.87MB-blue)
...
> **Last Updated:** 2026-02-26 16:51:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **919,685** |
| 💾 **Database Size** | **95.87 MB** |
| 📅 **Last Updated** | February 26, 2026 at 16:51 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,600                        │
│ 🧾 Transaction Headers  │ ████████ 253,280               │
│ 📝 Transaction Lines    │ ████████████████████ 633,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,891 Suppliers (+ 3 per run)
- ✅ 2,594 Staff members (+ 2 per run)
- ✅ 25,600 Products (+ 10 per run)
- ✅ 253,280 Transactions (+ 20 per run)
- ✅ 633,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (95.87 MB)
...
- **Records:** 919,685
- **Size:** 95.87 MB
- **Last Updated:** 2026-02-26 16:51 UTC
...
**Current Status:** 919,685 records | 95.87 MB | Growing every 2 hours
