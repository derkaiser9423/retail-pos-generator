...
![Total Records](https://img.shields.io/badge/records-437,560-brightgreen)
![Database Size](https://img.shields.io/badge/size-45.26MB-blue)
...
> **Last Updated:** 2025-12-30 18:21:29 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **437,560** |
| 💾 **Database Size** | **45.26 MB** |
...
│ 📦 Products             │  12,300                        │
│ 🧾 Transaction Headers  │ ████████ 120,280               │
│ 📝 Transaction Lines    │ ████████████████████ 300,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,896 Suppliers (+ 3 per run)
- ✅ 1,264 Staff members (+ 2 per run)
- ✅ 12,300 Products (+ 10 per run)
- ✅ 120,280 Transactions (+ 20 per run)
- ✅ 300,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (45.26 MB)
...
- **Records:** 437,560
- **Size:** 45.26 MB
- **Last Updated:** 2025-12-30 18:21 UTC
...
**Current Status:** 437,560 records | 45.26 MB | Growing every 2 hours
