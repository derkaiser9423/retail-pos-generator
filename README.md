...
![Total Records](https://img.shields.io/badge/records-524,560-brightgreen)
![Database Size](https://img.shields.io/badge/size-54.43MB-blue)
...
> **Last Updated:** 2026-01-09 18:22:01 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **524,560** |
| 💾 **Database Size** | **54.43 MB** |
...
│ 📦 Products             │  14,700                        │
│ 🧾 Transaction Headers  │ ████████ 144,280               │
│ 📝 Transaction Lines    │ ████████████████████ 360,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,256 Suppliers (+ 3 per run)
- ✅ 1,504 Staff members (+ 2 per run)
- ✅ 14,700 Products (+ 10 per run)
- ✅ 144,280 Transactions (+ 20 per run)
- ✅ 360,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (54.43 MB)
...
- **Records:** 524,560
- **Size:** 54.43 MB
- **Last Updated:** 2026-01-09 18:22 UTC
...
**Current Status:** 524,560 records | 54.43 MB | Growing every 2 hours
