...
![Total Records](https://img.shields.io/badge/records-673,185-brightgreen)
![Database Size](https://img.shields.io/badge/size-69.92MB-blue)
...
> **Last Updated:** 2026-01-26 20:18:32 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **673,185** |
| 💾 **Database Size** | **69.92 MB** |
| 📅 **Last Updated** | January 26, 2026 at 20:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,800                        │
│ 🧾 Transaction Headers  │ ████████ 185,280               │
│ 📝 Transaction Lines    │ ████████████████████ 463,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,871 Suppliers (+ 3 per run)
- ✅ 1,914 Staff members (+ 2 per run)
- ✅ 18,800 Products (+ 10 per run)
- ✅ 185,280 Transactions (+ 20 per run)
- ✅ 463,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (69.92 MB)
...
- **Records:** 673,185
- **Size:** 69.92 MB
- **Last Updated:** 2026-01-26 20:18 UTC
...
**Current Status:** 673,185 records | 69.92 MB | Growing every 2 hours
