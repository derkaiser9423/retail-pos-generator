...
![Total Records](https://img.shields.io/badge/records-744,235-brightgreen)
![Database Size](https://img.shields.io/badge/size-77.49MB-blue)
...
> **Last Updated:** 2026-02-04 16:38:22 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **744,235** |
| 💾 **Database Size** | **77.49 MB** |
| 📅 **Last Updated** | February 04, 2026 at 16:38 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,760                        │
│ 🧾 Transaction Headers  │ ████████ 204,880               │
│ 📝 Transaction Lines    │ ████████████████████ 512,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,165 Suppliers (+ 3 per run)
- ✅ 2,110 Staff members (+ 2 per run)
- ✅ 20,760 Products (+ 10 per run)
- ✅ 204,880 Transactions (+ 20 per run)
- ✅ 512,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (77.49 MB)
...
- **Records:** 744,235
- **Size:** 77.49 MB
- **Last Updated:** 2026-02-04 16:38 UTC
...
**Current Status:** 744,235 records | 77.49 MB | Growing every 2 hours
