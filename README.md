...
![Total Records](https://img.shields.io/badge/records-799,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-83.17MB-blue)
...
> **Last Updated:** 2026-02-11 16:58:26 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **799,335** |
| 💾 **Database Size** | **83.17 MB** |
| 📅 **Last Updated** | February 11, 2026 at 16:58 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,280                        │
│ 🧾 Transaction Headers  │ ████████ 220,080               │
│ 📝 Transaction Lines    │ ████████████████████ 550,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,393 Suppliers (+ 3 per run)
- ✅ 2,262 Staff members (+ 2 per run)
- ✅ 22,280 Products (+ 10 per run)
- ✅ 220,080 Transactions (+ 20 per run)
- ✅ 550,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (83.17 MB)
...
**Current Status:** 799,335 records | 83.17 MB | Growing every 2 hours
