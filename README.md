...
![Total Records](https://img.shields.io/badge/records-775,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-80.66MB-blue)
...
> **Last Updated:** 2026-02-08 14:21:58 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **775,410** |
| 💾 **Database Size** | **80.66 MB** |
| 📅 **Last Updated** | February 08, 2026 at 14:21 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,620                        │
│ 🧾 Transaction Headers  │ ████████ 213,480               │
│ 📝 Transaction Lines    │ ████████████████████ 533,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,294 Suppliers (+ 3 per run)
- ✅ 2,196 Staff members (+ 2 per run)
- ✅ 21,620 Products (+ 10 per run)
- ✅ 213,480 Transactions (+ 20 per run)
- ✅ 533,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (80.66 MB)
...
**Current Status:** 775,410 records | 80.66 MB | Growing every 2 hours
