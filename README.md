...
![Total Records](https://img.shields.io/badge/records-679,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-70.57MB-blue)
...
> **Last Updated:** 2026-01-27 14:24:10 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **679,710** |
| 💾 **Database Size** | **70.57 MB** |
| 📅 **Last Updated** | January 27, 2026 at 14:24 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,980                        │
│ 🧾 Transaction Headers  │ ████████ 187,080               │
│ 📝 Transaction Lines    │ ████████████████████ 467,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,898 Suppliers (+ 3 per run)
- ✅ 1,932 Staff members (+ 2 per run)
- ✅ 18,980 Products (+ 10 per run)
- ✅ 187,080 Transactions (+ 20 per run)
- ✅ 467,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (70.57 MB)
...
- **Records:** 679,710
- **Size:** 70.57 MB
- **Last Updated:** 2026-01-27 14:24 UTC
...
**Current Status:** 679,710 records | 70.57 MB | Growing every 2 hours
