...
![Total Records](https://img.shields.io/badge/records-781,210-brightgreen)
![Database Size](https://img.shields.io/badge/size-81.35MB-blue)
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **781,210** |
| 💾 **Database Size** | **81.35 MB** |
| 📅 **Last Updated** | February 09, 2026 at 08:41 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,780                        │
│ 🧾 Transaction Headers  │ ████████ 215,080               │
│ 📝 Transaction Lines    │ ████████████████████ 537,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,318 Suppliers (+ 3 per run)
- ✅ 2,212 Staff members (+ 2 per run)
- ✅ 21,780 Products (+ 10 per run)
- ✅ 215,080 Transactions (+ 20 per run)
- ✅ 537,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (81.35 MB)
...
- **Records:** 781,210
- **Size:** 81.35 MB
- **Last Updated:** 2026-02-09 08:41 UTC
...
**Current Status:** 781,210 records | 81.35 MB | Growing every 2 hours
