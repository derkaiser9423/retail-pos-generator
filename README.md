...
![Total Records](https://img.shields.io/badge/records-597,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-62.07MB-blue)
...
> **Last Updated:** 2026-01-18 03:40:25 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **597,060** |
| 💾 **Database Size** | **62.07 MB** |
| 📅 **Last Updated** | January 18, 2026 at 03:40 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,700                        │
│ 🧾 Transaction Headers  │ ████████ 164,280               │
│ 📝 Transaction Lines    │ ████████████████████ 410,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,556 Suppliers (+ 3 per run)
- ✅ 1,704 Staff members (+ 2 per run)
- ✅ 16,700 Products (+ 10 per run)
- ✅ 164,280 Transactions (+ 20 per run)
- ✅ 410,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (62.07 MB)
...
- **Records:** 597,060
- **Size:** 62.07 MB
- **Last Updated:** 2026-01-18 03:40 UTC
...
**Current Status:** 597,060 records | 62.07 MB | Growing every 2 hours
