...
![Total Records](https://img.shields.io/badge/records-934,185-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.39MB-blue)
...
> **Last Updated:** 2026-02-28 10:18:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **934,185** |
| 💾 **Database Size** | **97.39 MB** |
| 📅 **Last Updated** | February 28, 2026 at 10:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,000                        │
│ 🧾 Transaction Headers  │ ████████ 257,280               │
│ 📝 Transaction Lines    │ ████████████████████ 643,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,951 Suppliers (+ 3 per run)
- ✅ 2,634 Staff members (+ 2 per run)
- ✅ 26,000 Products (+ 10 per run)
- ✅ 257,280 Transactions (+ 20 per run)
- ✅ 643,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.39 MB)
...
**Current Status:** 934,185 records | 97.39 MB | Growing every 2 hours
