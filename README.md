...
![Total Records](https://img.shields.io/badge/records-476,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-49.44MB-blue)
...
> **Last Updated:** 2026-01-04 06:21:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **476,710** |
| 💾 **Database Size** | **49.44 MB** |
...
│ 📦 Products             │  13,380                        │
│ 🧾 Transaction Headers  │ ████████ 131,080               │
│ 📝 Transaction Lines    │ ████████████████████ 327,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,058 Suppliers (+ 3 per run)
- ✅ 1,372 Staff members (+ 2 per run)
- ✅ 13,380 Products (+ 10 per run)
- ✅ 131,080 Transactions (+ 20 per run)
- ✅ 327,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (49.44 MB)
...
- **Records:** 476,710
- **Size:** 49.44 MB
- **Last Updated:** 2026-01-04 06:21 UTC
...
**Current Status:** 476,710 records | 49.44 MB | Growing every 2 hours
