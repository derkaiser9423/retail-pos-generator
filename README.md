...
![Total Records](https://img.shields.io/badge/records-683,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-70.97MB-blue)
...
> **Last Updated:** 2026-01-28 01:08:36 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **683,335** |
| 💾 **Database Size** | **70.97 MB** |
...
│ 📦 Products             │  19,080                        │
│ 🧾 Transaction Headers  │ ████████ 188,080               │
│ 📝 Transaction Lines    │ ████████████████████ 470,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,913 Suppliers (+ 3 per run)
- ✅ 1,942 Staff members (+ 2 per run)
- ✅ 19,080 Products (+ 10 per run)
- ✅ 188,080 Transactions (+ 20 per run)
- ✅ 470,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (70.97 MB)
...
**Current Status:** 683,335 records | 70.97 MB | Growing every 2 hours
