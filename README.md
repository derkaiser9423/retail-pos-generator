...
![Total Records](https://img.shields.io/badge/records-652,160-brightgreen)
![Database Size](https://img.shields.io/badge/size-67.83MB-blue)
...
> **Last Updated:** 2026-01-24 10:15:07 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **652,160** |
| 💾 **Database Size** | **67.83 MB** |
| 📅 **Last Updated** | January 24, 2026 at 10:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,220                        │
│ 🧾 Transaction Headers  │ ████████ 179,480               │
│ 📝 Transaction Lines    │ ████████████████████ 448,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,784 Suppliers (+ 3 per run)
- ✅ 1,856 Staff members (+ 2 per run)
- ✅ 18,220 Products (+ 10 per run)
- ✅ 179,480 Transactions (+ 20 per run)
- ✅ 448,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (67.83 MB)
...
- **Records:** 652,160
- **Size:** 67.83 MB
- **Last Updated:** 2026-01-24 10:15 UTC
...
**Current Status:** 652,160 records | 67.83 MB | Growing every 2 hours
