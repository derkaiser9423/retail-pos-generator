...
![Total Records](https://img.shields.io/badge/records-270,801-brightgreen)
![Database Size](https://img.shields.io/badge/size-27.83MB-blue)
...
> **Last Updated:** 2025-12-11 14:17:16 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **270,801** |
| 💾 **Database Size** | **27.83 MB** |
| 📅 **Last Updated** | December 11, 2025 at 14:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  7,700                         │
│ 🧾 Transaction Headers  │ ████████ 74,280                │
│ 📝 Transaction Lines    │ ████████████████████ 185,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,206 Suppliers (+ 3 per run)
- ✅ 804 Staff members (+ 2 per run)
- ✅ 7,700 Products (+ 10 per run)
- ✅ 74,280 Transactions (+ 20 per run)
- ✅ 185,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (27.83 MB)
...
- **Records:** 270,801
- **Size:** 27.83 MB
- **Last Updated:** 2025-12-11 14:17 UTC
...
**Current Status:** 270,801 records | 27.83 MB | Growing every 2 hours
