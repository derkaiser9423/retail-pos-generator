...
![Total Records](https://img.shields.io/badge/records-784,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-81.74MB-blue)
...
> **Last Updated:** 2026-02-09 20:33:19 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **784,835** |
| 💾 **Database Size** | **81.74 MB** |
| 📅 **Last Updated** | February 09, 2026 at 20:33 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,880                        │
│ 🧾 Transaction Headers  │ ████████ 216,080               │
│ 📝 Transaction Lines    │ ████████████████████ 540,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,333 Suppliers (+ 3 per run)
- ✅ 2,222 Staff members (+ 2 per run)
- ✅ 21,880 Products (+ 10 per run)
- ✅ 216,080 Transactions (+ 20 per run)
- ✅ 540,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (81.74 MB)
...
- **Records:** 784,835
- **Size:** 81.74 MB
- **Last Updated:** 2026-02-09 20:33 UTC
...
**Current Status:** 784,835 records | 81.74 MB | Growing every 2 hours
