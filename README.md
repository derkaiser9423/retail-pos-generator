...
![Total Records](https://img.shields.io/badge/records-486,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-50.44MB-blue)
...
> **Last Updated:** 2026-01-05 08:22:39 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **486,135** |
| 💾 **Database Size** | **50.44 MB** |
| 📅 **Last Updated** | January 05, 2026 at 08:22 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  13,640                        │
│ 🧾 Transaction Headers  │ ████████ 133,680               │
│ 📝 Transaction Lines    │ ████████████████████ 334,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,097 Suppliers (+ 3 per run)
- ✅ 1,398 Staff members (+ 2 per run)
- ✅ 13,640 Products (+ 10 per run)
- ✅ 133,680 Transactions (+ 20 per run)
- ✅ 334,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (50.44 MB)
...
- **Records:** 486,135
- **Size:** 50.44 MB
- **Last Updated:** 2026-01-05 08:22 UTC
...
**Current Status:** 486,135 records | 50.44 MB | Growing every 2 hours
