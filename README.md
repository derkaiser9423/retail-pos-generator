...
![Total Records](https://img.shields.io/badge/records-485,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-50.35MB-blue)
...
> **Last Updated:** 2026-01-05 06:28:14 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **485,410** |
| 💾 **Database Size** | **50.35 MB** |
...
│ 📦 Products             │  13,620                        │
│ 🧾 Transaction Headers  │ ████████ 133,480               │
│ 📝 Transaction Lines    │ ████████████████████ 333,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,094 Suppliers (+ 3 per run)
- ✅ 1,396 Staff members (+ 2 per run)
- ✅ 13,620 Products (+ 10 per run)
- ✅ 133,480 Transactions (+ 20 per run)
- ✅ 333,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (50.35 MB)
...
**Current Status:** 485,410 records | 50.35 MB | Growing every 2 hours
