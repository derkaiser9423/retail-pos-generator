...
![Total Records](https://img.shields.io/badge/records-264,275-brightgreen)
![Database Size](https://img.shields.io/badge/size-27.14MB-blue)
...
> **Last Updated:** 2025-12-10 20:16:05 UTC  
...
│ 📦 Products             │  7,520                         │
│ 🧾 Transaction Headers  │ ████████ 72,480                │
│ 📝 Transaction Lines    │ ████████████████████ 181,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,179 Suppliers (+ 3 per run)
- ✅ 786 Staff members (+ 2 per run)
- ✅ 7,520 Products (+ 10 per run)
- ✅ 72,480 Transactions (+ 20 per run)
- ✅ 181,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (27.14 MB)
...
- **Records:** 264,275
- **Size:** 27.14 MB
- **Last Updated:** 2025-12-10 20:16 UTC
...
**Current Status:** 264,275 records | 27.14 MB | Growing every 2 hours
