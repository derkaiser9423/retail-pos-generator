...
![Total Records](https://img.shields.io/badge/records-362,160-brightgreen)
![Database Size](https://img.shields.io/badge/size-37.38MB-blue)
...
> **Last Updated:** 2025-12-22 03:26:27 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **362,160** |
| 💾 **Database Size** | **37.38 MB** |
| 📅 **Last Updated** | December 22, 2025 at 03:26 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  10,220                        │
│ 🧾 Transaction Headers  │ ████████ 99,480                │
│ 📝 Transaction Lines    │ ████████████████████ 248,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,584 Suppliers (+ 3 per run)
- ✅ 1,056 Staff members (+ 2 per run)
- ✅ 10,220 Products (+ 10 per run)
- ✅ 99,480 Transactions (+ 20 per run)
- ✅ 248,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (37.38 MB)
...
- **Records:** 362,160
- **Size:** 37.38 MB
- **Last Updated:** 2025-12-22 03:26 UTC
...
**Current Status:** 362,160 records | 37.38 MB | Growing every 2 hours
