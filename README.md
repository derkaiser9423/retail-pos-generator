...
![Total Records](https://img.shields.io/badge/records-948,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-99.0MB-blue)
...
> **Last Updated:** 2026-03-02 06:50:10 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **948,685** |
| 💾 **Database Size** | **99.0 MB** |
| 📅 **Last Updated** | March 02, 2026 at 06:50 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,400                        │
│ 🧾 Transaction Headers  │ ████████ 261,280               │
│ 📝 Transaction Lines    │ ████████████████████ 653,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 4,011 Suppliers (+ 3 per run)
- ✅ 2,674 Staff members (+ 2 per run)
- ✅ 26,400 Products (+ 10 per run)
- ✅ 261,280 Transactions (+ 20 per run)
- ✅ 653,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (99.0 MB)
...
- **Records:** 948,685
- **Size:** 99.0 MB
- **Last Updated:** 2026-03-02 06:50 UTC
...
**Current Status:** 948,685 records | 99.0 MB | Growing every 2 hours
