...
![Total Records](https://img.shields.io/badge/records-376,660-brightgreen)
![Database Size](https://img.shields.io/badge/size-38.96MB-blue)
...
> **Last Updated:** 2025-12-23 18:21:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **376,660** |
| 💾 **Database Size** | **38.96 MB** |
...
│ 📦 Products             │  10,620                        │
│ 🧾 Transaction Headers  │ ████████ 103,480               │
│ 📝 Transaction Lines    │ ████████████████████ 258,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,644 Suppliers (+ 3 per run)
- ✅ 1,096 Staff members (+ 2 per run)
- ✅ 10,620 Products (+ 10 per run)
- ✅ 103,480 Transactions (+ 20 per run)
- ✅ 258,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (38.96 MB)
...
**Current Status:** 376,660 records | 38.96 MB | Growing every 2 hours
