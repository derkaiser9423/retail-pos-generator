...
![Total Records](https://img.shields.io/badge/records-934,910-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.47MB-blue)
...
> **Last Updated:** 2026-02-28 12:31:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **934,910** |
| 💾 **Database Size** | **97.47 MB** |
| 📅 **Last Updated** | February 28, 2026 at 12:31 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,020                        │
│ 🧾 Transaction Headers  │ ████████ 257,480               │
│ 📝 Transaction Lines    │ ████████████████████ 643,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,954 Suppliers (+ 3 per run)
- ✅ 2,636 Staff members (+ 2 per run)
- ✅ 26,020 Products (+ 10 per run)
- ✅ 257,480 Transactions (+ 20 per run)
- ✅ 643,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.47 MB)
...
**Current Status:** 934,910 records | 97.47 MB | Growing every 2 hours
