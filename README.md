...
![Total Records](https://img.shields.io/badge/records-861,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-89.71MB-blue)
...
> **Last Updated:** 2026-02-19 12:45:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **861,685** |
| 💾 **Database Size** | **89.71 MB** |
| 📅 **Last Updated** | February 19, 2026 at 12:45 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,000                        │
│ 🧾 Transaction Headers  │ ████████ 237,280               │
│ 📝 Transaction Lines    │ ████████████████████ 593,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,651 Suppliers (+ 3 per run)
- ✅ 2,434 Staff members (+ 2 per run)
- ✅ 24,000 Products (+ 10 per run)
- ✅ 237,280 Transactions (+ 20 per run)
- ✅ 593,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (89.71 MB)
...
**Current Status:** 861,685 records | 89.71 MB | Growing every 2 hours
