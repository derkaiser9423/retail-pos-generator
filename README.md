...
![Total Records](https://img.shields.io/badge/records-552,835-brightgreen)
![Database Size](https://img.shields.io/badge/size-57.34MB-blue)
...
> **Last Updated:** 2026-01-13 01:03:49 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **552,835** |
| 💾 **Database Size** | **57.34 MB** |
...
│ 📦 Products             │  15,480                        │
│ 🧾 Transaction Headers  │ ████████ 152,080               │
│ 📝 Transaction Lines    │ ████████████████████ 380,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,373 Suppliers (+ 3 per run)
- ✅ 1,582 Staff members (+ 2 per run)
- ✅ 15,480 Products (+ 10 per run)
- ✅ 152,080 Transactions (+ 20 per run)
- ✅ 380,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (57.34 MB)
...
- **Records:** 552,835
- **Size:** 57.34 MB
- **Last Updated:** 2026-01-13 01:03 UTC
...
**Current Status:** 552,835 records | 57.34 MB | Growing every 2 hours
