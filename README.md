...
![Total Records](https://img.shields.io/badge/records-512,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-53.28MB-blue)
...
> **Last Updated:** 2026-01-08 10:17:25 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **512,960** |
| 💾 **Database Size** | **53.28 MB** |
| 📅 **Last Updated** | January 08, 2026 at 10:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,380                        │
│ 🧾 Transaction Headers  │ ████████ 141,080               │
│ 📝 Transaction Lines    │ ████████████████████ 352,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,208 Suppliers (+ 3 per run)
- ✅ 1,472 Staff members (+ 2 per run)
- ✅ 14,380 Products (+ 10 per run)
- ✅ 141,080 Transactions (+ 20 per run)
- ✅ 352,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (53.28 MB)
...
- **Records:** 512,960
- **Size:** 53.28 MB
- **Last Updated:** 2026-01-08 10:17 UTC
...
**Current Status:** 512,960 records | 53.28 MB | Growing every 2 hours
