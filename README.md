...
![Total Records](https://img.shields.io/badge/records-474,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-49.22MB-blue)
...
> **Last Updated:** 2026-01-04 01:14:01 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **474,535** |
| 💾 **Database Size** | **49.22 MB** |
...
│ 📦 Products             │  13,320                        │
│ 🧾 Transaction Headers  │ ████████ 130,480               │
│ 📝 Transaction Lines    │ ████████████████████ 326,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,049 Suppliers (+ 3 per run)
- ✅ 1,366 Staff members (+ 2 per run)
- ✅ 13,320 Products (+ 10 per run)
- ✅ 130,480 Transactions (+ 20 per run)
- ✅ 326,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (49.22 MB)
...
**Current Status:** 474,535 records | 49.22 MB | Growing every 2 hours
