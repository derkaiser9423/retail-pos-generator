...
![Total Records](https://img.shields.io/badge/records-446,985-brightgreen)
![Database Size](https://img.shields.io/badge/size-46.23MB-blue)
...
> **Last Updated:** 2025-12-31 20:15:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **446,985** |
| 💾 **Database Size** | **46.23 MB** |
| 📅 **Last Updated** | December 31, 2025 at 20:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  12,560                        │
│ 🧾 Transaction Headers  │ ████████ 122,880               │
│ 📝 Transaction Lines    │ ████████████████████ 307,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,935 Suppliers (+ 3 per run)
- ✅ 1,290 Staff members (+ 2 per run)
- ✅ 12,560 Products (+ 10 per run)
- ✅ 122,880 Transactions (+ 20 per run)
- ✅ 307,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (46.23 MB)
...
- **Records:** 446,985
- **Size:** 46.23 MB
- **Last Updated:** 2025-12-31 20:15 UTC
...
**Current Status:** 446,985 records | 46.23 MB | Growing every 2 hours
