...
![Total Records](https://img.shields.io/badge/records-509,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-52.91MB-blue)
...
> **Last Updated:** 2026-01-08 01:06:56 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **509,335** |
| 💾 **Database Size** | **52.91 MB** |
| 📅 **Last Updated** | January 08, 2026 at 01:06 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,280                        │
│ 🧾 Transaction Headers  │ ████████ 140,080               │
│ 📝 Transaction Lines    │ ████████████████████ 350,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,193 Suppliers (+ 3 per run)
- ✅ 1,462 Staff members (+ 2 per run)
- ✅ 14,280 Products (+ 10 per run)
- ✅ 140,080 Transactions (+ 20 per run)
- ✅ 350,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (52.91 MB)
...
- **Records:** 509,335
- **Size:** 52.91 MB
- **Last Updated:** 2026-01-08 01:06 UTC
...
**Current Status:** 509,335 records | 52.91 MB | Growing every 2 hours
