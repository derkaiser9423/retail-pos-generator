...
![Total Records](https://img.shields.io/badge/records-758,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-78.93MB-blue)
...
> **Last Updated:** 2026-02-06 12:41:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **758,735** |
| 💾 **Database Size** | **78.93 MB** |
...
│ 📦 Products             │  21,160                        │
│ 🧾 Transaction Headers  │ ████████ 208,880               │
│ 📝 Transaction Lines    │ ████████████████████ 522,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,225 Suppliers (+ 3 per run)
- ✅ 2,150 Staff members (+ 2 per run)
- ✅ 21,160 Products (+ 10 per run)
- ✅ 208,880 Transactions (+ 20 per run)
- ✅ 522,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (78.93 MB)
...
- **Records:** 758,735
- **Size:** 78.93 MB
- **Last Updated:** 2026-02-06 12:41 UTC
...
**Current Status:** 758,735 records | 78.93 MB | Growing every 2 hours
