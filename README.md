...
![Total Records](https://img.shields.io/badge/records-523,110-brightgreen)
![Database Size](https://img.shields.io/badge/size-54.27MB-blue)
...
> **Last Updated:** 2026-01-09 14:17:56 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **523,110** |
| 💾 **Database Size** | **54.27 MB** |
| 📅 **Last Updated** | January 09, 2026 at 14:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,660                        │
│ 🧾 Transaction Headers  │ ████████ 143,880               │
│ 📝 Transaction Lines    │ ████████████████████ 359,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,250 Suppliers (+ 3 per run)
- ✅ 1,500 Staff members (+ 2 per run)
- ✅ 14,660 Products (+ 10 per run)
- ✅ 143,880 Transactions (+ 20 per run)
- ✅ 359,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (54.27 MB)
...
**Current Status:** 523,110 records | 54.27 MB | Growing every 2 hours
