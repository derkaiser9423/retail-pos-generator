...
![Total Records](https://img.shields.io/badge/records-429,585-brightgreen)
![Database Size](https://img.shields.io/badge/size-44.46MB-blue)
...
> **Last Updated:** 2025-12-29 20:16:16 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **429,585** |
| 💾 **Database Size** | **44.46 MB** |
| 📅 **Last Updated** | December 29, 2025 at 20:16 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  12,080                        │
│ 🧾 Transaction Headers  │ ████████ 118,080               │
│ 📝 Transaction Lines    │ ████████████████████ 295,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,863 Suppliers (+ 3 per run)
- ✅ 1,242 Staff members (+ 2 per run)
- ✅ 12,080 Products (+ 10 per run)
- ✅ 118,080 Transactions (+ 20 per run)
- ✅ 295,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (44.46 MB)
...
**Current Status:** 429,585 records | 44.46 MB | Growing every 2 hours
