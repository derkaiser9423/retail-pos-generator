...
![Total Records](https://img.shields.io/badge/records-860,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-89.62MB-blue)
...
> **Last Updated:** 2026-02-19 10:38:28 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **860,960** |
| 💾 **Database Size** | **89.62 MB** |
| 📅 **Last Updated** | February 19, 2026 at 10:38 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,980                        │
│ 🧾 Transaction Headers  │ ████████ 237,080               │
│ 📝 Transaction Lines    │ ████████████████████ 592,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,648 Suppliers (+ 3 per run)
- ✅ 2,432 Staff members (+ 2 per run)
- ✅ 23,980 Products (+ 10 per run)
- ✅ 237,080 Transactions (+ 20 per run)
- ✅ 592,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (89.62 MB)
...
- **Records:** 860,960
- **Size:** 89.62 MB
- **Last Updated:** 2026-02-19 10:38 UTC
...
**Current Status:** 860,960 records | 89.62 MB | Growing every 2 hours
