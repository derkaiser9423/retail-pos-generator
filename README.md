...
![Total Records](https://img.shields.io/badge/records-596,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-61.99MB-blue)
...
> **Last Updated:** 2026-01-18 01:12:49 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **596,335** |
| 💾 **Database Size** | **61.99 MB** |
...
│ 📦 Products             │  16,680                        │
│ 🧾 Transaction Headers  │ ████████ 164,080               │
│ 📝 Transaction Lines    │ ████████████████████ 410,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,553 Suppliers (+ 3 per run)
- ✅ 1,702 Staff members (+ 2 per run)
- ✅ 16,680 Products (+ 10 per run)
- ✅ 164,080 Transactions (+ 20 per run)
- ✅ 410,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (61.99 MB)
...
- **Records:** 596,335
- **Size:** 61.99 MB
- **Last Updated:** 2026-01-18 01:12 UTC
...
**Current Status:** 596,335 records | 61.99 MB | Growing every 2 hours
