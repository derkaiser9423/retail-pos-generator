...
![Total Records](https://img.shields.io/badge/records-187,372-brightgreen)
![Database Size](https://img.shields.io/badge/size-19.14MB-blue)
...
> **Last Updated:** 2025-12-02 01:02:26 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **187,372** |
| 💾 **Database Size** | **19.14 MB** |
...
│ 🏷️ Product Groups       │  755                           │
│ 📦 Products             │  5,400                         │
│ 🧾 Transaction Headers  │ ████████ 51,280                │
│ 📝 Transaction Lines    │ ████████████████████ 128,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 861 Suppliers (+ 3 per run)
- ✅ 574 Staff members (+ 2 per run)
- ✅ 5,400 Products (+ 10 per run)
- ✅ 51,280 Transactions (+ 20 per run)
- ✅ 128,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (19.14 MB)
...
- **Records:** 187,372
- **Size:** 19.14 MB
- **Last Updated:** 2025-12-02 01:02 UTC
...
**Current Status:** 187,372 records | 19.14 MB | Growing every 2 hours
