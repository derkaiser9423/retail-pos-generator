...
![Total Records](https://img.shields.io/badge/records-728,285-brightgreen)
![Database Size](https://img.shields.io/badge/size-75.77MB-blue)
...
> **Last Updated:** 2026-02-02 12:40:03 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **728,285** |
| 💾 **Database Size** | **75.77 MB** |
...
│ 📦 Products             │  20,320                        │
│ 🧾 Transaction Headers  │ ████████ 200,480               │
│ 📝 Transaction Lines    │ ████████████████████ 501,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,099 Suppliers (+ 3 per run)
- ✅ 2,066 Staff members (+ 2 per run)
- ✅ 20,320 Products (+ 10 per run)
- ✅ 200,480 Transactions (+ 20 per run)
- ✅ 501,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (75.77 MB)
...
- **Records:** 728,285
- **Size:** 75.77 MB
- **Last Updated:** 2026-02-02 12:40 UTC
...
**Current Status:** 728,285 records | 75.77 MB | Growing every 2 hours
