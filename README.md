...
![Total Records](https://img.shields.io/badge/records-922,585-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.2MB-blue)
...
> **Last Updated:** 2026-02-27 01:19:41 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **922,585** |
| 💾 **Database Size** | **96.2 MB** |
| 📅 **Last Updated** | February 27, 2026 at 01:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,680                        │
│ 🧾 Transaction Headers  │ ████████ 254,080               │
│ 📝 Transaction Lines    │ ████████████████████ 635,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,903 Suppliers (+ 3 per run)
- ✅ 2,602 Staff members (+ 2 per run)
- ✅ 25,680 Products (+ 10 per run)
- ✅ 254,080 Transactions (+ 20 per run)
- ✅ 635,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.2 MB)
...
- **Records:** 922,585
- **Size:** 96.2 MB
- **Last Updated:** 2026-02-27 01:19 UTC
...
**Current Status:** 922,585 records | 96.2 MB | Growing every 2 hours
