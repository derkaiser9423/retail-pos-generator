...
![Total Records](https://img.shields.io/badge/records-839,935-brightgreen)
![Database Size](https://img.shields.io/badge/size-87.36MB-blue)
...
> **Last Updated:** 2026-02-16 18:35:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **839,935** |
| 💾 **Database Size** | **87.36 MB** |
| 📅 **Last Updated** | February 16, 2026 at 18:35 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  23,400                        │
│ 🧾 Transaction Headers  │ ████████ 231,280               │
│ 📝 Transaction Lines    │ ████████████████████ 578,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,561 Suppliers (+ 3 per run)
- ✅ 2,374 Staff members (+ 2 per run)
- ✅ 23,400 Products (+ 10 per run)
- ✅ 231,280 Transactions (+ 20 per run)
- ✅ 578,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (87.36 MB)
...
**Current Status:** 839,935 records | 87.36 MB | Growing every 2 hours
