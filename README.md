...
![Total Records](https://img.shields.io/badge/records-489,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-50.73MB-blue)
...
> **Last Updated:** 2026-01-05 16:20:04 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **489,035** |
| 💾 **Database Size** | **50.73 MB** |
| 📅 **Last Updated** | January 05, 2026 at 16:20 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  13,720                        │
│ 🧾 Transaction Headers  │ ████████ 134,480               │
│ 📝 Transaction Lines    │ ████████████████████ 336,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,109 Suppliers (+ 3 per run)
- ✅ 1,406 Staff members (+ 2 per run)
- ✅ 13,720 Products (+ 10 per run)
- ✅ 134,480 Transactions (+ 20 per run)
- ✅ 336,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (50.73 MB)
...
- **Records:** 489,035
- **Size:** 50.73 MB
- **Last Updated:** 2026-01-05 16:20 UTC
...
**Current Status:** 489,035 records | 50.73 MB | Growing every 2 hours
