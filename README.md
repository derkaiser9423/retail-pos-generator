...
![Total Records](https://img.shields.io/badge/records-557,185-brightgreen)
![Database Size](https://img.shields.io/badge/size-57.81MB-blue)
...
> **Last Updated:** 2026-01-13 12:30:51 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **557,185** |
| 💾 **Database Size** | **57.81 MB** |
| 📅 **Last Updated** | January 13, 2026 at 12:30 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  15,600                        │
│ 🧾 Transaction Headers  │ ████████ 153,280               │
│ 📝 Transaction Lines    │ ████████████████████ 383,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,391 Suppliers (+ 3 per run)
- ✅ 1,594 Staff members (+ 2 per run)
- ✅ 15,600 Products (+ 10 per run)
- ✅ 153,280 Transactions (+ 20 per run)
- ✅ 383,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (57.81 MB)
...
- **Records:** 557,185
- **Size:** 57.81 MB
- **Last Updated:** 2026-01-13 12:30 UTC
...
**Current Status:** 557,185 records | 57.81 MB | Growing every 2 hours
