...
![Total Records](https://img.shields.io/badge/records-585,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-60.81MB-blue)
...
> **Last Updated:** 2026-01-16 18:22:13 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **585,460** |
| 💾 **Database Size** | **60.81 MB** |
...
│ 📦 Products             │  16,380                        │
│ 🧾 Transaction Headers  │ ████████ 161,080               │
│ 📝 Transaction Lines    │ ████████████████████ 402,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,508 Suppliers (+ 3 per run)
- ✅ 1,672 Staff members (+ 2 per run)
- ✅ 16,380 Products (+ 10 per run)
- ✅ 161,080 Transactions (+ 20 per run)
- ✅ 402,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (60.81 MB)
...
- **Records:** 585,460
- **Size:** 60.81 MB
- **Last Updated:** 2026-01-16 18:22 UTC
...
**Current Status:** 585,460 records | 60.81 MB | Growing every 2 hours
