...
![Total Records](https://img.shields.io/badge/records-770,335-brightgreen)
![Database Size](https://img.shields.io/badge/size-80.2MB-blue)
...
> **Last Updated:** 2026-02-07 22:19:09 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **770,335** |
| 💾 **Database Size** | **80.2 MB** |
| 📅 **Last Updated** | February 07, 2026 at 22:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,480                        │
│ 🧾 Transaction Headers  │ ████████ 212,080               │
│ 📝 Transaction Lines    │ ████████████████████ 530,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,273 Suppliers (+ 3 per run)
- ✅ 2,182 Staff members (+ 2 per run)
- ✅ 21,480 Products (+ 10 per run)
- ✅ 212,080 Transactions (+ 20 per run)
- ✅ 530,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (80.2 MB)
...
- **Records:** 770,335
- **Size:** 80.2 MB
- **Last Updated:** 2026-02-07 22:19 UTC
...
**Current Status:** 770,335 records | 80.2 MB | Growing every 2 hours
