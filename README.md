...
![Total Records](https://img.shields.io/badge/records-723,210-brightgreen)
![Database Size](https://img.shields.io/badge/size-75.25MB-blue)
...
> **Last Updated:** 2026-02-01 20:18:49 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **723,210** |
| 💾 **Database Size** | **75.25 MB** |
| 📅 **Last Updated** | February 01, 2026 at 20:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,180                        │
│ 🧾 Transaction Headers  │ ████████ 199,080               │
│ 📝 Transaction Lines    │ ████████████████████ 497,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,078 Suppliers (+ 3 per run)
- ✅ 2,052 Staff members (+ 2 per run)
- ✅ 20,180 Products (+ 10 per run)
- ✅ 199,080 Transactions (+ 20 per run)
- ✅ 497,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (75.25 MB)
...
- **Records:** 723,210
- **Size:** 75.25 MB
- **Last Updated:** 2026-02-01 20:18 UTC
...
**Current Status:** 723,210 records | 75.25 MB | Growing every 2 hours
