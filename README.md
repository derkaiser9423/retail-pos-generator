...
![Total Records](https://img.shields.io/badge/records-231,642-brightgreen)
![Database Size](https://img.shields.io/badge/size-23.8MB-blue)
...
> **Last Updated:** 2025-12-07 03:21:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **231,642** |
| 💾 **Database Size** | **23.8 MB** |
| 📅 **Last Updated** | December 07, 2025 at 03:21 UTC |
| 📈 **24h Growth** | +726 records |
...
│ 📦 Products             │  6,620                         │
│ 🧾 Transaction Headers  │ ████████ 63,480                │
│ 📝 Transaction Lines    │ ████████████████████ 158,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,044 Suppliers (+ 3 per run)
- ✅ 696 Staff members (+ 2 per run)
- ✅ 6,620 Products (+ 10 per run)
- ✅ 63,480 Transactions (+ 20 per run)
- ✅ 158,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (23.8 MB)
...
- **Records:** 231,642
- **Size:** 23.8 MB
- **Last Updated:** 2025-12-07 03:21 UTC
...
**Current Status:** 231,642 records | 23.8 MB | Growing every 2 hours
