...
![Total Records](https://img.shields.io/badge/records-759,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-79.04MB-blue)
...
> **Last Updated:** 2026-02-06 14:37:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **759,460** |
| 💾 **Database Size** | **79.04 MB** |
| 📅 **Last Updated** | February 06, 2026 at 14:37 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,180                        │
│ 🧾 Transaction Headers  │ ████████ 209,080               │
│ 📝 Transaction Lines    │ ████████████████████ 522,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,228 Suppliers (+ 3 per run)
- ✅ 2,152 Staff members (+ 2 per run)
- ✅ 21,180 Products (+ 10 per run)
- ✅ 209,080 Transactions (+ 20 per run)
- ✅ 522,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (79.04 MB)
...
**Current Status:** 759,460 records | 79.04 MB | Growing every 2 hours
