...
![Total Records](https://img.shields.io/badge/records-324,459-brightgreen)
![Database Size](https://img.shields.io/badge/size-33.46MB-blue)
...
> **Last Updated:** 2025-12-17 18:22:05 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **324,459** |
| 💾 **Database Size** | **33.46 MB** |
...
│ 📦 Products             │  9,180                         │
│ 🧾 Transaction Headers  │ ████████ 89,080                │
│ 📝 Transaction Lines    │ ████████████████████ 222,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,428 Suppliers (+ 3 per run)
- ✅ 952 Staff members (+ 2 per run)
- ✅ 9,180 Products (+ 10 per run)
- ✅ 89,080 Transactions (+ 20 per run)
- ✅ 222,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (33.46 MB)
...
- **Records:** 324,459
- **Size:** 33.46 MB
- **Last Updated:** 2025-12-17 18:22 UTC
...
**Current Status:** 324,459 records | 33.46 MB | Growing every 2 hours
