...
![Total Records](https://img.shields.io/badge/records-594,160-brightgreen)
![Database Size](https://img.shields.io/badge/size-61.72MB-blue)
...
> **Last Updated:** 2026-01-17 18:19:25 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **594,160** |
| 💾 **Database Size** | **61.72 MB** |
...
│ 📦 Products             │  16,620                        │
│ 🧾 Transaction Headers  │ ████████ 163,480               │
│ 📝 Transaction Lines    │ ████████████████████ 408,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,544 Suppliers (+ 3 per run)
- ✅ 1,696 Staff members (+ 2 per run)
- ✅ 16,620 Products (+ 10 per run)
- ✅ 163,480 Transactions (+ 20 per run)
- ✅ 408,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (61.72 MB)
...
- **Records:** 594,160
- **Size:** 61.72 MB
- **Last Updated:** 2026-01-17 18:19 UTC
...
**Current Status:** 594,160 records | 61.72 MB | Growing every 2 hours
