...
![Total Records](https://img.shields.io/badge/records-873,285-brightgreen)
![Database Size](https://img.shields.io/badge/size-90.96MB-blue)
...
> **Last Updated:** 2026-02-20 22:19:46 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **873,285** |
| 💾 **Database Size** | **90.96 MB** |
| 📅 **Last Updated** | February 20, 2026 at 22:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,320                        │
│ 🧾 Transaction Headers  │ ████████ 240,480               │
│ 📝 Transaction Lines    │ ████████████████████ 601,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,699 Suppliers (+ 3 per run)
- ✅ 2,466 Staff members (+ 2 per run)
- ✅ 24,320 Products (+ 10 per run)
- ✅ 240,480 Transactions (+ 20 per run)
- ✅ 601,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (90.96 MB)
...
**Current Status:** 873,285 records | 90.96 MB | Growing every 2 hours
