...
![Total Records](https://img.shields.io/badge/records-921,860-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.11MB-blue)
...
> **Last Updated:** 2026-02-26 22:29:02 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **921,860** |
| 💾 **Database Size** | **96.11 MB** |
| 📅 **Last Updated** | February 26, 2026 at 22:29 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,660                        │
│ 🧾 Transaction Headers  │ ████████ 253,880               │
│ 📝 Transaction Lines    │ ████████████████████ 634,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,900 Suppliers (+ 3 per run)
- ✅ 2,600 Staff members (+ 2 per run)
- ✅ 25,660 Products (+ 10 per run)
- ✅ 253,880 Transactions (+ 20 per run)
- ✅ 634,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.11 MB)
...
- **Records:** 921,860
- **Size:** 96.11 MB
- **Last Updated:** 2026-02-26 22:29 UTC
...
**Current Status:** 921,860 records | 96.11 MB | Growing every 2 hours
