...
![Total Records](https://img.shields.io/badge/records-568,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-58.99MB-blue)
...
> **Last Updated:** 2026-01-14 18:23:32 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **568,060** |
| 💾 **Database Size** | **58.99 MB** |
...
│ 📦 Products             │  15,900                        │
│ 🧾 Transaction Headers  │ ████████ 156,280               │
│ 📝 Transaction Lines    │ ████████████████████ 390,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,436 Suppliers (+ 3 per run)
- ✅ 1,624 Staff members (+ 2 per run)
- ✅ 15,900 Products (+ 10 per run)
- ✅ 156,280 Transactions (+ 20 per run)
- ✅ 390,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (58.99 MB)
...
- **Records:** 568,060
- **Size:** 58.99 MB
- **Last Updated:** 2026-01-14 18:23 UTC
...
**Current Status:** 568,060 records | 58.99 MB | Growing every 2 hours
