...
![Total Records](https://img.shields.io/badge/records-322,284-brightgreen)
![Database Size](https://img.shields.io/badge/size-33.24MB-blue)
...
> **Last Updated:** 2025-12-17 12:28:56 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **322,284** |
| 💾 **Database Size** | **33.24 MB** |
| 📅 **Last Updated** | December 17, 2025 at 12:28 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  9,120                         │
│ 🧾 Transaction Headers  │ ████████ 88,480                │
│ 📝 Transaction Lines    │ ████████████████████ 221,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,419 Suppliers (+ 3 per run)
- ✅ 946 Staff members (+ 2 per run)
- ✅ 9,120 Products (+ 10 per run)
- ✅ 88,480 Transactions (+ 20 per run)
- ✅ 221,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (33.24 MB)
...
- **Records:** 322,284
- **Size:** 33.24 MB
- **Last Updated:** 2025-12-17 12:28 UTC
...
**Current Status:** 322,284 records | 33.24 MB | Growing every 2 hours
