...
![Total Records](https://img.shields.io/badge/records-301,256-brightgreen)
![Database Size](https://img.shields.io/badge/size-31.11MB-blue)
...
> **Last Updated:** 2025-12-15 03:24:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **301,256** |
| 💾 **Database Size** | **31.11 MB** |
| 📅 **Last Updated** | December 15, 2025 at 03:24 UTC |
| 📈 **24h Growth** | +726 records |
...
│ 📦 Products             │  8,540                         │
│ 🧾 Transaction Headers  │ ████████ 82,680                │
│ 📝 Transaction Lines    │ ████████████████████ 206,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,332 Suppliers (+ 3 per run)
- ✅ 888 Staff members (+ 2 per run)
- ✅ 8,540 Products (+ 10 per run)
- ✅ 82,680 Transactions (+ 20 per run)
- ✅ 206,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (31.11 MB)
...
- **Records:** 301,256
- **Size:** 31.11 MB
- **Last Updated:** 2025-12-15 03:24 UTC
...
**Current Status:** 301,256 records | 31.11 MB | Growing every 2 hours
