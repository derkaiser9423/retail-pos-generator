...
![Total Records](https://img.shields.io/badge/records-640,560-brightgreen)
![Database Size](https://img.shields.io/badge/size-66.61MB-blue)
...
> **Last Updated:** 2026-01-23 03:27:39 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **640,560** |
| 💾 **Database Size** | **66.61 MB** |
| 📅 **Last Updated** | January 23, 2026 at 03:27 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,900                        │
│ 🧾 Transaction Headers  │ ████████ 176,280               │
│ 📝 Transaction Lines    │ ████████████████████ 440,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,736 Suppliers (+ 3 per run)
- ✅ 1,824 Staff members (+ 2 per run)
- ✅ 17,900 Products (+ 10 per run)
- ✅ 176,280 Transactions (+ 20 per run)
- ✅ 440,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (66.61 MB)
...
- **Records:** 640,560
- **Size:** 66.61 MB
- **Last Updated:** 2026-01-23 03:27 UTC
...
**Current Status:** 640,560 records | 66.61 MB | Growing every 2 hours
