...
![Total Records](https://img.shields.io/badge/records-937,810-brightgreen)
![Database Size](https://img.shields.io/badge/size-97.75MB-blue)
...
> **Last Updated:** 2026-02-28 20:19:55 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **937,810** |
| 💾 **Database Size** | **97.75 MB** |
| 📅 **Last Updated** | February 28, 2026 at 20:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  26,100                        │
│ 🧾 Transaction Headers  │ ████████ 258,280               │
│ 📝 Transaction Lines    │ ████████████████████ 645,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,966 Suppliers (+ 3 per run)
- ✅ 2,644 Staff members (+ 2 per run)
- ✅ 26,100 Products (+ 10 per run)
- ✅ 258,280 Transactions (+ 20 per run)
- ✅ 645,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (97.75 MB)
...
**Current Status:** 937,810 records | 97.75 MB | Growing every 2 hours
