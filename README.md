...
![Total Records](https://img.shields.io/badge/records-489,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-50.79MB-blue)
...
> **Last Updated:** 2026-01-05 18:22:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **489,760** |
| 💾 **Database Size** | **50.79 MB** |
...
│ 📦 Products             │  13,740                        │
│ 🧾 Transaction Headers  │ ████████ 134,680               │
│ 📝 Transaction Lines    │ ████████████████████ 336,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,112 Suppliers (+ 3 per run)
- ✅ 1,408 Staff members (+ 2 per run)
- ✅ 13,740 Products (+ 10 per run)
- ✅ 134,680 Transactions (+ 20 per run)
- ✅ 336,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (50.79 MB)
...
**Current Status:** 489,760 records | 50.79 MB | Growing every 2 hours
