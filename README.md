...
![Total Records](https://img.shields.io/badge/records-486,860-brightgreen)
![Database Size](https://img.shields.io/badge/size-50.53MB-blue)
...
> **Last Updated:** 2026-01-05 10:18:05 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **486,860** |
| 💾 **Database Size** | **50.53 MB** |
| 📅 **Last Updated** | January 05, 2026 at 10:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  13,660                        │
│ 🧾 Transaction Headers  │ ████████ 133,880               │
│ 📝 Transaction Lines    │ ████████████████████ 334,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,100 Suppliers (+ 3 per run)
- ✅ 1,400 Staff members (+ 2 per run)
- ✅ 13,660 Products (+ 10 per run)
- ✅ 133,880 Transactions (+ 20 per run)
- ✅ 334,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (50.53 MB)
...
- **Records:** 486,860
- **Size:** 50.53 MB
- **Last Updated:** 2026-01-05 10:18 UTC
...
**Current Status:** 486,860 records | 50.53 MB | Growing every 2 hours
