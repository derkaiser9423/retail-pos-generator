...
![Total Records](https://img.shields.io/badge/records-687,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-71.45MB-blue)
...
> **Last Updated:** 2026-01-28 12:33:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **687,685** |
| 💾 **Database Size** | **71.45 MB** |
...
│ 📦 Products             │  19,200                        │
│ 🧾 Transaction Headers  │ ████████ 189,280               │
│ 📝 Transaction Lines    │ ████████████████████ 473,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,931 Suppliers (+ 3 per run)
- ✅ 1,954 Staff members (+ 2 per run)
- ✅ 19,200 Products (+ 10 per run)
- ✅ 189,280 Transactions (+ 20 per run)
- ✅ 473,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (71.45 MB)
...
- **Records:** 687,685
- **Size:** 71.45 MB
- **Last Updated:** 2026-01-28 12:33 UTC
...
**Current Status:** 687,685 records | 71.45 MB | Growing every 2 hours
