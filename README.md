...
![Total Records](https://img.shields.io/badge/records-634,035-brightgreen)
![Database Size](https://img.shields.io/badge/size-65.88MB-blue)
...
> **Last Updated:** 2026-01-22 08:22:27 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **634,035** |
| 💾 **Database Size** | **65.88 MB** |
| 📅 **Last Updated** | January 22, 2026 at 08:22 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  17,720                        │
│ 🧾 Transaction Headers  │ ████████ 174,480               │
│ 📝 Transaction Lines    │ ████████████████████ 436,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,709 Suppliers (+ 3 per run)
- ✅ 1,806 Staff members (+ 2 per run)
- ✅ 17,720 Products (+ 10 per run)
- ✅ 174,480 Transactions (+ 20 per run)
- ✅ 436,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (65.88 MB)
...
- **Records:** 634,035
- **Size:** 65.88 MB
- **Last Updated:** 2026-01-22 08:22 UTC
...
**Current Status:** 634,035 records | 65.88 MB | Growing every 2 hours
