...
![Total Records](https://img.shields.io/badge/records-747,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-77.78MB-blue)
...
> **Last Updated:** 2026-02-05 01:19:52 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **747,135** |
| 💾 **Database Size** | **77.78 MB** |
| 📅 **Last Updated** | February 05, 2026 at 01:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,840                        │
│ 🧾 Transaction Headers  │ ████████ 205,680               │
│ 📝 Transaction Lines    │ ████████████████████ 514,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,177 Suppliers (+ 3 per run)
- ✅ 2,118 Staff members (+ 2 per run)
- ✅ 20,840 Products (+ 10 per run)
- ✅ 205,680 Transactions (+ 20 per run)
- ✅ 514,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (77.78 MB)
...
- **Records:** 747,135
- **Size:** 77.78 MB
- **Last Updated:** 2026-02-05 01:19 UTC
...
**Current Status:** 747,135 records | 77.78 MB | Growing every 2 hours
