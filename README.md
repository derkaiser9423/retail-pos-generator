...
![Total Records](https://img.shields.io/badge/records-863,860-brightgreen)
![Database Size](https://img.shields.io/badge/size-89.95MB-blue)
...
> **Last Updated:** 2026-02-19 18:43:05 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **863,860** |
| 💾 **Database Size** | **89.95 MB** |
| 📅 **Last Updated** | February 19, 2026 at 18:43 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,060                        │
│ 🧾 Transaction Headers  │ ████████ 237,880               │
│ 📝 Transaction Lines    │ ████████████████████ 594,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,660 Suppliers (+ 3 per run)
- ✅ 2,440 Staff members (+ 2 per run)
- ✅ 24,060 Products (+ 10 per run)
- ✅ 237,880 Transactions (+ 20 per run)
- ✅ 594,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (89.95 MB)
...
**Current Status:** 863,860 records | 89.95 MB | Growing every 2 hours
