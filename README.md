...
![Total Records](https://img.shields.io/badge/records-576,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-59.87MB-blue)
...
> **Last Updated:** 2026-01-15 18:27:47 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **576,760** |
| 💾 **Database Size** | **59.87 MB** |
...
│ 📦 Products             │  16,140                        │
│ 🧾 Transaction Headers  │ ████████ 158,680               │
│ 📝 Transaction Lines    │ ████████████████████ 396,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,472 Suppliers (+ 3 per run)
- ✅ 1,648 Staff members (+ 2 per run)
- ✅ 16,140 Products (+ 10 per run)
- ✅ 158,680 Transactions (+ 20 per run)
- ✅ 396,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (59.87 MB)
...
- **Records:** 576,760
- **Size:** 59.87 MB
- **Last Updated:** 2026-01-15 18:27 UTC
...
**Current Status:** 576,760 records | 59.87 MB | Growing every 2 hours
