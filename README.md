...
![Total Records](https://img.shields.io/badge/records-803,685-brightgreen)
![Database Size](https://img.shields.io/badge/size-83.64MB-blue)
...
> **Last Updated:** 2026-02-12 06:54:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **803,685** |
| 💾 **Database Size** | **83.64 MB** |
| 📅 **Last Updated** | February 12, 2026 at 06:54 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,400                        │
│ 🧾 Transaction Headers  │ ████████ 221,280               │
│ 📝 Transaction Lines    │ ████████████████████ 553,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,411 Suppliers (+ 3 per run)
- ✅ 2,274 Staff members (+ 2 per run)
- ✅ 22,400 Products (+ 10 per run)
- ✅ 221,280 Transactions (+ 20 per run)
- ✅ 553,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (83.64 MB)
...
- **Records:** 803,685
- **Size:** 83.64 MB
- **Last Updated:** 2026-02-12 06:54 UTC
...
**Current Status:** 803,685 records | 83.64 MB | Growing every 2 hours
