...
![Total Records](https://img.shields.io/badge/records-577,485-brightgreen)
![Database Size](https://img.shields.io/badge/size-59.96MB-blue)
...
> **Last Updated:** 2026-01-15 20:17:28 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **577,485** |
| 💾 **Database Size** | **59.96 MB** |
| 📅 **Last Updated** | January 15, 2026 at 20:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,160                        │
│ 🧾 Transaction Headers  │ ████████ 158,880               │
│ 📝 Transaction Lines    │ ████████████████████ 397,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,475 Suppliers (+ 3 per run)
- ✅ 1,650 Staff members (+ 2 per run)
- ✅ 16,160 Products (+ 10 per run)
- ✅ 158,880 Transactions (+ 20 per run)
- ✅ 397,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (59.96 MB)
...
**Current Status:** 577,485 records | 59.96 MB | Growing every 2 hours
