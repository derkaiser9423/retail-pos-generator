...
![Total Records](https://img.shields.io/badge/records-518,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-53.82MB-blue)
...
> **Last Updated:** 2026-01-09 03:25:07 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **518,760** |
| 💾 **Database Size** | **53.82 MB** |
| 📅 **Last Updated** | January 09, 2026 at 03:25 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  14,540                        │
│ 🧾 Transaction Headers  │ ████████ 142,680               │
│ 📝 Transaction Lines    │ ████████████████████ 356,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,232 Suppliers (+ 3 per run)
- ✅ 1,488 Staff members (+ 2 per run)
- ✅ 14,540 Products (+ 10 per run)
- ✅ 142,680 Transactions (+ 20 per run)
- ✅ 356,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (53.82 MB)
...
- **Records:** 518,760
- **Size:** 53.82 MB
- **Last Updated:** 2026-01-09 03:25 UTC
...
**Current Status:** 518,760 records | 53.82 MB | Growing every 2 hours
