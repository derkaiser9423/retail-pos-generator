...
![Total Records](https://img.shields.io/badge/records-889,235-brightgreen)
![Database Size](https://img.shields.io/badge/size-92.64MB-blue)
...
> **Last Updated:** 2026-02-22 20:19:31 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **889,235** |
| 💾 **Database Size** | **92.64 MB** |
| 📅 **Last Updated** | February 22, 2026 at 20:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,760                        │
│ 🧾 Transaction Headers  │ ████████ 244,880               │
│ 📝 Transaction Lines    │ ████████████████████ 612,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,765 Suppliers (+ 3 per run)
- ✅ 2,510 Staff members (+ 2 per run)
- ✅ 24,760 Products (+ 10 per run)
- ✅ 244,880 Transactions (+ 20 per run)
- ✅ 612,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (92.64 MB)
...
- **Records:** 889,235
- **Size:** 92.64 MB
- **Last Updated:** 2026-02-22 20:19 UTC
...
**Current Status:** 889,235 records | 92.64 MB | Growing every 2 hours
