...
![Total Records](https://img.shields.io/badge/records-396,235-brightgreen)
![Database Size](https://img.shields.io/badge/size-40.99MB-blue)
...
> **Last Updated:** 2025-12-26 01:05:08 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **396,235** |
| 💾 **Database Size** | **40.99 MB** |
...
│ 📦 Products             │  11,160                        │
│ 🧾 Transaction Headers  │ ████████ 108,880               │
│ 📝 Transaction Lines    │ ████████████████████ 272,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,725 Suppliers (+ 3 per run)
- ✅ 1,150 Staff members (+ 2 per run)
- ✅ 11,160 Products (+ 10 per run)
- ✅ 108,880 Transactions (+ 20 per run)
- ✅ 272,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (40.99 MB)
...
**Current Status:** 396,235 records | 40.99 MB | Growing every 2 hours
