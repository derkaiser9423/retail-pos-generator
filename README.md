...
![Total Records](https://img.shields.io/badge/records-792,085-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.46MB-blue)
...
> **Last Updated:** 2026-02-10 18:57:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **792,085** |
| 💾 **Database Size** | **82.46 MB** |
...
│ 📦 Products             │  22,080                        │
│ 🧾 Transaction Headers  │ ████████ 218,080               │
│ 📝 Transaction Lines    │ ████████████████████ 545,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,363 Suppliers (+ 3 per run)
- ✅ 2,242 Staff members (+ 2 per run)
- ✅ 22,080 Products (+ 10 per run)
- ✅ 218,080 Transactions (+ 20 per run)
- ✅ 545,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.46 MB)
...
- **Records:** 792,085
- **Size:** 82.46 MB
- **Last Updated:** 2026-02-10 18:57 UTC
...
**Current Status:** 792,085 records | 82.46 MB | Growing every 2 hours
