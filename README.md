...
![Total Records](https://img.shields.io/badge/records-895,760-brightgreen)
![Database Size](https://img.shields.io/badge/size-93.3MB-blue)
...
> **Last Updated:** 2026-02-23 16:51:15 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **895,760** |
| 💾 **Database Size** | **93.3 MB** |
| 📅 **Last Updated** | February 23, 2026 at 16:51 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,940                        │
│ 🧾 Transaction Headers  │ ████████ 246,680               │
│ 📝 Transaction Lines    │ ████████████████████ 616,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,792 Suppliers (+ 3 per run)
- ✅ 2,528 Staff members (+ 2 per run)
- ✅ 24,940 Products (+ 10 per run)
- ✅ 246,680 Transactions (+ 20 per run)
- ✅ 616,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (93.3 MB)
...
**Current Status:** 895,760 records | 93.3 MB | Growing every 2 hours
