...
![Total Records](https://img.shields.io/badge/records-387,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-40.09MB-blue)
...
> **Last Updated:** 2025-12-25 01:04:48 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **387,535** |
| 💾 **Database Size** | **40.09 MB** |
...
│ 📦 Products             │  10,920                        │
│ 🧾 Transaction Headers  │ ████████ 106,480               │
│ 📝 Transaction Lines    │ ████████████████████ 266,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,689 Suppliers (+ 3 per run)
- ✅ 1,126 Staff members (+ 2 per run)
- ✅ 10,920 Products (+ 10 per run)
- ✅ 106,480 Transactions (+ 20 per run)
- ✅ 266,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (40.09 MB)
...
- **Records:** 387,535
- **Size:** 40.09 MB
- **Last Updated:** 2025-12-25 01:04 UTC
...
**Current Status:** 387,535 records | 40.09 MB | Growing every 2 hours
