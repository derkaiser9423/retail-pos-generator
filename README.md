...
![Total Records](https://img.shields.io/badge/records-755,110-brightgreen)
![Database Size](https://img.shields.io/badge/size-78.53MB-blue)
...
> **Last Updated:** 2026-02-06 01:18:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **755,110** |
| 💾 **Database Size** | **78.53 MB** |
...
│ 📦 Products             │  21,060                        │
│ 🧾 Transaction Headers  │ ████████ 207,880               │
│ 📝 Transaction Lines    │ ████████████████████ 519,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,210 Suppliers (+ 3 per run)
- ✅ 2,140 Staff members (+ 2 per run)
- ✅ 21,060 Products (+ 10 per run)
- ✅ 207,880 Transactions (+ 20 per run)
- ✅ 519,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (78.53 MB)
...
**Current Status:** 755,110 records | 78.53 MB | Growing every 2 hours
