...
![Total Records](https://img.shields.io/badge/records-358,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-36.98MB-blue)
...
> **Last Updated:** 2025-12-21 16:15:35 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **358,535** |
| 💾 **Database Size** | **36.98 MB** |
...
│ 📦 Products             │  10,120                        │
│ 🧾 Transaction Headers  │ ████████ 98,480                │
│ 📝 Transaction Lines    │ ████████████████████ 246,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,569 Suppliers (+ 3 per run)
- ✅ 1,046 Staff members (+ 2 per run)
- ✅ 10,120 Products (+ 10 per run)
- ✅ 98,480 Transactions (+ 20 per run)
- ✅ 246,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (36.98 MB)
...
- **Records:** 358,535
- **Size:** 36.98 MB
- **Last Updated:** 2025-12-21 16:15 UTC
...
**Current Status:** 358,535 records | 36.98 MB | Growing every 2 hours
