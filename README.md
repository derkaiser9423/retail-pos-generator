...
![Total Records](https://img.shields.io/badge/records-317,933-brightgreen)
![Database Size](https://img.shields.io/badge/size-32.79MB-blue)
...
> **Last Updated:** 2025-12-17 01:00:31 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **317,933** |
| 💾 **Database Size** | **32.79 MB** |
...
│ 📦 Products             │  9,000                         │
│ 🧾 Transaction Headers  │ ████████ 87,280                │
│ 📝 Transaction Lines    │ ████████████████████ 218,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,401 Suppliers (+ 3 per run)
- ✅ 934 Staff members (+ 2 per run)
- ✅ 9,000 Products (+ 10 per run)
- ✅ 87,280 Transactions (+ 20 per run)
- ✅ 218,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (32.79 MB)
...
**Current Status:** 317,933 records | 32.79 MB | Growing every 2 hours
