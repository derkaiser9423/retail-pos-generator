...
![Total Records](https://img.shields.io/badge/records-591,985-brightgreen)
![Database Size](https://img.shields.io/badge/size-61.48MB-blue)
...
> **Last Updated:** 2026-01-17 12:26:06 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **591,985** |
| 💾 **Database Size** | **61.48 MB** |
...
│ 📦 Products             │  16,560                        │
│ 🧾 Transaction Headers  │ ████████ 162,880               │
│ 📝 Transaction Lines    │ ████████████████████ 407,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,535 Suppliers (+ 3 per run)
- ✅ 1,690 Staff members (+ 2 per run)
- ✅ 16,560 Products (+ 10 per run)
- ✅ 162,880 Transactions (+ 20 per run)
- ✅ 407,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (61.48 MB)
...
- **Records:** 591,985
- **Size:** 61.48 MB
- **Last Updated:** 2026-01-17 12:26 UTC
...
**Current Status:** 591,985 records | 61.48 MB | Growing every 2 hours
