...
![Total Records](https://img.shields.io/badge/records-889,960-brightgreen)
![Database Size](https://img.shields.io/badge/size-92.71MB-blue)
...
> **Last Updated:** 2026-02-22 22:18:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **889,960** |
| 💾 **Database Size** | **92.71 MB** |
| 📅 **Last Updated** | February 22, 2026 at 22:18 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,780                        │
│ 🧾 Transaction Headers  │ ████████ 245,080               │
│ 📝 Transaction Lines    │ ████████████████████ 612,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,768 Suppliers (+ 3 per run)
- ✅ 2,512 Staff members (+ 2 per run)
- ✅ 24,780 Products (+ 10 per run)
- ✅ 245,080 Transactions (+ 20 per run)
- ✅ 612,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (92.71 MB)
...
**Current Status:** 889,960 records | 92.71 MB | Growing every 2 hours
