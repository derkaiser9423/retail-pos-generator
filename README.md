...
![Total Records](https://img.shields.io/badge/records-659,410-brightgreen)
![Database Size](https://img.shields.io/badge/size-68.51MB-blue)
...
> **Last Updated:** 2026-01-25 06:22:18 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **659,410** |
| 💾 **Database Size** | **68.51 MB** |
...
│ 📦 Products             │  18,420                        │
│ 🧾 Transaction Headers  │ ████████ 181,480               │
│ 📝 Transaction Lines    │ ████████████████████ 453,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,814 Suppliers (+ 3 per run)
- ✅ 1,876 Staff members (+ 2 per run)
- ✅ 18,420 Products (+ 10 per run)
- ✅ 181,480 Transactions (+ 20 per run)
- ✅ 453,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (68.51 MB)
...
- **Records:** 659,410
- **Size:** 68.51 MB
- **Last Updated:** 2026-01-25 06:22 UTC
...
**Current Status:** 659,410 records | 68.51 MB | Growing every 2 hours
