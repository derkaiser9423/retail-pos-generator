...
![Total Records](https://img.shields.io/badge/records-930,560-brightgreen)
![Database Size](https://img.shields.io/badge/size-96.99MB-blue)
...
> **Last Updated:** 2026-02-28 01:14:16 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **930,560** |
| 💾 **Database Size** | **96.99 MB** |
| 📅 **Last Updated** | February 28, 2026 at 01:14 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  25,900                        │
│ 🧾 Transaction Headers  │ ████████ 256,280               │
│ 📝 Transaction Lines    │ ████████████████████ 640,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,936 Suppliers (+ 3 per run)
- ✅ 2,624 Staff members (+ 2 per run)
- ✅ 25,900 Products (+ 10 per run)
- ✅ 256,280 Transactions (+ 20 per run)
- ✅ 640,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (96.99 MB)
...
- **Records:** 930,560
- **Size:** 96.99 MB
- **Last Updated:** 2026-02-28 01:14 UTC
...
**Current Status:** 930,560 records | 96.99 MB | Growing every 2 hours
