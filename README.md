...
![Total Records](https://img.shields.io/badge/records-533,260-brightgreen)
![Database Size](https://img.shields.io/badge/size-55.32MB-blue)
...
> **Last Updated:** 2026-01-10 18:19:45 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **533,260** |
| 💾 **Database Size** | **55.32 MB** |
...
│ 📦 Products             │  14,940                        │
│ 🧾 Transaction Headers  │ ████████ 146,680               │
│ 📝 Transaction Lines    │ ████████████████████ 366,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,292 Suppliers (+ 3 per run)
- ✅ 1,528 Staff members (+ 2 per run)
- ✅ 14,940 Products (+ 10 per run)
- ✅ 146,680 Transactions (+ 20 per run)
- ✅ 366,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (55.32 MB)
...
- **Records:** 533,260
- **Size:** 55.32 MB
- **Last Updated:** 2026-01-10 18:19 UTC
...
**Current Status:** 533,260 records | 55.32 MB | Growing every 2 hours
