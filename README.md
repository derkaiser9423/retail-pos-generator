...
![Total Records](https://img.shields.io/badge/records-673,910-brightgreen)
![Database Size](https://img.shields.io/badge/size-69.99MB-blue)
...
> **Last Updated:** 2026-01-26 22:15:54 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **673,910** |
| 💾 **Database Size** | **69.99 MB** |
| 📅 **Last Updated** | January 26, 2026 at 22:15 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  18,820                        │
│ 🧾 Transaction Headers  │ ████████ 185,480               │
│ 📝 Transaction Lines    │ ████████████████████ 463,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,874 Suppliers (+ 3 per run)
- ✅ 1,916 Staff members (+ 2 per run)
- ✅ 18,820 Products (+ 10 per run)
- ✅ 185,480 Transactions (+ 20 per run)
- ✅ 463,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (69.99 MB)
...
- **Records:** 673,910
- **Size:** 69.99 MB
- **Last Updated:** 2026-01-26 22:15 UTC
...
**Current Status:** 673,910 records | 69.99 MB | Growing every 2 hours
