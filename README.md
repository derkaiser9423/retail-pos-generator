...
![Total Records](https://img.shields.io/badge/records-869,660-brightgreen)
![Database Size](https://img.shields.io/badge/size-90.56MB-blue)
...
> **Last Updated:** 2026-02-20 12:41:10 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **869,660** |
| 💾 **Database Size** | **90.56 MB** |
| 📅 **Last Updated** | February 20, 2026 at 12:41 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  24,220                        │
│ 🧾 Transaction Headers  │ ████████ 239,480               │
│ 📝 Transaction Lines    │ ████████████████████ 598,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,684 Suppliers (+ 3 per run)
- ✅ 2,456 Staff members (+ 2 per run)
- ✅ 24,220 Products (+ 10 per run)
- ✅ 239,480 Transactions (+ 20 per run)
- ✅ 598,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (90.56 MB)
...
**Current Status:** 869,660 records | 90.56 MB | Growing every 2 hours
