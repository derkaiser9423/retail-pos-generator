...
![Total Records](https://img.shields.io/badge/records-424,510-brightgreen)
![Database Size](https://img.shields.io/badge/size-43.9MB-blue)
...
> **Last Updated:** 2025-12-29 06:24:38 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **424,510** |
| 💾 **Database Size** | **43.9 MB** |
| 📅 **Last Updated** | December 29, 2025 at 06:24 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  11,940                        │
│ 🧾 Transaction Headers  │ ████████ 116,680               │
│ 📝 Transaction Lines    │ ████████████████████ 291,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,842 Suppliers (+ 3 per run)
- ✅ 1,228 Staff members (+ 2 per run)
- ✅ 11,940 Products (+ 10 per run)
- ✅ 116,680 Transactions (+ 20 per run)
- ✅ 291,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (43.9 MB)
...
- **Records:** 424,510
- **Size:** 43.9 MB
- **Last Updated:** 2025-12-29 06:24 UTC
...
**Current Status:** 424,510 records | 43.9 MB | Growing every 2 hours
