...
![Total Records](https://img.shields.io/badge/records-536,885-brightgreen)
![Database Size](https://img.shields.io/badge/size-55.7MB-blue)
...
> **Last Updated:** 2026-01-11 04:42:13 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **536,885** |
| 💾 **Database Size** | **55.7 MB** |
| 📅 **Last Updated** | January 11, 2026 at 04:42 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  15,040                        │
│ 🧾 Transaction Headers  │ ████████ 147,680               │
│ 📝 Transaction Lines    │ ████████████████████ 369,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,307 Suppliers (+ 3 per run)
- ✅ 1,538 Staff members (+ 2 per run)
- ✅ 15,040 Products (+ 10 per run)
- ✅ 147,680 Transactions (+ 20 per run)
- ✅ 369,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (55.7 MB)
...
- **Records:** 536,885
- **Size:** 55.7 MB
- **Last Updated:** 2026-01-11 04:42 UTC
...
**Current Status:** 536,885 records | 55.7 MB | Growing every 2 hours
