...
![Total Records](https://img.shields.io/badge/records-556,460-brightgreen)
![Database Size](https://img.shields.io/badge/size-57.74MB-blue)
...
> **Last Updated:** 2026-01-13 10:17:11 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **556,460** |
| 💾 **Database Size** | **57.74 MB** |
| 📅 **Last Updated** | January 13, 2026 at 10:17 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  15,580                        │
│ 🧾 Transaction Headers  │ ████████ 153,080               │
│ 📝 Transaction Lines    │ ████████████████████ 382,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,388 Suppliers (+ 3 per run)
- ✅ 1,592 Staff members (+ 2 per run)
- ✅ 15,580 Products (+ 10 per run)
- ✅ 153,080 Transactions (+ 20 per run)
- ✅ 382,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (57.74 MB)
...
- **Records:** 556,460
- **Size:** 57.74 MB
- **Last Updated:** 2026-01-13 10:17 UTC
...
**Current Status:** 556,460 records | 57.74 MB | Growing every 2 hours
