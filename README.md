...
![Total Records](https://img.shields.io/badge/records-793,535-brightgreen)
![Database Size](https://img.shields.io/badge/size-82.6MB-blue)
...
> **Last Updated:** 2026-02-10 22:33:39 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **793,535** |
| 💾 **Database Size** | **82.6 MB** |
| 📅 **Last Updated** | February 10, 2026 at 22:33 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  22,120                        │
│ 🧾 Transaction Headers  │ ████████ 218,480               │
│ 📝 Transaction Lines    │ ████████████████████ 546,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,369 Suppliers (+ 3 per run)
- ✅ 2,246 Staff members (+ 2 per run)
- ✅ 22,120 Products (+ 10 per run)
- ✅ 218,480 Transactions (+ 20 per run)
- ✅ 546,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (82.6 MB)
...
- **Records:** 793,535
- **Size:** 82.6 MB
- **Last Updated:** 2026-02-10 22:33 UTC
...
**Current Status:** 793,535 records | 82.6 MB | Growing every 2 hours
