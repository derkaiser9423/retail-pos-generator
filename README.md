...
![Total Records](https://img.shields.io/badge/records-581,110-brightgreen)
![Database Size](https://img.shields.io/badge/size-60.36MB-blue)
...
> **Last Updated:** 2026-01-16 06:23:50 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **581,110** |
| 💾 **Database Size** | **60.36 MB** |
| 📅 **Last Updated** | January 16, 2026 at 06:23 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,260                        │
│ 🧾 Transaction Headers  │ ████████ 159,880               │
│ 📝 Transaction Lines    │ ████████████████████ 399,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,490 Suppliers (+ 3 per run)
- ✅ 1,660 Staff members (+ 2 per run)
- ✅ 16,260 Products (+ 10 per run)
- ✅ 159,880 Transactions (+ 20 per run)
- ✅ 399,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (60.36 MB)
...
**Current Status:** 581,110 records | 60.36 MB | Growing every 2 hours
