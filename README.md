...
![Total Records](https://img.shields.io/badge/records-143,764-brightgreen)
![Database Size](https://img.shields.io/badge/size-14.62MB-blue)
...
> **Last Updated:** 2025-11-27 01:00:21 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **143,764** |
| 💾 **Database Size** | **14.62 MB** |
...
│ 🏷️ Product Groups       │  647                           │
│ 📦 Products             │  4,200                         │
│ 🧾 Transaction Headers  │ ████████ 39,280                │
│ 📝 Transaction Lines    │ ████████████████████ 98,200    │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 681 Suppliers (+ 3 per run)
- ✅ 454 Staff members (+ 2 per run)
- ✅ 4,200 Products (+ 10 per run)
- ✅ 39,280 Transactions (+ 20 per run)
- ✅ 98,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (14.62 MB)
...
**Current Status:** 143,764 records | 14.62 MB | Growing every 2 hours
