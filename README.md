...
![Total Records](https://img.shields.io/badge/records-718,135-brightgreen)
![Database Size](https://img.shields.io/badge/size-74.7MB-blue)
...
> **Last Updated:** 2026-02-01 06:41:01 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **718,135** |
| 💾 **Database Size** | **74.7 MB** |
| 📅 **Last Updated** | February 01, 2026 at 06:41 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  20,040                        │
│ 🧾 Transaction Headers  │ ████████ 197,680               │
│ 📝 Transaction Lines    │ ████████████████████ 494,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,057 Suppliers (+ 3 per run)
- ✅ 2,038 Staff members (+ 2 per run)
- ✅ 20,040 Products (+ 10 per run)
- ✅ 197,680 Transactions (+ 20 per run)
- ✅ 494,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (74.7 MB)
...
- **Records:** 718,135
- **Size:** 74.7 MB
- **Last Updated:** 2026-02-01 06:41 UTC
...
**Current Status:** 718,135 records | 74.7 MB | Growing every 2 hours
