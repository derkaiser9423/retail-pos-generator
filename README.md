...
![Total Records](https://img.shields.io/badge/records-765,985-brightgreen)
![Database Size](https://img.shields.io/badge/size-79.73MB-blue)
...
> **Last Updated:** 2026-02-07 10:19:23 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **765,985** |
| 💾 **Database Size** | **79.73 MB** |
| 📅 **Last Updated** | February 07, 2026 at 10:19 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,360                        │
│ 🧾 Transaction Headers  │ ████████ 210,880               │
│ 📝 Transaction Lines    │ ████████████████████ 527,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,255 Suppliers (+ 3 per run)
- ✅ 2,170 Staff members (+ 2 per run)
- ✅ 21,360 Products (+ 10 per run)
- ✅ 210,880 Transactions (+ 20 per run)
- ✅ 527,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (79.73 MB)
...
- **Records:** 765,985
- **Size:** 79.73 MB
- **Last Updated:** 2026-02-07 10:19 UTC
...
**Current Status:** 765,985 records | 79.73 MB | Growing every 2 hours
