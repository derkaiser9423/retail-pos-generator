...
![Total Records](https://img.shields.io/badge/records-428,860-brightgreen)
![Database Size](https://img.shields.io/badge/size-44.37MB-blue)
...
> **Last Updated:** 2025-12-29 18:21:25 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **428,860** |
| 💾 **Database Size** | **44.37 MB** |
...
│ 📦 Products             │  12,060                        │
│ 🧾 Transaction Headers  │ ████████ 117,880               │
│ 📝 Transaction Lines    │ ████████████████████ 294,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,860 Suppliers (+ 3 per run)
- ✅ 1,240 Staff members (+ 2 per run)
- ✅ 12,060 Products (+ 10 per run)
- ✅ 117,880 Transactions (+ 20 per run)
- ✅ 294,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (44.37 MB)
...
**Current Status:** 428,860 records | 44.37 MB | Growing every 2 hours
