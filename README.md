...
![Total Records](https://img.shields.io/badge/records-539,060-brightgreen)
![Database Size](https://img.shields.io/badge/size-55.92MB-blue)
...
> **Last Updated:** 2026-01-11 10:14:34 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **539,060** |
| 💾 **Database Size** | **55.92 MB** |
| 📅 **Last Updated** | January 11, 2026 at 10:14 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  15,100                        │
│ 🧾 Transaction Headers  │ ████████ 148,280               │
│ 📝 Transaction Lines    │ ████████████████████ 370,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,316 Suppliers (+ 3 per run)
- ✅ 1,544 Staff members (+ 2 per run)
- ✅ 15,100 Products (+ 10 per run)
- ✅ 148,280 Transactions (+ 20 per run)
- ✅ 370,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (55.92 MB)
...
- **Records:** 539,060
- **Size:** 55.92 MB
- **Last Updated:** 2026-01-11 10:14 UTC
...
**Current Status:** 539,060 records | 55.92 MB | Growing every 2 hours
