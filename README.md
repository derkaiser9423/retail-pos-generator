...
![Total Records](https://img.shields.io/badge/records-785,560-brightgreen)
![Database Size](https://img.shields.io/badge/size-81.8MB-blue)
...
> **Last Updated:** 2026-02-09 22:29:52 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **785,560** |
| 💾 **Database Size** | **81.8 MB** |
| 📅 **Last Updated** | February 09, 2026 at 22:29 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  21,900                        │
│ 🧾 Transaction Headers  │ ████████ 216,280               │
│ 📝 Transaction Lines    │ ████████████████████ 540,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 3,336 Suppliers (+ 3 per run)
- ✅ 2,224 Staff members (+ 2 per run)
- ✅ 21,900 Products (+ 10 per run)
- ✅ 216,280 Transactions (+ 20 per run)
- ✅ 540,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (81.8 MB)
...
- **Records:** 785,560
- **Size:** 81.8 MB
- **Last Updated:** 2026-02-09 22:29 UTC
...
**Current Status:** 785,560 records | 81.8 MB | Growing every 2 hours
