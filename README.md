...
![Total Records](https://img.shields.io/badge/records-592,710-brightgreen)
![Database Size](https://img.shields.io/badge/size-61.56MB-blue)
...
> **Last Updated:** 2026-01-17 14:13:17 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **592,710** |
| 💾 **Database Size** | **61.56 MB** |
| 📅 **Last Updated** | January 17, 2026 at 14:13 UTC |
| 📈 **24h Growth** | +725 records |
...
│ 📦 Products             │  16,580                        │
│ 🧾 Transaction Headers  │ ████████ 163,080               │
│ 📝 Transaction Lines    │ ████████████████████ 407,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,538 Suppliers (+ 3 per run)
- ✅ 1,692 Staff members (+ 2 per run)
- ✅ 16,580 Products (+ 10 per run)
- ✅ 163,080 Transactions (+ 20 per run)
- ✅ 407,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (61.56 MB)
...
- **Records:** 592,710
- **Size:** 61.56 MB
- **Last Updated:** 2026-01-17 14:13 UTC
...
**Current Status:** 592,710 records | 61.56 MB | Growing every 2 hours
