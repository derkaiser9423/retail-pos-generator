...
![Total Records](https://img.shields.io/badge/records-491,935-brightgreen)
![Database Size](https://img.shields.io/badge/size-51.06MB-blue)
...
> **Last Updated:** 2026-01-06 01:06:32 UTC  
...
│ 📦 Products             │  13,800                        │
│ 🧾 Transaction Headers  │ ████████ 135,280               │
│ 📝 Transaction Lines    │ ████████████████████ 338,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 2,121 Suppliers (+ 3 per run)
- ✅ 1,414 Staff members (+ 2 per run)
- ✅ 13,800 Products (+ 10 per run)
- ✅ 135,280 Transactions (+ 20 per run)
- ✅ 338,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (51.06 MB)
...
- **Records:** 491,935
- **Size:** 51.06 MB
- **Last Updated:** 2026-01-06 01:06 UTC
...
**Current Status:** 491,935 records | 51.06 MB | Growing every 2 hours
