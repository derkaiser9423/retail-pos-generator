...
![Total Records](https://img.shields.io/badge/records-352,735-brightgreen)
![Database Size](https://img.shields.io/badge/size-36.41MB-blue)
...
> **Last Updated:** 2025-12-21 01:09:22 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **352,735** |
| 💾 **Database Size** | **36.41 MB** |
...
│ 📦 Products             │  9,960                         │
│ 🧾 Transaction Headers  │ ████████ 96,880                │
│ 📝 Transaction Lines    │ ████████████████████ 242,200   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 1,545 Suppliers (+ 3 per run)
- ✅ 1,030 Staff members (+ 2 per run)
- ✅ 9,960 Products (+ 10 per run)
- ✅ 96,880 Transactions (+ 20 per run)
- ✅ 242,200 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (36.41 MB)
...
- **Records:** 352,735
- **Size:** 36.41 MB
- **Last Updated:** 2025-12-21 01:09 UTC
...
**Current Status:** 352,735 records | 36.41 MB | Growing every 2 hours
