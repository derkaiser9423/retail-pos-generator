...
![Total Records](https://img.shields.io/badge/records-164,853-brightgreen)
![Database Size](https://img.shields.io/badge/size-16.83MB-blue)
...
> **Last Updated:** 2025-11-29 10:13:10 UTC  
...
| Metric | Value |
|--------|-------|
| 📦 **Total Records** | **164,853** |
| 💾 **Database Size** | **16.83 MB** |
| 📅 **Last Updated** | November 29, 2025 at 10:13 UTC |
| 📈 **24h Growth** | +728 records |
...
│ 🏷️ Product Groups       │  711                           │
│ 📦 Products             │  4,780                         │
│ 🧾 Transaction Headers  │ ████████ 45,080                │
│ 📝 Transaction Lines    │ ████████████████████ 112,700   │
└─────────────────────────┴──────────────────────────────┘
```
...
- ✅ 768 Suppliers (+ 3 per run)
- ✅ 512 Staff members (+ 2 per run)
- ✅ 4,780 Products (+ 10 per run)
- ✅ 45,080 Transactions (+ 20 per run)
- ✅ 112,700 Transaction lines (+ 50 per run)
...
├── retail_pos.db                # SQLite database (16.83 MB)
...
- **Records:** 164,853
- **Size:** 16.83 MB
- **Last Updated:** 2025-11-29 10:13 UTC
...
**Current Status:** 164,853 records | 16.83 MB | Growing every 2 hours
